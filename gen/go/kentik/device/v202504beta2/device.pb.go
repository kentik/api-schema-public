...
const file_kentik_device_v202504beta2_device_proto_rawDesc = "" +
	"\n" +
	...
	"\x04snmp\x18\x04 \x01(\v2/.kentik.device.v202504beta2.DeviceNmsSnmpConfigB~\x92A{2yConfiguration if metrics will be collected over SNMP. Not including this configuration will make this a ping-only device.R\x04snmp\x12\x88\x01\n" +
	"\x02st\x18\x05 \x01(\v2-.kentik.device.v202504beta2.DeviceNmsStConfigBI\x92AF2DConfiguration if metrics will be collected over Streaming Telemetry.R\x02st\"\x9c\x02\n" +
	...
	"\x06secure\x18\x04 \x01(\bB'\x92A$2\"Use SSL to connect to this device.R\x06secure\"\xc1*\n" +
	"\rDeviceConcise\x127\n" +
	...
	"\x13device_snmp_v3_conf\x18\r \x01(\v2,.kentik.device.v202504beta2.DeviceSnmpV3ConfB\x9e\x01\x92A\x9a\x012\x97\x01SNMP v3 configuration (device_snmp_v3_conf) - SNMP v3 configuration. device_snmp_v3_conf is ignored unless the device subtype's parent type is \"router\"R\x10deviceSnmpV3Conf\x12\xf2\x01\n" +
	...
	"\bmetadata\x18\x10 \x03(\v2..kentik.device.v202504beta2.Plan.MetadataEntryB\x12\x92A\x0f2\rPlan MetadataR\bmetadata\x1a;\n" +
	...
	"\x04site\x18\a \x01(\v2 .kentik.device.v202504beta2.SiteB\t\x92A\x062\x04SiteR\x04site\x12?\n" +
	"\x04plan\x18\b \x01(\v2 .kentik.device.v202504beta2.PlanB\t\x92A\x062\x04PlanR\x04plan\x12N\n" +
	"\x06labels\x18\t \x03(\v2!.kentik.device.v202504beta2.LabelB\x13\x92A\x102\x0eList of labelsR\x06labels\x12e\n" +
	"\x0eall_interfaces\x18\n" +
	" \x03(\v2%.kentik.device.v202504beta2.InterfaceB\x17\x92A\x142\x12List of interfacesR\rallInterfaces\x12?\n" +
	...
	"\x12custom_column_data\x18\x1c \x03(\v2,.kentik.device.v202504beta2.CustomColumnDataB\x17\x92A\x142\x12Custom column dataR\x10customColumnData\x12P\n" +
	...
	"\x13device_snmp_v3_conf\x18( \x01(\v2,.kentik.device.v202504beta2.DeviceSnmpV3ConfB!\x92A\x1e2\x1cDevice SNMP v3 configurationR\x10deviceSnmpV3Conf\x12.\n" +
	...
	"\x13device_gnmi_v1_conf\x189 \x01(\v2&.kentik.device.v202504beta2.GnmiV1ConfB!\x92A\x1e2\x1cDevice GNMI v1 configurationR\x10deviceGnmiV1Conf\x12A\n" +
	...
	"\x06device\x18\x01 \x01(\v2*.kentik.device.v202504beta2.DeviceDetailedB.\x92A+2)Configuration of the newly created deviceR\x06device\"\x94\x01\n" +
	"\x14CreateDevicesRequest\x12|\n" +
	"\adevices\x18\x01 \x03(\v2).kentik.device.v202504beta2.DeviceConciseB7\x92A12/List of configurations of devices to be created\xe0A\x02R\adevices\"\xf3\x01\n" +
	"\x15CreateDevicesResponse\x12z\n" +
	"\adevices\x18\x01 \x03(\v2*.kentik.device.v202504beta2.DeviceDetailedB4\x92A12/List of configurations of newly created devicesR\adevices\x12^\n" +
	...
	"\x06device\x18\x01 \x01(\v2).kentik.device.v202504beta2.DeviceConciseBA\x92A;29New configuration attributes for the device to be updated\xe0A\x02R\x06device\"\x84\x01\n" +
	"\x14UpdateDeviceResponse\x12l\n" +
	"\x06device\x18\x01 \x01(\v2*.kentik.device.v202504beta2.DeviceDetailedB(\x92A%2#Updated configuration of the deviceR\x06device\"\x94\x01\n" +
	"\x14UpdateDevicesRequest\x12|\n" +
	"\adevices\x18\x01 \x03(\v2).kentik.device.v202504beta2.DeviceConciseB7\x92A12/List of configurations of devices to be updated\xe0A\x02R\adevices\"\xeb\x01\n" +
	"\x15UpdateDevicesResponse\x12t\n" +
	"\adevices\x18\x01 \x03(\v2*.kentik.device.v202504beta2.DeviceDetailedB.\x92A+2)List of configurations of updated devicesR\adevices\x12\\\n" +
	...
	"\x06labels\x18\x02 \x03(\v2(.kentik.device.v202504beta2.LabelConciseB0\x92A*2(List of labels to be added to the device\xe0A\x02R\x06labels\"\x8a\x01\n" +
	"\x1aUpdateDeviceLabelsResponse\x12l\n" +
	"\x06device\x18\x01 \x01(\v2*.kentik.device.v202504beta2.DeviceDetailedB(\x92A%2#Updated configuration of the deviceR\x06device\"M\n" +
	...
	"\x12UpdateDeviceLabels\x125.kentik.device.v202504beta2.UpdateDeviceLabelsRequest\x1a6.kentik.device.v202504beta2.UpdateDeviceLabelsResponse\"\xbc\x02\x92A\xf0\x01\x12\x1bUpdates labels of a device.\x1a\xbc\x01Removes all existing labels from the device and applies the device labels (see [About Device Labels](https://kb.kentik.com/v4/Cb16.htm)) specified by id. Returns the updated configuration.*\x12UpdateDeviceLabels\xf2\xd7\x02\x12admin.device:write\x82\xd3\xe4\x93\x02,:\x01*\x1a'/device/v202504beta2/device/{id}/labels\x12\xd5\x02\n" +
	"\fDeleteDevice\x12/.kentik.device.v202504beta2.DeleteDeviceRequest\x1a0.kentik.device.v202504beta2.DeleteDeviceResponse\"\xe1\x01\x92A\x9f\x01\x12!Delete configuration of a device.\x1alDeletes configuration of a device with specific ID (see [About Devices](https://kb.kentik.com/v4/Cb01.htm)).*\fDeleteDevice\xf2\xd7\x02\x12admin.device:write\x82\xd3\xe4\x93\x02\"* /device/v202504beta2/device/{id}\x12\xf5\x02\n" +
	"\rDeleteDevices\x120.kentik.device.v202504beta2.DeleteDevicesRequest\x1a1.kentik.device.v202504beta2.DeleteDevicesResponse\"\xfe\x01\x92A\xb1\x01\x12)Delete configuration of multiple devices.\x1auDeletes configuration of multiple devices with specific IDs (see [About Devices](https://kb.kentik.com/v4/Cb01.htm)).*\rDeleteDevices\xf2\xd7\x02\x12admin.device:write\x82\xd3\xe4\x93\x02-:\x01*\"(/device/v202504beta2/device/batch_delete\x1a*\xcaA\x13grpc.api.kentik.com\xea\xd7\x02\fadmin.device\x90\xd8\x02\x03B\xee\x03\x92A\x9c\x03\x12\xb5\x01\n" +
	"\n" +
	"Device API\x12R# Overview\n" +
	"The Device API provides programmatic access to configuration of devices\"E\n" +
	"\x16Kentik API Engineering\x12+https://github.com/kentik/api-schema-public2\fv202504beta2*\x01\x022\x10application/json:\x10application/jsonZD\n" +
	"\x1e\n" +
	...
	"\t\n" +
	"\x05token\x12\x00r]\n" +
	"%General information about Kentik APIs\x124https://kb.kentik.com/v0/Ab09.htm#Ab09-APIs_OverviewZLgithub.com/kentik/api-schema-public/gen/go/kentik/device/v202504beta2;deviceb\x06proto3"

var (
	file_kentik_device_v202504beta2_device_proto_rawDescOnce sync.Once
	file_kentik_device_v202504beta2_device_proto_rawDescData []byte
)
...
func file_kentik_device_v202504beta2_device_proto_rawDescGZIP() []byte {
	file_kentik_device_v202504beta2_device_proto_rawDescOnce.Do(func() {
		file_kentik_device_v202504beta2_device_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_kentik_device_v202504beta2_device_proto_rawDesc), len(file_kentik_device_v202504beta2_device_proto_rawDesc)))
	})
...
func file_kentik_device_v202504beta2_device_proto_init() {
	...
	file_kentik_device_v202504beta2_device_proto_msgTypes[4].OneofWrappers = []any{}
	file_kentik_device_v202504beta2_device_proto_msgTypes[11].OneofWrappers = []any{}
	type x struct{}

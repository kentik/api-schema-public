...
const (
	MitigationPlatformsService_List_FullMethodName = "/kentik.alerting.public.v202505.MitigationPlatformsService/List"
	MitigationPlatformsService_Get_FullMethodName  = "/kentik.alerting.public.v202505.MitigationPlatformsService/Get"
)
...
func (c *mitigationPlatformsServiceClient) List(ctx context.Context, in *MitigationPlatformsServiceListRequest, opts ...grpc.CallOption) (*MitigationPlatformsServiceListResponse, error) {
	...
	err := c.cc.Invoke(ctx, MitigationPlatformsService_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mitigationPlatformsServiceClient) Get(ctx context.Context, in *MitigationPlatformsServiceGetRequest, opts ...grpc.CallOption) (*MitigationPlatformsServiceGetResponse, error) {
	...
	err := c.cc.Invoke(ctx, MitigationPlatformsService_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMitigationPlatformsServiceServer should be embedded to have
...
func (UnimplementedMitigationPlatformsServiceServer) testEmbeddedByValue() {}
...
func RegisterMitigationPlatformsServiceServer(s grpc.ServiceRegistrar, srv MitigationPlatformsServiceServer) {
	// If the following call pancis, it indicates UnimplementedMitigationPlatformsServiceServer was
...
func _MitigationPlatformsService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MitigationPlatformsService_List_FullMethodName,
	}
...
func _MitigationPlatformsService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MitigationPlatformsService_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

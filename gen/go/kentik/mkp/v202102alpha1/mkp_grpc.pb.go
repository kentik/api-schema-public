...
const (
	PackageService_ListPackage_FullMethodName   = "/kentik.mkp.v202102alpha1.PackageService/ListPackage"
	PackageService_GetPackage_FullMethodName    = "/kentik.mkp.v202102alpha1.PackageService/GetPackage"
	PackageService_CreatePackage_FullMethodName = "/kentik.mkp.v202102alpha1.PackageService/CreatePackage"
	PackageService_UpdatePackage_FullMethodName = "/kentik.mkp.v202102alpha1.PackageService/UpdatePackage"
	PackageService_PatchPackage_FullMethodName  = "/kentik.mkp.v202102alpha1.PackageService/PatchPackage"
	PackageService_DeletePackage_FullMethodName = "/kentik.mkp.v202102alpha1.PackageService/DeletePackage"
)
...
const (
	TenantService_ListTenant_FullMethodName   = "/kentik.mkp.v202102alpha1.TenantService/ListTenant"
	TenantService_GetTenant_FullMethodName    = "/kentik.mkp.v202102alpha1.TenantService/GetTenant"
	TenantService_CreateTenant_FullMethodName = "/kentik.mkp.v202102alpha1.TenantService/CreateTenant"
	TenantService_UpdateTenant_FullMethodName = "/kentik.mkp.v202102alpha1.TenantService/UpdateTenant"
	TenantService_PatchTenant_FullMethodName  = "/kentik.mkp.v202102alpha1.TenantService/PatchTenant"
	TenantService_DeleteTenant_FullMethodName = "/kentik.mkp.v202102alpha1.TenantService/DeleteTenant"
)
...
func (c *tenantServiceClient) PatchTenant(ctx context.Context, in *PatchTenantRequest, opts ...grpc.CallOption) (*PatchTenantResponse, error) {
	...
	err := c.cc.Invoke(ctx, TenantService_PatchTenant_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TenantService_PatchTenant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TenantService_PatchTenant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

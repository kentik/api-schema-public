...
const file_kentik_mkp_v202407_mkp_proto_rawDesc = "" +
	...
	"\n" +
	"user_email\x18\x04 \x01(\tB!\x92A\x1b2\x19Email address of the user\xe0A\x02R\tuserEmail\"\xec\n" +
	"\n" +
	"\x06Tenant\x12G\n" +
	...
	"\x05users\x18\x11 \x03(\v2\x19.kentik.user.v202211.UserBL\x92AD2BUsers associated with the tenant (deprecated; use ListTenantUser).\xe0A\x03\x18\x01R\x05users\x12S\n" +

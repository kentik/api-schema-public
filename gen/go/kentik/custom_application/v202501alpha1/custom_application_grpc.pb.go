...
const (
	CustomApplicationService_CreateCustomApplication_FullMethodName = "/kentik.custom_application.v202501alpha1.CustomApplicationService/CreateCustomApplication"
	CustomApplicationService_ListCustomApplications_FullMethodName  = "/kentik.custom_application.v202501alpha1.CustomApplicationService/ListCustomApplications"
	CustomApplicationService_GetCustomApplication_FullMethodName    = "/kentik.custom_application.v202501alpha1.CustomApplicationService/GetCustomApplication"
	CustomApplicationService_UpdateCustomApplication_FullMethodName = "/kentik.custom_application.v202501alpha1.CustomApplicationService/UpdateCustomApplication"
	CustomApplicationService_DeleteCustomApplication_FullMethodName = "/kentik.custom_application.v202501alpha1.CustomApplicationService/DeleteCustomApplication"
)
...
func (c *customApplicationServiceClient) CreateCustomApplication(ctx context.Context, in *CreateCustomApplicationRequest, opts ...grpc.CallOption) (*CreateCustomApplicationResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomApplicationService_CreateCustomApplication_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customApplicationServiceClient) ListCustomApplications(ctx context.Context, in *ListCustomApplicationsRequest, opts ...grpc.CallOption) (*ListCustomApplicationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomApplicationService_ListCustomApplications_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customApplicationServiceClient) GetCustomApplication(ctx context.Context, in *GetCustomApplicationRequest, opts ...grpc.CallOption) (*GetCustomApplicationResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomApplicationService_GetCustomApplication_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customApplicationServiceClient) UpdateCustomApplication(ctx context.Context, in *UpdateCustomApplicationRequest, opts ...grpc.CallOption) (*UpdateCustomApplicationResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomApplicationService_UpdateCustomApplication_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customApplicationServiceClient) DeleteCustomApplication(ctx context.Context, in *DeleteCustomApplicationRequest, opts ...grpc.CallOption) (*DeleteCustomApplicationResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomApplicationService_DeleteCustomApplication_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCustomApplicationServiceServer should be embedded to have
...
func (UnimplementedCustomApplicationServiceServer) testEmbeddedByValue() {}
...
func RegisterCustomApplicationServiceServer(s grpc.ServiceRegistrar, srv CustomApplicationServiceServer) {
	// If the following call pancis, it indicates UnimplementedCustomApplicationServiceServer was
...
func _CustomApplicationService_CreateCustomApplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomApplicationService_CreateCustomApplication_FullMethodName,
	}
...
func _CustomApplicationService_ListCustomApplications_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomApplicationService_ListCustomApplications_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CustomApplicationService_GetCustomApplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomApplicationService_GetCustomApplication_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CustomApplicationService_UpdateCustomApplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomApplicationService_UpdateCustomApplication_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CustomApplicationService_DeleteCustomApplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomApplicationService_DeleteCustomApplication_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

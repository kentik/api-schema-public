...
const (
	SiteService_ListSite_FullMethodName   = "/kentik.site.v202106alpha1.SiteService/ListSite"
	SiteService_GetSite_FullMethodName    = "/kentik.site.v202106alpha1.SiteService/GetSite"
	SiteService_CreateSite_FullMethodName = "/kentik.site.v202106alpha1.SiteService/CreateSite"
	SiteService_UpdateSite_FullMethodName = "/kentik.site.v202106alpha1.SiteService/UpdateSite"
	SiteService_DeleteSite_FullMethodName = "/kentik.site.v202106alpha1.SiteService/DeleteSite"
)
...
func (c *siteServiceClient) ListSite(ctx context.Context, in *ListSiteRequest, opts ...grpc.CallOption) (*ListSiteResponse, error) {
	...
	err := c.cc.Invoke(ctx, SiteService_ListSite_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SiteService_ListSite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SiteService_ListSite_FullMethodName,
	}

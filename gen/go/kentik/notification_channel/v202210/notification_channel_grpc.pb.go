...
const (
	NotificationChannelService_ListNotificationChannels_FullMethodName   = "/kentik.notification_channel.v202210.NotificationChannelService/ListNotificationChannels"
	NotificationChannelService_GetNotificationChannel_FullMethodName     = "/kentik.notification_channel.v202210.NotificationChannelService/GetNotificationChannel"
	NotificationChannelService_SearchNotificationChannels_FullMethodName = "/kentik.notification_channel.v202210.NotificationChannelService/SearchNotificationChannels"
)
...
func (c *notificationChannelServiceClient) SearchNotificationChannels(ctx context.Context, in *SearchNotificationChannelsRequest, opts ...grpc.CallOption) (*SearchNotificationChannelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotificationChannelService_SearchNotificationChannels_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNotificationChannelServiceServer should be embedded to have
...
func RegisterNotificationChannelServiceServer(s grpc.ServiceRegistrar, srv NotificationChannelServiceServer) {
	// If the following call pancis, it indicates UnimplementedNotificationChannelServiceServer was
...
func _NotificationChannelService_SearchNotificationChannels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationChannelService_SearchNotificationChannels_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

...
// field getters, which are defined as any methods of the same signature as those
// generated for the receiver type, with a name starting with Get.
func (x *SearchNotificationChannelsRequest) Proto_ShallowCopy(v interface{}) {
	switch v := v.(type) {
	case *SearchNotificationChannelsRequest:
		x.NamePattern = v.GetNamePattern()
		x.Types = v.GetTypes()
		x.IncludeDisabled = v.GetIncludeDisabled()
	default:
		if v, ok := v.(interface{ GetNamePattern() string }); ok {
			x.NamePattern = v.GetNamePattern()
		}
		if v, ok := v.(interface{ GetTypes() []ChannelType }); ok {
			x.Types = v.GetTypes()
		}
		if v, ok := v.(interface{ GetIncludeDisabled() bool }); ok {
			x.IncludeDisabled = v.GetIncludeDisabled()
		}
	}
}
...
// Proto_ShallowClone returns a shallow copy of the receiver or nil if it's nil.
func (x *SearchNotificationChannelsRequest) Proto_ShallowClone() (c *SearchNotificationChannelsRequest) {
	if x != nil {
		c = new(SearchNotificationChannelsRequest)
		c.NamePattern = x.NamePattern
		c.Types = x.Types
		c.IncludeDisabled = x.IncludeDisabled
	}
	return
}
...
// field getters, which are defined as any methods of the same signature as those
// generated for the receiver type, with a name starting with Get.
func (x *SearchNotificationChannelsResponse) Proto_ShallowCopy(v interface{}) {
	switch v := v.(type) {
	case *SearchNotificationChannelsResponse:
		x.NotificationChannels = v.GetNotificationChannels()
		x.InvalidCount = v.GetInvalidCount()
	default:
		if v, ok := v.(interface{ GetNotificationChannels() []*NotificationChannel }); ok {
...
// Proto_ShallowClone returns a shallow copy of the receiver or nil if it's nil.
func (x *SearchNotificationChannelsResponse) Proto_ShallowClone() (c *SearchNotificationChannelsResponse) {
	if x != nil {
		c = new(SearchNotificationChannelsResponse)
		c.NotificationChannels = x.NotificationChannels
		c.InvalidCount = x.InvalidCount
	}
	return

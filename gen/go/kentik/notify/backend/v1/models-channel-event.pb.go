...
func (ChannelVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_kentik_notify_backend_v1_models_channel_event_proto_enumTypes[0].Descriptor()
}

func (ChannelVersion) Type() protoreflect.EnumType {
	return &file_kentik_notify_backend_v1_models_channel_event_proto_enumTypes[0]
}
...
func (ChannelVersion) EnumDescriptor() ([]byte, []int) {
	return file_kentik_notify_backend_v1_models_channel_event_proto_rawDescGZIP(), []int{0}
}
...
func (x *ChannelEvent) Reset() {
	*x = ChannelEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_kentik_notify_backend_v1_models_channel_event_proto_msgTypes[0]
...
var File_kentik_notify_backend_v1_models_channel_event_proto protoreflect.FileDescriptor

var file_kentik_notify_backend_v1_models_channel_event_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x64, 0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2d, 0x65, 0x76,
	...
	0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x6b, 0x65, 0x6e, 0x74, 0x69, 0x6b, 0x2f, 0x6e,
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x2f, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f, 0x76, 0x31,
	0x3b, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_kentik_notify_backend_v1_models_channel_event_proto_rawDescOnce sync.Once
	file_kentik_notify_backend_v1_models_channel_event_proto_rawDescData = file_kentik_notify_backend_v1_models_channel_event_proto_rawDesc
)

func file_kentik_notify_backend_v1_models_channel_event_proto_rawDescGZIP() []byte {
	file_kentik_notify_backend_v1_models_channel_event_proto_rawDescOnce.Do(func() {
		file_kentik_notify_backend_v1_models_channel_event_proto_rawDescData = protoimpl.X.CompressGZIP(file_kentik_notify_backend_v1_models_channel_event_proto_rawDescData)
	})
	return file_kentik_notify_backend_v1_models_channel_event_proto_rawDescData
}

var file_kentik_notify_backend_v1_models_channel_event_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_kentik_notify_backend_v1_models_channel_event_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_kentik_notify_backend_v1_models_channel_event_proto_goTypes = []interface{}{
...
var file_kentik_notify_backend_v1_models_channel_event_proto_depIdxs = []int32{
...
func init() { file_kentik_notify_backend_v1_models_channel_event_proto_init() }
func file_kentik_notify_backend_v1_models_channel_event_proto_init() {
	if File_kentik_notify_backend_v1_models_channel_event_proto != nil {
		return
	}
	file_kentik_notify_backend_v1_models_event_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_kentik_notify_backend_v1_models_channel_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_kentik_notify_backend_v1_models_channel_event_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_kentik_notify_backend_v1_models_channel_event_proto_goTypes,
		DependencyIndexes: file_kentik_notify_backend_v1_models_channel_event_proto_depIdxs,
		EnumInfos:         file_kentik_notify_backend_v1_models_channel_event_proto_enumTypes,
		MessageInfos:      file_kentik_notify_backend_v1_models_channel_event_proto_msgTypes,
	}.Build()
	File_kentik_notify_backend_v1_models_channel_event_proto = out.File
	file_kentik_notify_backend_v1_models_channel_event_proto_rawDesc = nil
	file_kentik_notify_backend_v1_models_channel_event_proto_goTypes = nil
	file_kentik_notify_backend_v1_models_channel_event_proto_depIdxs = nil
}

...
func (c *cloudExportAdminServiceClient) CreateCloudExport(ctx context.Context, in *CreateCloudExportRequest, opts ...grpc.CallOption) (*CreateCloudExportResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kentik.cloud_export.v202210.CloudExportAdminService/CreateCloudExport", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cloudExportAdminServiceClient) ListCloudExports(ctx context.Context, in *ListCloudExportsRequest, opts ...grpc.CallOption) (*ListCloudExportsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kentik.cloud_export.v202210.CloudExportAdminService/ListCloudExports", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cloudExportAdminServiceClient) GetCloudExport(ctx context.Context, in *GetCloudExportRequest, opts ...grpc.CallOption) (*GetCloudExportResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kentik.cloud_export.v202210.CloudExportAdminService/GetCloudExport", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cloudExportAdminServiceClient) UpdateCloudExport(ctx context.Context, in *UpdateCloudExportRequest, opts ...grpc.CallOption) (*UpdateCloudExportResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kentik.cloud_export.v202210.CloudExportAdminService/UpdateCloudExport", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cloudExportAdminServiceClient) DeleteCloudExport(ctx context.Context, in *DeleteCloudExportRequest, opts ...grpc.CallOption) (*DeleteCloudExportResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kentik.cloud_export.v202210.CloudExportAdminService/DeleteCloudExport", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CloudExportAdminService_CreateCloudExport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kentik.cloud_export.v202210.CloudExportAdminService/CreateCloudExport",
	}
...
func _CloudExportAdminService_ListCloudExports_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kentik.cloud_export.v202210.CloudExportAdminService/ListCloudExports",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CloudExportAdminService_GetCloudExport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kentik.cloud_export.v202210.CloudExportAdminService/GetCloudExport",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CloudExportAdminService_UpdateCloudExport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kentik.cloud_export.v202210.CloudExportAdminService/UpdateCloudExport",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CloudExportAdminService_DeleteCloudExport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kentik.cloud_export.v202210.CloudExportAdminService/DeleteCloudExport",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

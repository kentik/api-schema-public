...
func (x *CloudExport) GetProperties() isCloudExport_Properties {
	if x != nil {
		return x.Properties
	}
	return nil
...
func (x *CloudExport) GetAws() *AwsProperties {
	if x != nil {
		if x, ok := x.Properties.(*CloudExport_Aws); ok {
			return x.Aws
		}
	}
	return nil
...
func (x *CloudExport) GetAzure() *AzureProperties {
	if x != nil {
		if x, ok := x.Properties.(*CloudExport_Azure); ok {
			return x.Azure
		}
	}
	return nil
...
func (x *CloudExport) GetGce() *GceProperties {
	if x != nil {
		if x, ok := x.Properties.(*CloudExport_Gce); ok {
			return x.Gce
		}
	}
	return nil
...
func (x *CloudExport) GetIbm() *IbmProperties {
	if x != nil {
		if x, ok := x.Properties.(*CloudExport_Ibm); ok {
			return x.Ibm
		}
	}
	return nil
...
const file_kentik_cloud_export_v202101beta1_cloud_export_proto_rawDesc = "" +
	"\n" +
	...
	"\vCloudExport\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12E\n" +
	"\x04type\x18\x0f \x01(\x0e21.kentik.cloud_export.v202101beta1.CloudExportTypeR\x04type\x12\x18\n" +
	"\aenabled\x18\x02 \x01(\bR\aenabled\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12\x19\n" +
	"\bapi_root\x18\x05 \x01(\tR\aapiRoot\x12\x1b\n" +
	"\tflow_dest\x18\x06 \x01(\tR\bflowDest\x12\x17\n" +
	"\aplan_id\x18\a \x01(\tR\x06planId\x12%\n" +
	"\x0ecloud_provider\x18\b \x01(\tR\rcloudProvider\x12C\n" +
	"\x03aws\x18\t \x01(\v2/.kentik.cloud_export.v202101beta1.AwsPropertiesH\x00R\x03aws\x12I\n" +
	"\x05azure\x18\n" +
	" \x01(\v21.kentik.cloud_export.v202101beta1.AzurePropertiesH\x00R\x05azure\x12C\n" +
	"\x03gce\x18\v \x01(\v2/.kentik.cloud_export.v202101beta1.GcePropertiesH\x00R\x03gce\x12C\n" +
	"\x03ibm\x18\f \x01(\v2/.kentik.cloud_export.v202101beta1.IbmPropertiesH\x00R\x03ibm\x12A\n" +
	"\x03bgp\x18\r \x01(\v2/.kentik.cloud_export.v202101beta1.BgpPropertiesR\x03bgp\x12O\n" +
	"\x0ecurrent_status\x18\x0e \x01(\v2(.kentik.cloud_export.v202101beta1.StatusR\rcurrentStatusB\f\n" +
	"\n" +
	"properties\"\x7f\n" +
	...
	"\x1asecurity_principal_enabled\x18\x05 \x01(\bR\x18securityPrincipalEnabled\"M\n" +
	"\rGceProperties\x12\x18\n" +
	"\aproject\x18\x01 \x01(\tR\aproject\x12\"\n" +
	"\fsubscription\x18\x02 \x01(\tR\fsubscription\"'\n" +
	"\rIbmProperties\x12\x16\n" +
	"\x06bucket\x18\x01 \x01(\tR\x06bucket\"\x8d\x02\n" +
	"\x06Status\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12#\n" +
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\x129\n" +
	"\n" +
	"flow_found\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueR\tflowFound\x129\n" +
	"\n" +
	"api_access\x18\x04 \x01(\v2\x1a.google.protobuf.BoolValueR\tapiAccess\x12P\n" +
	"\x16storage_account_access\x18\x05 \x01(\v2\x1a.google.protobuf.BoolValueR\x14storageAccountAccess\"a\n" +
	"\x18CreateCloudExportRequest\x12E\n" +
	"\x06export\x18\x01 \x01(\v2-.kentik.cloud_export.v202101beta1.CloudExportR\x06export\"b\n" +
	"\x19CreateCloudExportResponse\x12E\n" +
	"\x06export\x18\x01 \x01(\v2-.kentik.cloud_export.v202101beta1.CloudExportR\x06export\"\x18\n" +
	"\x16ListCloudExportRequest\"\x96\x01\n" +
	"\x17ListCloudExportResponse\x12G\n" +
	"\aexports\x18\x01 \x03(\v2-.kentik.cloud_export.v202101beta1.CloudExportR\aexports\x122\n" +
	...
	"\x16GetCloudExportResponse\x12E\n" +
	"\x06export\x18\x01 \x01(\v2-.kentik.cloud_export.v202101beta1.CloudExportR\x06export\"\x90\x01\n" +
	"\x17PatchCloudExportRequest\x12E\n" +
	"\x06export\x18\x01 \x01(\v2-.kentik.cloud_export.v202101beta1.CloudExportR\x06export\x12.\n" +
	"\x04mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\x04mask\"a\n" +
	"\x18PatchCloudExportResponse\x12E\n" +
	"\x06export\x18\x01 \x01(\v2-.kentik.cloud_export.v202101beta1.CloudExportR\x06export\"a\n" +
	"\x18UpdateCloudExportRequest\x12E\n" +
	"\x06export\x18\x01 \x01(\v2-.kentik.cloud_export.v202101beta1.CloudExportR\x06export\"b\n" +
	"\x19UpdateCloudExportResponse\x12E\n" +
	"\x06export\x18\x01 \x01(\v2-.kentik.cloud_export.v202101beta1.CloudExportR\x06export\"*\n" +
	"\x18DeleteCloudExportRequest\x12\x0e\n" +
	...
	"\"CLOUD_EXPORT_TYPE_CUSTOMER_MANAGED\x10\x022\xad\x0f\n" +
	"\x17CloudExportAdminService\x12\xba\x02\n" +
	"\x11CreateCloudExport\x12:.kentik.cloud_export.v202101beta1.CreateCloudExportRequest\x1a;.kentik.cloud_export.v202101beta1.CreateCloudExportResponse\"\xab\x01\x92A_\x12\x14Create Cloud Export.\x1a9Create cloud export from request. Returns created export.*\fExportCreate\xf2\xd7\x02\x18admin.cloud_export:write\x82\xd3\xe4\x93\x02':\x01*\"\"/cloud_export/v202101beta1/exports\x12\x92\x02\n" +
	"\x0fListCloudExport\x128.kentik.cloud_export.v202101beta1.ListCloudExportRequest\x1a9.kentik.cloud_export.v202101beta1.ListCloudExportResponse\"\x89\x01\x92AA\x12\x12List Cloud Export.\x1a\x1fReturns a list of cloud export.*\n" +
	"ExportList\xf2\xd7\x02\x17admin.cloud_export:read\x82\xd3\xe4\x93\x02$\x12\"/cloud_export/v202101beta1/exports\x12\xbc\x02\n" +
	"\x0eGetCloudExport\x127.kentik.cloud_export.v202101beta1.GetCloudExportRequest\x1a8.kentik.cloud_export.v202101beta1.GetCloudExportResponse\"\xb6\x01\x92Ai\x12 Get information about an export.\x1a:Returns information about export specified with export ID.*\tExportGet\xf2\xd7\x02\x17admin.cloud_export:read\x82\xd3\xe4\x93\x02)\x12'/cloud_export/v202101beta1/exports/{id}\x12\xd9\x02\n" +
	"\x10PatchCloudExport\x129.kentik.cloud_export.v202101beta1.PatchCloudExportRequest\x1a:.kentik.cloud_export.v202101beta1.PatchCloudExportResponse\"\xcd\x01\x92Au\x12\x10Patch an export.\x1aTPartially Updates the attributes of export specified with id and update_mask fields.*\vExportPatch\xf2\xd7\x02\x18admin.cloud_export:write\x82\xd3\xe4\x93\x023:\x01*2./cloud_export/v202101beta1/exports/{export.id}\x12\xc2\x02\n" +
	"\x11UpdateCloudExport\x12:.kentik.cloud_export.v202101beta1.UpdateCloudExportRequest\x1a;.kentik.cloud_export.v202101beta1.UpdateCloudExportResponse\"\xb3\x01\x92A[\x12\x11Update an export.\x1a8Replaces the entire export attributes specified with id.*\fExportUpdate\xf2\xd7\x02\x18admin.cloud_export:write\x82\xd3\xe4\x93\x023:\x01*\x1a./cloud_export/v202101beta1/exports/{export.id}\x12\xa5\x02\n" +
	"\x11DeleteCloudExport\x12:.kentik.cloud_export.v202101beta1.DeleteCloudExportRequest\x1a;.kentik.cloud_export.v202101beta1.DeleteCloudExportResponse\"\x96\x01\x92AH\x12\x11Delete an export.\x1a%Deletes the export specified with id.*\fExportDelete\xf2\xd7\x02\x18admin.cloud_export:write\x82\xd3\xe4\x93\x02)*'/cloud_export/v202101beta1/exports/{id}\x1a8\xcaA\x1bcloud_export.api.kentik.com\xea\xd7\x02\x12admin.cloud_export\x90\xd8\x02\x03B\xf0\x03\x92A\x92\x03\x12\xab\x01\n" +
	"\x16Cloud Export Admin API\x12K--- This API has been deprecated and will be removed in the near future ---\"7\n" +
	...
	"\t\n" +
	"\x05token\x12\x00r]\n" +
	"%General information about Kentik APIs\x124https://kb.kentik.com/v0/Ab09.htm#Ab09-APIs_OverviewZXgithub.com/kentik/api-schema-public/gen/go/kentik/cloud_export/v202101beta1;cloud_exportb\x06proto3"

var (
	file_kentik_cloud_export_v202101beta1_cloud_export_proto_rawDescOnce sync.Once
	file_kentik_cloud_export_v202101beta1_cloud_export_proto_rawDescData []byte
)
...
func file_kentik_cloud_export_v202101beta1_cloud_export_proto_rawDescGZIP() []byte {
	file_kentik_cloud_export_v202101beta1_cloud_export_proto_rawDescOnce.Do(func() {
		file_kentik_cloud_export_v202101beta1_cloud_export_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_kentik_cloud_export_v202101beta1_cloud_export_proto_rawDesc), len(file_kentik_cloud_export_v202101beta1_cloud_export_proto_rawDesc)))
	})
...
var file_kentik_cloud_export_v202101beta1_cloud_export_proto_goTypes = []any{
...
func file_kentik_cloud_export_v202101beta1_cloud_export_proto_init() {
	...
	file_kentik_cloud_export_v202101beta1_cloud_export_proto_msgTypes[0].OneofWrappers = []any{
		(*CloudExport_Aws)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_kentik_cloud_export_v202101beta1_cloud_export_proto_rawDesc), len(file_kentik_cloud_export_v202101beta1_cloud_export_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   19,
			NumExtensions: 0,
			NumServices:   1,

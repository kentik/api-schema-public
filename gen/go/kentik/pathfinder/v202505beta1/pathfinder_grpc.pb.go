...
const (
	PathfinderAdminService_CreatePathfinderReport_FullMethodName = "/kentik.pathfinder.v202505beta1.PathfinderAdminService/CreatePathfinderReport"
)
...
func (c *pathfinderAdminServiceClient) CreatePathfinderReport(ctx context.Context, in *CreatePathfinderReportRequest, opts ...grpc.CallOption) (*CreatePathfinderReportResponse, error) {
	...
	err := c.cc.Invoke(ctx, PathfinderAdminService_CreatePathfinderReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPathfinderAdminServiceServer should be embedded to have
...
func (UnimplementedPathfinderAdminServiceServer) testEmbeddedByValue() {}
...
func RegisterPathfinderAdminServiceServer(s grpc.ServiceRegistrar, srv PathfinderAdminServiceServer) {
	// If the following call pancis, it indicates UnimplementedPathfinderAdminServiceServer was
...
func _PathfinderAdminService_CreatePathfinderReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PathfinderAdminService_CreatePathfinderReport_FullMethodName,
	}

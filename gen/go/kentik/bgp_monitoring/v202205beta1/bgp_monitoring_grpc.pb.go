...
func (c *bgpMonitoringAdminServiceClient) ListMonitors(ctx context.Context, in *ListMonitorsRequest, opts ...grpc.CallOption) (*ListMonitorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/ListMonitors", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bgpMonitoringAdminServiceClient) CreateMonitor(ctx context.Context, in *CreateMonitorRequest, opts ...grpc.CallOption) (*CreateMonitorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/CreateMonitor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bgpMonitoringAdminServiceClient) GetMonitor(ctx context.Context, in *GetMonitorRequest, opts ...grpc.CallOption) (*GetMonitorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/GetMonitor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bgpMonitoringAdminServiceClient) UpdateMonitor(ctx context.Context, in *UpdateMonitorRequest, opts ...grpc.CallOption) (*UpdateMonitorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/UpdateMonitor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bgpMonitoringAdminServiceClient) DeleteMonitor(ctx context.Context, in *DeleteMonitorRequest, opts ...grpc.CallOption) (*DeleteMonitorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/DeleteMonitor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bgpMonitoringAdminServiceClient) SetMonitorStatus(ctx context.Context, in *SetMonitorStatusRequest, opts ...grpc.CallOption) (*SetMonitorStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/SetMonitorStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BgpMonitoringAdminService_ListMonitors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/ListMonitors",
	}
...
func _BgpMonitoringAdminService_CreateMonitor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/CreateMonitor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BgpMonitoringAdminService_GetMonitor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/GetMonitor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BgpMonitoringAdminService_UpdateMonitor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/UpdateMonitor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BgpMonitoringAdminService_DeleteMonitor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/DeleteMonitor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BgpMonitoringAdminService_SetMonitorStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/SetMonitorStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
type BgpMonitoringDataServiceClient interface {
	...
	GetEventsForMonitor(ctx context.Context, in *GetEventsForMonitorRequest, opts ...grpc.CallOption) (*GetEventsForMonitorResponse, error)
...
func (c *bgpMonitoringDataServiceClient) GetEventsForMonitor(ctx context.Context, in *GetEventsForMonitorRequest, opts ...grpc.CallOption) (*GetEventsForMonitorResponse, error) {
	out := new(GetEventsForMonitorResponse)
	err := c.cc.Invoke(ctx, "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringDataService/GetEventsForMonitor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BgpMonitoringDataServiceServer interface {
	// Get measurement results for a set of tests
	GetEventsForMonitor(context.Context, *GetEventsForMonitorRequest) (*GetEventsForMonitorResponse, error)
...
func (UnimplementedBgpMonitoringDataServiceServer) GetEventsForMonitor(context.Context, *GetEventsForMonitorRequest) (*GetEventsForMonitorResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetEventsForMonitor not implemented")
}
...
func _BgpMonitoringDataService_GetEventsForMonitor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetEventsForMonitorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BgpMonitoringDataServiceServer).GetEventsForMonitor(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringDataService/GetEventsForMonitor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BgpMonitoringDataServiceServer).GetEventsForMonitor(ctx, req.(*GetEventsForMonitorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BgpMonitoringDataService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetEventsForMonitor",
			Handler:    _BgpMonitoringDataService_GetEventsForMonitor_Handler,
		},
		{

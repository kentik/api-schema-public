...
const (
	BgpMonitoringAdminService_ListMonitors_FullMethodName     = "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/ListMonitors"
	BgpMonitoringAdminService_CreateMonitor_FullMethodName    = "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/CreateMonitor"
	BgpMonitoringAdminService_GetMonitor_FullMethodName       = "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/GetMonitor"
	BgpMonitoringAdminService_UpdateMonitor_FullMethodName    = "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/UpdateMonitor"
	BgpMonitoringAdminService_DeleteMonitor_FullMethodName    = "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/DeleteMonitor"
	BgpMonitoringAdminService_SetMonitorStatus_FullMethodName = "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService/SetMonitorStatus"
)
...
func (c *bgpMonitoringAdminServiceClient) ListMonitors(ctx context.Context, in *ListMonitorsRequest, opts ...grpc.CallOption) (*ListMonitorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BgpMonitoringAdminService_ListMonitors_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bgpMonitoringAdminServiceClient) CreateMonitor(ctx context.Context, in *CreateMonitorRequest, opts ...grpc.CallOption) (*CreateMonitorResponse, error) {
	...
	err := c.cc.Invoke(ctx, BgpMonitoringAdminService_CreateMonitor_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bgpMonitoringAdminServiceClient) GetMonitor(ctx context.Context, in *GetMonitorRequest, opts ...grpc.CallOption) (*GetMonitorResponse, error) {
	...
	err := c.cc.Invoke(ctx, BgpMonitoringAdminService_GetMonitor_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bgpMonitoringAdminServiceClient) UpdateMonitor(ctx context.Context, in *UpdateMonitorRequest, opts ...grpc.CallOption) (*UpdateMonitorResponse, error) {
	...
	err := c.cc.Invoke(ctx, BgpMonitoringAdminService_UpdateMonitor_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bgpMonitoringAdminServiceClient) DeleteMonitor(ctx context.Context, in *DeleteMonitorRequest, opts ...grpc.CallOption) (*DeleteMonitorResponse, error) {
	...
	err := c.cc.Invoke(ctx, BgpMonitoringAdminService_DeleteMonitor_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bgpMonitoringAdminServiceClient) SetMonitorStatus(ctx context.Context, in *SetMonitorStatusRequest, opts ...grpc.CallOption) (*SetMonitorStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, BgpMonitoringAdminService_SetMonitorStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedBgpMonitoringAdminServiceServer should be embedded to have
...
func (UnimplementedBgpMonitoringAdminServiceServer) testEmbeddedByValue() {}
...
func RegisterBgpMonitoringAdminServiceServer(s grpc.ServiceRegistrar, srv BgpMonitoringAdminServiceServer) {
	// If the following call pancis, it indicates UnimplementedBgpMonitoringAdminServiceServer was
...
func _BgpMonitoringAdminService_ListMonitors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BgpMonitoringAdminService_ListMonitors_FullMethodName,
	}
...
func _BgpMonitoringAdminService_CreateMonitor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BgpMonitoringAdminService_CreateMonitor_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BgpMonitoringAdminService_GetMonitor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BgpMonitoringAdminService_GetMonitor_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BgpMonitoringAdminService_UpdateMonitor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BgpMonitoringAdminService_UpdateMonitor_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BgpMonitoringAdminService_DeleteMonitor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BgpMonitoringAdminService_DeleteMonitor_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BgpMonitoringAdminService_SetMonitorStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BgpMonitoringAdminService_SetMonitorStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var BgpMonitoringAdminService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kentik.bgp_monitoring.v202205beta1.BgpMonitoringAdminService",
	...
	Metadata: "kentik/bgp_monitoring/v202205beta1/bgp_monitoring.proto",
}

const (
	BgpMonitoringDataService_GetMetricsForTarget_FullMethodName = "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringDataService/GetMetricsForTarget"
	BgpMonitoringDataService_GetRoutesForTarget_FullMethodName  = "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringDataService/GetRoutesForTarget"
)
...
func (c *bgpMonitoringDataServiceClient) GetMetricsForTarget(ctx context.Context, in *GetMetricsForTargetRequest, opts ...grpc.CallOption) (*GetMetricsForTargetResponse, error) {
	...
	err := c.cc.Invoke(ctx, BgpMonitoringDataService_GetMetricsForTarget_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bgpMonitoringDataServiceClient) GetRoutesForTarget(ctx context.Context, in *GetRoutesForTargetRequest, opts ...grpc.CallOption) (*GetRoutesForTargetResponse, error) {
	...
	err := c.cc.Invoke(ctx, BgpMonitoringDataService_GetRoutesForTarget_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedBgpMonitoringDataServiceServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedBgpMonitoringDataServiceServer) testEmbeddedByValue() {}
...
func RegisterBgpMonitoringDataServiceServer(s grpc.ServiceRegistrar, srv BgpMonitoringDataServiceServer) {
	// If the following call pancis, it indicates UnimplementedBgpMonitoringDataServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _BgpMonitoringDataService_GetMetricsForTarget_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BgpMonitoringDataService_GetMetricsForTarget_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BgpMonitoringDataService_GetRoutesForTarget_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BgpMonitoringDataService_GetRoutesForTarget_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var BgpMonitoringDataService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kentik.bgp_monitoring.v202205beta1.BgpMonitoringDataService",

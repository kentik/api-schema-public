...
func request_BgpMonitoringDataService_GetEventsForMonitor_0(ctx context.Context, marshaler runtime.Marshaler, client BgpMonitoringDataServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetEventsForMonitorRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetEventsForMonitor(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_BgpMonitoringDataService_GetEventsForMonitor_0(ctx context.Context, marshaler runtime.Marshaler, server BgpMonitoringDataServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetEventsForMonitorRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetEventsForMonitor(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterBgpMonitoringDataServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BgpMonitoringDataServiceServer) error {
	...
	mux.Handle("POST", pattern_BgpMonitoringDataService_GetEventsForMonitor_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringDataService/GetEventsForMonitor")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_BgpMonitoringDataService_GetEventsForMonitor_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_BgpMonitoringDataService_GetEventsForMonitor_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterBgpMonitoringDataServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BgpMonitoringDataServiceClient) error {
	...
	mux.Handle("POST", pattern_BgpMonitoringDataService_GetEventsForMonitor_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/kentik.bgp_monitoring.v202205beta1.BgpMonitoringDataService/GetEventsForMonitor")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_BgpMonitoringDataService_GetEventsForMonitor_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_BgpMonitoringDataService_GetEventsForMonitor_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"bgp_monitoring", "v202205beta1", "events"}, ""))
...
var (
	forward_BgpMonitoringDataService_GetEventsForMonitor_0 = runtime.ForwardResponseMessage

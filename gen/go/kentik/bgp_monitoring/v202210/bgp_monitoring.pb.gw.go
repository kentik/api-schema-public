...
func RegisterBgpMonitoringAdminServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BgpMonitoringAdminServiceServer) error {
	...
	mux.Handle("GET", pattern_BgpMonitoringAdminService_ListMonitors_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringAdminService/ListMonitors")
		if err != nil {
	...
	mux.Handle("POST", pattern_BgpMonitoringAdminService_CreateMonitor_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringAdminService/CreateMonitor")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_BgpMonitoringAdminService_GetMonitor_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringAdminService/GetMonitor")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_BgpMonitoringAdminService_UpdateMonitor_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringAdminService/UpdateMonitor")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_BgpMonitoringAdminService_DeleteMonitor_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringAdminService/DeleteMonitor")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_BgpMonitoringAdminService_SetMonitorStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringAdminService/SetMonitorStatus")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterBgpMonitoringDataServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BgpMonitoringDataServiceServer) error {
	...
	mux.Handle("POST", pattern_BgpMonitoringDataService_GetMetricsForTarget_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringDataService/GetMetricsForTarget")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_BgpMonitoringDataService_GetRoutesForTarget_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringDataService/GetRoutesForTarget")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterBgpMonitoringAdminServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BgpMonitoringAdminServiceClient) error {
	...
	mux.Handle("GET", pattern_BgpMonitoringAdminService_ListMonitors_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringAdminService/ListMonitors")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_BgpMonitoringAdminService_CreateMonitor_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringAdminService/CreateMonitor")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_BgpMonitoringAdminService_GetMonitor_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringAdminService/GetMonitor")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_BgpMonitoringAdminService_UpdateMonitor_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringAdminService/UpdateMonitor")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_BgpMonitoringAdminService_DeleteMonitor_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringAdminService/DeleteMonitor")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_BgpMonitoringAdminService_SetMonitorStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringAdminService/SetMonitorStatus")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_BgpMonitoringAdminService_ListMonitors_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"bgp_monitoring", "v202210", "monitors"}, ""))

	pattern_BgpMonitoringAdminService_CreateMonitor_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"bgp_monitoring", "v202210", "monitors"}, ""))

	pattern_BgpMonitoringAdminService_GetMonitor_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"bgp_monitoring", "v202210", "monitors", "id"}, ""))

	pattern_BgpMonitoringAdminService_UpdateMonitor_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"bgp_monitoring", "v202210", "monitors", "monitor.id"}, ""))

	pattern_BgpMonitoringAdminService_DeleteMonitor_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"bgp_monitoring", "v202210", "monitors", "id"}, ""))

	pattern_BgpMonitoringAdminService_SetMonitorStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"bgp_monitoring", "v202210", "monitors", "id", "status"}, ""))
)
...
func RegisterBgpMonitoringDataServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BgpMonitoringDataServiceClient) error {
	...
	mux.Handle("POST", pattern_BgpMonitoringDataService_GetMetricsForTarget_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringDataService/GetMetricsForTarget")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_BgpMonitoringDataService_GetRoutesForTarget_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/kentik.bgp_monitoring.v202210.BgpMonitoringDataService/GetRoutesForTarget")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_BgpMonitoringDataService_GetMetricsForTarget_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"bgp_monitoring", "v202210", "metrics"}, ""))

	pattern_BgpMonitoringDataService_GetRoutesForTarget_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"bgp_monitoring", "v202210", "routes"}, ""))
)

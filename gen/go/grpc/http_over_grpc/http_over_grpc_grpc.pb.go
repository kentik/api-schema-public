...
// All implementations should embed UnimplementedHTTPOverGRPCServer
...
// UnimplementedHTTPOverGRPCServer should be embedded to have forward compatible implementations.
type UnimplementedHTTPOverGRPCServer struct {
}

func (UnimplementedHTTPOverGRPCServer) HTTPRequest(context.Context, *HTTPOverGRPCRequest) (*HTTPOverGRPCReply, error) {
...
var _HTTPOverGRPC_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc/http_over_grpc/http_over_grpc.proto",
}

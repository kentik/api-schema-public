...
var (
	filter_SyntheticsAdminService_PatchTest_0 = &utilities.DoubleArray{Encoding: map[string]int{"test": 0, "id": 1}, Base: []int{1, 1, 1, 0}, Check: []int{0, 1, 2, 3}}
)
...
func request_SyntheticsAdminService_PatchTest_0(ctx context.Context, marshaler runtime.Marshaler, client SyntheticsAdminServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_SyntheticsAdminService_PatchTest_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

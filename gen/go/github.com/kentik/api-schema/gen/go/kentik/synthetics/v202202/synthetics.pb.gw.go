...
func RegisterSyntheticsDataServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SyntheticsDataServiceServer) error {
	...
	mux.Handle("POST", pattern_SyntheticsDataService_GetHealthForTests_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/kentik.synthetics.v202202.SyntheticsDataService/GetHealthForTests")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterSyntheticsDataServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SyntheticsDataServiceClient) error {
	...
	mux.Handle("POST", pattern_SyntheticsDataService_GetHealthForTests_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/kentik.synthetics.v202202.SyntheticsDataService/GetHealthForTests")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_SyntheticsDataService_GetHealthForTests_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"synthetics", "v202202", "health"}, ""))

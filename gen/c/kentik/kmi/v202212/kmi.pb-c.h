...
typedef enum {
  ...
  KENTIK__KMI__V202212__RANKING___RANK_RANK = 5
...
typedef enum {
  ...
  KENTIK__KMI__V202212__RANKING___RANK_CHANGE_RANK_CHANGE = 6
...
typedef enum {
  ...
  KENTIK__KMI__V202212__RANKING___SCORE_SCORE = 7
...
typedef enum {
  ...
  KENTIK__KMI__V202212__RANKING___SCORE_CHANGE_SCORE_CHANGE = 8
...
#define KENTIK__KMI__V202212__RANKING__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&kentik__kmi__v202212__ranking__descriptor) \
    , (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, KENTIK__KMI__V202212__RANKING___ASN__NOT_SET, {0}, KENTIK__KMI__V202212__RANKING___RANK__NOT_SET, {0}, KENTIK__KMI__V202212__RANKING___RANK_CHANGE__NOT_SET, {0}, KENTIK__KMI__V202212__RANKING___SCORE__NOT_SET, {0}, KENTIK__KMI__V202212__RANKING___SCORE_CHANGE__NOT_SET, {0} }
...
typedef enum {
  KENTIK__KMI__V202212__CUSTOMER_PROVIDER___EDGE_TYPE__NOT_SET = 0,
  KENTIK__KMI__V202212__CUSTOMER_PROVIDER___EDGE_TYPE_EDGE_TYPE = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(KENTIK__KMI__V202212__CUSTOMER_PROVIDER___EDGE_TYPE)
} Kentik__Kmi__V202212__CustomerProvider__EdgeTypeCase;

typedef enum {
  KENTIK__KMI__V202212__CUSTOMER_PROVIDER___SCORE__NOT_SET = 0,
  KENTIK__KMI__V202212__CUSTOMER_PROVIDER___SCORE_SCORE = 6
...
typedef enum {
  ...
  KENTIK__KMI__V202212__CUSTOMER_PROVIDER___SINGLEHOMED_CUSTOMER_SINGLEHOMED_CUSTOMER = 7
...
typedef enum {
  ...
  KENTIK__KMI__V202212__CUSTOMER_PROVIDER___MUTUAL_CUSTOMER_MUTUAL_CUSTOMER = 8
...
typedef enum {
  ...
  KENTIK__KMI__V202212__CUSTOMER_PROVIDER___MUTUAL_PROVIDER_MUTUAL_PROVIDER = 9
...
struct  _Kentik__Kmi__V202212__CustomerProvider
{
  ...
  Kentik__Kmi__V202212__CustomerProvider__EdgeTypeCase _edge_type_case;
  union {
    uint32_t edge_type;
  };
...
#define KENTIK__KMI__V202212__CUSTOMER_PROVIDER__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&kentik__kmi__v202212__customer_provider__descriptor) \
    , (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, KENTIK__KMI__V202212__CUSTOMER_PROVIDER___ASN__NOT_SET, {0}, KENTIK__KMI__V202212__CUSTOMER_PROVIDER___EDGE_TYPE__NOT_SET, {0}, KENTIK__KMI__V202212__CUSTOMER_PROVIDER___SCORE__NOT_SET, {0}, KENTIK__KMI__V202212__CUSTOMER_PROVIDER___SINGLEHOMED_CUSTOMER__NOT_SET, {0}, KENTIK__KMI__V202212__CUSTOMER_PROVIDER___MUTUAL_CUSTOMER__NOT_SET, {0}, KENTIK__KMI__V202212__CUSTOMER_PROVIDER___MUTUAL_PROVIDER__NOT_SET, {0} }

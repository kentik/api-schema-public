...
const ::uint32_t
    TableStruct_kentik_2fdevice_2fv202504beta2_2fdevice_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::kentik::device::v202504beta2::DeviceDetailed, _impl_.os_name_),
        PROTOBUF_FIELD_OFFSET(::kentik::device::v202504beta2::DeviceDetailed, _impl_.os_version_),
        PROTOBUF_FIELD_OFFSET(::kentik::device::v202504beta2::DeviceDetailed, _impl_.serial_number_),
        ~0u,
        ~0u,
        ~0u,
        ~0u,
...
const char descriptor_table_protodef_kentik_2fdevice_2fv202504beta2_2fdevice_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "\023\222A\0202\016Dialout serverR\rdialoutServer\"\276(\n\016"
    ...
    "\rBU\222AR2PMonitoring template - The ID of "
    "the monitoring template assigned to this"
    " device.R\024monitoringTemplateId\0223\n\007os_nam"
    "e\030A \001(\tB\032\222A\0272\025Operating system nameR\006osN"
    "ame\022<\n\nos_version\030B \001(\tB\035\222A\0322\030Operating "
    "system versionR\tosVersion\0227\n\rserial_numb"
    "er\030C \001(\tB\022\222A\0172\rSerial numberR\014serialNumb"
    "erB\020\n\016_minimize_snmp\"9\n\013DeviceQuery\022*\n\021n"
    "o_custom_columns\030\001 \001(\010R\017noCustomColumns\""
    "-\n\014LabelConcise\022\035\n\002id\030\001 \001(\rB\r\222A\n2\010Label "
    "IDR\002id\"S\n\022ListDevicesRequest\022=\n\005query\030\001 "
    "\001(\0132\'.kentik.device.v202504beta2.DeviceQ"
    "ueryR\005query\"\352\001\n\023ListDevicesResponse\022l\n\007d"
    "evices\030\001 \003(\0132*.kentik.device.v202504beta"
    "2.DeviceDetailedB&\222A#2!List of configura"
    "tions of devicesR\007devices\022e\n\rinvalid_cou"
    "nt\030\002 \001(\rB@\222A=2;Number of invalid entries"
    " encountered while collecting dataR\014inva"
    "lidCount\"\205\001\n\020GetDeviceRequest\0222\n\002id\030\001 \001("
    "\tB\"\222A\0342\032ID of the requested device\340A\002R\002i"
    "d\022=\n\005query\030\002 \001(\0132\'.kentik.device.v202504"
    "beta2.DeviceQueryR\005query\"\203\001\n\021GetDeviceRe"
    ...
    ".kentik.device.v202504beta2.ListDevicesR"
    "equest\032/.kentik.device.v202504beta2.List"
    ...
    "ice:read\202\323\344\223\002\035\022\033/device/v202504beta2/dev"
    "ice\022\311\002\n\tGetDevice\022,.kentik.device.v20250"
    "4beta2.GetDeviceRequest\032-.kentik.device."
    "v202504beta2.GetDeviceResponse\"\336\001\222A\235\001\022#R"
    ...
    "min.device:read\202\323\344\223\002\"\022 /device/v202504be"
    "ta2/device/{id}\022\346\002\n\014CreateDevice\022/.kenti"
    "k.device.v202504beta2.CreateDeviceReques"
    "t\0320.kentik.device.v202504beta2.CreateDev"
    ...
    "admin.device:write\202\323\344\223\002 \"\033/device/v20250"
    "4beta2/device:\001*\022\212\003\n\rCreateDevices\0220.ken"
    "tik.device.v202504beta2.CreateDevicesReq"
    "uest\0321.kentik.device.v202504beta2.Create"
    "DevicesResponse\"\223\002\222A\306\001\022%Configure multip"
    ...
    "te\202\323\344\223\002-\"(/device/v202504beta2/device/ba"
    "tch_create:\001*\022\223\003\n\014UpdateDevice\022/.kentik."
    "device.v202504beta2.UpdateDeviceRequest\032"
    "0.kentik.device.v202504beta2.UpdateDevic"
    "eResponse\"\237\002\222A\323\001\022\"Updates configuration "
    "of a device.\032\236\001Replaces configuration of"
    " a device with attributes in the request"
    ". Returns the updated configuration (see"
    " [About Devices](https://kb.kentik.com/v"
    "4/Cb01.htm)).*\014UpdateDevice\362\327\002\022admin.dev"
    "ice:write\202\323\344\223\002,\032\'/device/v202504beta2/de"
    "vice/{device.id}:\001*\022\263\003\n\rUpdateDevices\0220."
    "kentik.device.v202504beta2.UpdateDevices"
    "Request\0321.kentik.device.v202504beta2.Upd"
    "ateDevicesResponse\"\274\002\222A\357\001\0224Updates confi"
    "guration of multiple devices (max 100).\032"
    "\247\001Replaces configuration of multiple dev"
    "ices with attributes in the request. Ret"
    "urns the updated configurations (see [Ab"
    "out Devices](https://kb.kentik.com/v4/Cb"
    "01.htm)).*\rUpdateDevices\362\327\002\022admin.device"
    ":write\202\323\344\223\002-\032(/device/v202504beta2/devic"
    "e/batch_update:\001*\022\302\003\n\022UpdateDeviceLabels"
    "\0225.kentik.device.v202504beta2.UpdateDevi"
    "ceLabelsRequest\0326.kentik.device.v202504b"
    "eta2.UpdateDeviceLabelsResponse\"\274\002\222A\360\001\022\033"
    "Updates labels of a device.\032\274\001Removes al"
    "l existing labels from the device and ap"
    "plies the device labels (see [About Devi"
    "ce Labels](https://kb.kentik.com/v4/Cb16"
    ".htm)) specified by id. Returns the upda"
    "ted configuration.*\022UpdateDeviceLabels\362\327"
    "\002\022admin.device:write\202\323\344\223\002,\032\'/device/v202"
    "504beta2/device/{id}/labels:\001*\022\325\002\n\014Delet"
    "eDevice\022/.kentik.device.v202504beta2.Del"
    "eteDeviceRequest\0320.kentik.device.v202504"
    "beta2.DeleteDeviceResponse\"\341\001\222A\237\001\022!Delet"
    "e configuration of a device.\032lDeletes co"
    "nfiguration of a device with specific ID"
    " (see [About Devices](https://kb.kentik."
    "com/v4/Cb01.htm)).*\014DeleteDevice\362\327\002\022admi"
    "n.device:write\202\323\344\223\002\"* /device/v202504bet"
    "a2/device/{id}\022\365\002\n\rDeleteDevices\0220.kenti"
    "k.device.v202504beta2.DeleteDevicesReque"
    "st\0321.kentik.device.v202504beta2.DeleteDe"
    "vicesResponse\"\376\001\222A\261\001\022)Delete configurati"
    "on of multiple devices.\032uDeletes configu"
    "ration of multiple devices with specific"
    " IDs (see [About Devices](https://kb.ken"
    "tik.com/v4/Cb01.htm)).*\rDeleteDevices\362\327\002"
    "\022admin.device:write\202\323\344\223\002-\"(/device/v2025"
    "04beta2/device/batch_delete:\001*\032*\312A\023grpc."
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<5, 67, 10, 868, 11> DeviceDetailed::_table_ = {
  {
    ...
    "\51\2\12\13\14\13\22\0\0\0\0\20\22\13\16\25\0\17\26\27\27\0\23\0\23\15\21\16\0\26\32\24\21\0\0\20\21\0\0\0\0\10\14\14\16\22\21\17\15\14\24\32\23\31\23\14\4\0\0\0\0\0\32\31\0\7\12\15\0\0\0\0"
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* DeviceDetailed::_InternalSerialize(
          ...
          if (!this_._internal_os_name().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "kentik.device.v202504beta2.DeviceDetailed.os_name");
          ...
          if (!this_._internal_os_version().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "kentik.device.v202504beta2.DeviceDetailed.os_version");
          ...
          if (!this_._internal_serial_number().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "kentik.device.v202504beta2.DeviceDetailed.serial_number");

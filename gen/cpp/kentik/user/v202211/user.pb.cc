...
const char descriptor_table_protodef_kentik_2fuser_2fv202211_2fuser_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "r\220\330\002\003B\360\031ZCgithub.com/kentik/api-schema-p"
  "ublic/gen/go/kentik/user/v202211;user\222A\247"
  "\031\022\300\027\n\023User Management API\022\330\026# Overview\nT"
  "he User Management API enables programma"
  "tic administration of users within your "
  "organization. The API may be used to gra"
  "nt permissions to users at two levels: \n"
  "* **User role**: Permissions based on th"
  "e level assigned to the Kentik user, eit"
  "her Member, Administrator, or Super Admi"
  "nistrator (see [About Users](https://kb."
  "kentik.com/v4/Cb02.htm#Cb02-About_Users)"
  ").\n* **User permissions**: Permissions g"
  "ranting access to specific capabilities "
  "of the Kentik platform (see [User Permis"
  "sions](https://kb.kentik.com/v4/Cb02.htm"
  "#Cb02-User_Permissions)).\n\nBoth REST end"
  "point and gRPC RPCs are provided.\n\n***No"
  "te:*** The legacy REST-only [User API](h"
  "ttps://kb.kentik.com/v0/Ec06.htm#Ec06-Us"
  "er_API) provides a subset of the functio"
  "nality of this API.\n\n# User Permission I"
  "dentifiers\n\nIndividual user permissions "
  "are represented in this API by string-ba"
  "sed identifiers. The table below shows t"
  "he identifier used in the API for each p"
  "ermission that can be enabled/disabled w"
  "ith the checkboxes on the Permissions ta"
  "b of the Edit User dialog in the Kentik "
  "portal\'s Manage Users module (Settings \302"
  "\273 Manage Users).\n| Portal setting  | API"
  " identifier |\n|-----------------|-------"
  ...
  "s Permissions: Edit tests | synthetics.t"
  "ests.edit |\n| Synthetics Permissions: De"
  "lete tests | synthetics.tests.delete |\n|"
  " Synthetics Permissions: Create agents |"
  " synthetics.agents.create |\n| Synthetics"
  " Permissions: Edit agents | synthetics.a"
  "gents.edit |\n| Synthetics Permissions: D"
  "elete agents | synthetics.agents.delete "
  "|\n| Connectivity Costs Permissions: View"
  " Costs | connectivity_costs.read |\n| Con"
  "nectivity Costs Permissions: Configure C"
  "osts | connectivity_costs.edit |\n\n**_Not"
  "e:_** The API returns an error if the sa"
  "me permission is both granted and denied"
  " in the same request.\n\n### Default Permi"
  "ssions\n\nThe permissions above that are e"
  "nabled/disabled by default depend on the"
  " role (level) of the user:\n* **Member**:"
  " All permissions in the table above are "
  "denied by default.\n* **Administrator** o"
  "r **Super Administrator**: All permissio"
  "ns are granted. \n\n# User Filter Attribut"
  "e\n\nUser filters enable Administrators to"
  " apply filters that restrict the data th"
  "at can be returned from queries by a giv"
  "en user (see [User Filters](https://kb.k"
  "entik.com/v4/Cb02.htm#Cb02-User_Filters)"
  "). In the Kentik portal these filters ar"
  "e set on the Filters tab of the Edit Use"
  "r dialog in the Manage Users module. In "
  "this API the filters are set in the `use"
  "r` object with the `filter` attribute, w"
  "hose type is string. The value of the at"
  "tribute is given in JSON notation. The r"
  "ecommended way to construct the JSON str"
  "ing is to configure the desired filter f"
  "or one user in the Kentik portal and the"
  "n copy the value of the `user.filter` at"
  "tribute returned for that user by the `G"
  "etUser` RPC.\"E\n\026Kentik API Engineering\022+"
  "https://github.com/kentik/api-schema-pub"
  "lic2\007v202211*\001\0022\020application/json:\020appli"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fuser_2fv202211_2fuser_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fuser_2fv202211_2fuser_2eproto, "kentik/user/v202211/user.proto", 7928,

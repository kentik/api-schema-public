...
const char descriptor_table_protodef_kentik_2fuser_2fv202211_2fuser_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "in.user\220\330\002\003B\354\031Z\?github.com/kentik/api-sc"
  "hema-public/go/kentik/user/v202211;user\222"
  "A\247\031\022\300\027\n\023User Management API\022\330\026# Overview"
  "\nThe User Management API enables program"
  "matic administration of users within you"
  "r organization. The API may be used to g"
  "rant permissions to users at two levels:"
  " \n* **User role**: Permissions based on "
  "the level assigned to the Kentik user, e"
  "ither Member, Administrator, or Super Ad"
  "ministrator (see [About Users](https://k"
  "b.kentik.com/v4/Cb02.htm#Cb02-About_User"
  "s)).\n* **User permissions**: Permissions"
  " granting access to specific capabilitie"
  "s of the Kentik platform (see [User Perm"
  "issions](https://kb.kentik.com/v4/Cb02.h"
  "tm#Cb02-User_Permissions)).\n\nBoth REST e"
  "ndpoint and gRPC RPCs are provided.\n\n***"
  "Note:*** The legacy REST-only [User API]"
  "(https://kb.kentik.com/v0/Ec06.htm#Ec06-"
  "User_API) provides a subset of the funct"
  "ionality of this API.\n\n# User Permission"
  " Identifiers\n\nIndividual user permission"
  "s are represented in this API by string-"
  "based identifiers. The table below shows"
  " the identifier used in the API for each"
  " permission that can be enabled/disabled"
  " with the checkboxes on the Permissions "
  "tab of the Edit User dialog in the Kenti"
  "k portal\'s Manage Users module (Settings"
  " \302\273 Manage Users).\n| Portal setting  | A"
  "PI identifier |\n|-----------------|-----"
  "-----------|\n| Cancel Queries in Forensi"
  "c Viewer | forensic_viewer.cancel_querie"
  "s |\n| Synthetics Permissions: Create tes"
  "ts | synthetics.tests.create |\n| Synthet"
  "ics Permissions: Edit tests | synthetics"
  ".tests.edit |\n| Synthetics Permissions: "
  "Delete tests | synthetics.tests.delete |"
  "\n| Synthetics Permissions: Create agents"
  " | synthetics.agents.create |\n| Syntheti"
  "cs Permissions: Edit agents | synthetics"
  ".agents.edit |\n| Synthetics Permissions:"
  " Delete agents | synthetics.agents.delet"
  "e |\n| Connectivity Costs Permissions: Vi"
  "ew Costs | connectivity_costs.read |\n| C"
  "onnectivity Costs Permissions: Configure"
  " Costs | connectivity_costs.edit |\n\n**_N"
  "ote:_** The API returns an error if the "
  "same permission is both granted and deni"
  "ed in the same request.\n\n### Default Per"
  "missions\n\nThe permissions above that are"
  " enabled/disabled by default depend on t"
  "he role (level) of the user:\n* **Member*"
  "*: All permissions in the table above ar"
  "e denied by default.\n* **Administrator**"
  " or **Super Administrator**: All permiss"
  "ions are granted. \n\n# User Filter Attrib"
  "ute\n\nUser filters enable Administrators "
  "to apply filters that restrict the data "
  "that can be returned from queries by a g"
  "iven user (see [User Filters](https://kb"
  ".kentik.com/v4/Cb02.htm#Cb02-User_Filter"
  "s)). In the Kentik portal these filters "
  "are set on the Filters tab of the Edit U"
  "ser dialog in the Manage Users module. I"
  "n this API the filters are set in the `u"
  "ser` object with the `filter` attribute,"
  " whose type is string. The value of the "
  "attribute is given in JSON notation. The"
  " recommended way to construct the JSON s"
  "tring is to configure the desired filter"
  " for one user in the Kentik portal and t"
  "hen copy the value of the `user.filter` "
  "attribute returned for that user by the "
  "`GetUser` RPC.\"E\n\026Kentik API Engineering"
  "\022+https://github.com/kentik/api-schema-p"
  "ublic2\007v202211*\001\0022\020application/json:\020app"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fuser_2fv202211_2fuser_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fuser_2fv202211_2fuser_2eproto, "kentik/user/v202211/user.proto", 7930,

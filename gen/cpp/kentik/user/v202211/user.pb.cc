...
const char descriptor_table_protodef_kentik_2fuser_2fv202211_2fuser_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "in.userB\351\031Z<github.com/kentik/api-schema"
  "/gen/go/kentik/user/v202211;user\222A\247\031\022\300\027\n"
  "\023User Management API\022\330\026# Overview\nThe Us"
  "er Management API enables programmatic a"
  "dministration of users within your organ"
  "ization. The API may be used to grant pe"
  "rmissions to users at two levels: \n* **U"
  "ser role**: Permissions based on the lev"
  "el assigned to the Kentik user, either M"
  "ember, Administrator, or Super Administr"
  "ator (see [About Users](https://kb.kenti"
  "k.com/v4/Cb02.htm#Cb02-About_Users)).\n* "
  "**User permissions**: Permissions granti"
  "ng access to specific capabilities of th"
  "e Kentik platform (see [User Permissions"
  "](https://kb.kentik.com/v4/Cb02.htm#Cb02"
  "-User_Permissions)).\n\nBoth REST endpoint"
  " and gRPC RPCs are provided.\n\n***Note:**"
  "* The legacy REST-only [User API](https:"
  "//kb.kentik.com/v0/Ec06.htm#Ec06-User_AP"
  "I) provides a subset of the functionalit"
  "y of this API.\n\n# User Permission Identi"
  "fiers\n\nIndividual user permissions are r"
  "epresented in this API by string-based i"
  "dentifiers. The table below shows the id"
  "entifier used in the API for each permis"
  "sion that can be enabled/disabled with t"
  "he checkboxes on the Permissions tab of "
  "the Edit User dialog in the Kentik porta"
  "l\'s Manage Users module (Settings \302\273 Man"
  "age Users).\n| Portal setting  | API iden"
  "tifier |\n|-----------------|------------"
  "----|\n| Cancel Queries in Forensic Viewe"
  "r | forensic_viewer.cancel_queries |\n| S"
  "ynthetics Permissions: Create tests | sy"
  "nthetics.tests.create |\n| Synthetics Per"
  "missions: Edit tests | synthetics.tests."
  "edit |\n| Synthetics Permissions: Delete "
  "tests | synthetics.tests.delete |\n| Synt"
  "hetics Permissions: Create agents | synt"
  "hetics.agents.create |\n| Synthetics Perm"
  "issions: Edit agents | synthetics.agents"
  ".edit |\n| Synthetics Permissions: Delete"
  " agents | synthetics.agents.delete |\n| C"
  "onnectivity Costs Permissions: View Cost"
  "s | connectivity_costs.read |\n| Connecti"
  "vity Costs Permissions: Configure Costs "
  "| connectivity_costs.edit |\n\n**_Note:_**"
  " The API returns an error if the same pe"
  "rmission is both granted and denied in t"
  "he same request.\n\n### Default Permission"
  "s\n\nThe permissions above that are enable"
  "d/disabled by default depend on the role"
  " (level) of the user:\n* **Member**: All "
  "permissions in the table above are denie"
  "d by default.\n* **Administrator** or **S"
  "uper Administrator**: All permissions ar"
  "e granted. \n\n# User Filter Attribute\n\nUs"
  "er filters enable Administrators to appl"
  "y filters that restrict the data that ca"
  "n be returned from queries by a given us"
  "er (see [User Filters](https://kb.kentik"
  ".com/v4/Cb02.htm#Cb02-User_Filters)). In"
  " the Kentik portal these filters are set"
  " on the Filters tab of the Edit User dia"
  "log in the Manage Users module. In this "
  "API the filters are set in the `user` ob"
  "ject with the `filter` attribute, whose "
  "type is string. The value of the attribu"
  "te is given in JSON notation. The recomm"
  "ended way to construct the JSON string i"
  "s to configure the desired filter for on"
  "e user in the Kentik portal and then cop"
  "y the value of the `user.filter` attribu"
  "te returned for that user by the `GetUse"
  "r` RPC.\"E\n\026Kentik API Engineering\022+https"
  "://github.com/kentik/api-schema-public2\007"
  "v202211*\001\0022\020application/json:\020applicatio"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fuser_2fv202211_2fuser_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fuser_2fv202211_2fuser_2eproto, "kentik/user/v202211/user.proto", 7923,

...
const char descriptor_table_protodef_kentik_2fuser_2fv202211_2fuser_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "012alpha1/annotations.proto\"\304\001\n\017Permissi"
  "onEntry\022`\n\ncapability\030\001 \001(\tB@\222A927String"
  " identifying capability that is granted "
  "of denied\342A\001\002R\ncapability\022O\n\007allowed\030\002 \001"
  "(\010B5\222A.2,Flag indicating whether operati"
  "on is allowed\342A\001\002R\007allowed\"\264\006\n\004User\022;\n\002i"
  "d\030\001 \001(\tB+\222A$2\"System generated unique id"
  "entifier\342A\001\003R\002id\022U\n\nuser_email\030\002 \001(\tB6\222A"
  "/2-User e-mail address (serves also as u"
  "sername)\342A\001\002R\tuserEmail\0228\n\016user_full_nam"
  "e\030\004 \001(\tB\022\222A\0132\tFull name\342A\001\002R\014userFullNam"
  "e\022Y\n\004role\030\005 \001(\0162\031.kentik.user.v202211.Ro"
  "leB*\222A#2!User role (in Kentik applicatio"
  "n)\342A\001\002R\004role\022}\n\013permissions\030\006 \003(\0132$.kent"
  "ik.user.v202211.PermissionEntryB5\222A220Op"
  "tional list of permissions granted to th"
  "e userR\013permissions\022a\n\006filter\030\007 \001(\tBI\222AF"
  "2DOptional JSON string defining filter f"
  "or objects visible to the userR\006filter\022n"
  "\n\nlast_login\030\010 \001(\0132\032.google.protobuf.Tim"
  "estampB3\222A,2*UTC Timestamp of user\'s las"
  "t login session\342A\001\003R\tlastLogin\022S\n\005cdate\030"
  "\t \001(\0132\032.google.protobuf.TimestampB!\222A\0322\030"
  "Creation timestamp (UTC)\342A\001\003R\005cdate\022\\\n\005e"
  "date\030\n \001(\0132\032.google.protobuf.TimestampB*"
  "\222A#2!Last modification timestamp (UTC)\342A"
  "\001\003R\005edate\"\022\n\020ListUsersRequest\"\322\001\n\021ListUs"
  "ersResponse\022V\n\005users\030\001 \003(\0132\031.kentik.user"
  ".v202211.UserB%\222A\0362\034Last of users in the"
  " account\342A\001\003R\005users\022e\n\rinvalid_count\030\002 \001"
  "(\rB@\222A=2;Number of invalid entries encou"
  "ntered while collecting dataR\014invalidCou"
  "nt\"C\n\016GetUserRequest\0221\n\002id\030\001 \001(\tB!\222A\0322\030I"
  "D of the requested user\342A\001\002R\002id\"k\n\017GetUs"
  "erResponse\022X\n\004user\030\001 \001(\0132\031.kentik.user.v"
  "202211.UserB)\222A&2$Information about the "
  "requested userR\004user\"z\n\021CreateUserReques"
  "t\022e\n\004user\030\001 \001(\0132\031.kentik.user.v202211.Us"
  "erB6\222A/2-Attributes for the user account"
  " to be created\342A\001\002R\004user\"w\n\022CreateUserRe"
  "sponse\022a\n\004user\030\001 \001(\0132\031.kentik.user.v2022"
  "11.UserB2\222A/2-Attributes for the newly c"
  "reated user accountR\004user\"p\n\021UpdateUserR"
  "equest\022[\n\004user\030\001 \001(\0132\031.kentik.user.v2022"
  "11.UserB,\222A%2#New attributes for the use"
  "r account\342A\001\002R\004user\"i\n\022UpdateUserRespons"
  "e\022S\n\004user\030\001 \001(\0132\031.kentik.user.v202211.Us"
  "erB$\222A!2\037Updated user account attributes"
  "R\004user\"V\n\021DeleteUserRequest\022A\n\002id\030\001 \001(\tB"
  "1\222A*2(ID of the the user account to be d"
  "eleted\342A\001\002R\002id\"\024\n\022DeleteUserResponse\"c\n\024"
  "ResetApiTokenRequest\022K\n\002id\030\001 \001(\tB;\222A422I"
  "D of the the user whose API token should"
  " be reset\342A\001\002R\002id\"\027\n\025ResetApiTokenRespon"
  "se\"h\n\032ResetActiveSessionsRequest\022J\n\002id\030\001"
  " \001(\tB:\222A321ID of the the user whose sess"
  "ions should be reset\342A\001\002R\002id\"\035\n\033ResetAct"
  "iveSessionsResponse*c\n\004Role\022\024\n\020ROLE_UNSP"
  "ECIFIED\020\000\022\017\n\013ROLE_MEMBER\020\001\022\026\n\022ROLE_ADMIN"
  "ISTRATOR\020\002\022\034\n\030ROLE_SUPER_ADMINISTRATOR\020\003"
  "2\260\017\n\013UserService\022\337\001\n\tListUsers\022%.kentik."
  "user.v202211.ListUsersRequest\032&.kentik.u"
  "ser.v202211.ListUsersResponse\"\202\001\222AQ\022\017Lis"
  "t all users.\0323Returns a list of all user"
  " accounts in the company.*\tListUsers\362\327\002\017"
  "admin.user:read\202\323\344\223\002\025\022\023/user/v202211/use"
  "rs\022\360\001\n\007GetUser\022#.kentik.user.v202211.Get"
  "UserRequest\032$.kentik.user.v202211.GetUse"
  "rResponse\"\231\001\222Ac\022!Get attributes of a use"
  "r account.\0325Returns attributes of a user"
  " account specified by ID.*\007GetUser\362\327\002\017ad"
  "min.user:read\202\323\344\223\002\032\022\030/user/v202211/users"
  "/{id}\022\253\002\n\nCreateUser\022&.kentik.user.v2022"
  "11.CreateUserRequest\032\'.kentik.user.v2022"
  "11.CreateUserResponse\"\313\001\222A\225\001\022\030Create new"
  " user account.\032mCreates new user account"
  " based on attributes in the request. Ret"
  "urns attributes of the newly created acc"
  "ount.*\nCreateUser\362\327\002\020admin.user:write\202\323\344"
  "\223\002\030\"\023/user/v202211/users:\001*\022\311\002\n\nUpdateUs"
  "er\022&.kentik.user.v202211.UpdateUserReque"
  "st\032\'.kentik.user.v202211.UpdateUserRespo"
  "nse\"\351\001\222A\251\001\022$Update attributes of a user "
  "account.\032uReplaces all attributes of a u"
  "ser account specified by ID with attribu"
  "tes in the request. Returns updated attr"
  "ibutes.*\nUpdateUser\362\327\002\020admin.user:write\202"
  "\323\344\223\002\"\032\035/user/v202211/users/{user.id}:\001*\022"
  "\342\001\n\nDeleteUser\022&.kentik.user.v202211.Del"
  "eteUserRequest\032\'.kentik.user.v202211.Del"
  "eteUserResponse\"\202\001\222AK\022\026Delete a user acc"
  "ount.\032%Deletes user account specified by"
  " ID.*\nDeleteUser\362\327\002\020admin.user:write\202\323\344\223"
  "\002\032*\030/user/v202211/users/{id}\022\212\002\n\rResetAp"
  "iToken\022).kentik.user.v202211.ResetApiTok"
  "enRequest\032*.kentik.user.v202211.ResetApi"
  "TokenResponse\"\241\001\222AZ\022\033Reset API token for"
  " a user.\032,Resets API token for a user sp"
  "ecified by ID.*\rResetApiToken\362\327\002\020admin.u"
  "ser:write\202\323\344\223\002*\032(/user/v202211/users/{id"
  "}/reset_api_token\022\265\002\n\023ResetActiveSession"
  "s\022/.kentik.user.v202211.ResetActiveSessi"
  "onsRequest\0320.kentik.user.v202211.ResetAc"
  "tiveSessionsResponse\"\272\001\222Am\022\"Resets activ"
  "e sessions for a user.\0322Resets active se"
  "ssions for a user specified by ID.*\023Rese"
  "tActiveSessions\362\327\002\020admin.user:write\202\323\344\223\002"
  "0\032./user/v202211/users/{id}/reset_active"
  "_sessions\032(\312A\023grpc.api.kentik.com\352\327\002\nadm"
  "in.user\220\330\002\003B\351\031Z<github.com/kentik/api-sc"
  "hema/gen/go/kentik/user/v202211;user\222A\247\031"
  "\022\300\027\n\023User Management API\022\330\026# Overview\nTh"
  "e User Management API enables programmat"
  "ic administration of users within your o"
  "rganization. The API may be used to gran"
  "t permissions to users at two levels: \n*"
  " **User role**: Permissions based on the"
  " level assigned to the Kentik user, eith"
  "er Member, Administrator, or Super Admin"
  "istrator (see [About Users](https://kb.k"
  "entik.com/v4/Cb02.htm#Cb02-About_Users))"
  ".\n* **User permissions**: Permissions gr"
  "anting access to specific capabilities o"
  "f the Kentik platform (see [User Permiss"
  "ions](https://kb.kentik.com/v4/Cb02.htm#"
  "Cb02-User_Permissions)).\n\nBoth REST endp"
  "oint and gRPC RPCs are provided.\n\n***Not"
  "e:*** The legacy REST-only [User API](ht"
  "tps://kb.kentik.com/v0/Ec06.htm#Ec06-Use"
  "r_API) provides a subset of the function"
  "ality of this API.\n\n# User Permission Id"
  "entifiers\n\nIndividual user permissions a"
  "re represented in this API by string-bas"
  "ed identifiers. The table below shows th"
  "e identifier used in the API for each pe"
  "rmission that can be enabled/disabled wi"
  "th the checkboxes on the Permissions tab"
  " of the Edit User dialog in the Kentik p"
  "ortal\'s Manage Users module (Settings \302\273"
  " Manage Users).\n| Portal setting  | API "
  "identifier |\n|-----------------|--------"
  "--------|\n| Cancel Queries in Forensic V"
  "iewer | forensic_viewer.cancel_queries |"
  "\n| Synthetics Permissions: Create tests "
  "| synthetics.tests.create |\n| Synthetics"
  " Permissions: Edit tests | synthetics.te"
  "sts.edit |\n| Synthetics Permissions: Del"
  "ete tests | synthetics.tests.delete |\n| "
  "Synthetics Permissions: Create agents | "
  "synthetics.agents.create |\n| Synthetics "
  "Permissions: Edit agents | synthetics.ag"
  "ents.edit |\n| Synthetics Permissions: De"
  "lete agents | synthetics.agents.delete |"
  "\n| Connectivity Costs Permissions: View "
  "Costs | connectivity_costs.read |\n| Conn"
  "ectivity Costs Permissions: Configure Co"
  "sts | connectivity_costs.edit |\n\n**_Note"
  ":_** The API returns an error if the sam"
  "e permission is both granted and denied "
  "in the same request.\n\n### Default Permis"
  "sions\n\nThe permissions above that are en"
  "abled/disabled by default depend on the "
  "role (level) of the user:\n* **Member**: "
  "All permissions in the table above are d"
  "enied by default.\n* **Administrator** or"
  " **Super Administrator**: All permission"
  "s are granted. \n\n# User Filter Attribute"
  "\n\nUser filters enable Administrators to "
  "apply filters that restrict the data tha"
  "t can be returned from queries by a give"
  "n user (see [User Filters](https://kb.ke"
  "ntik.com/v4/Cb02.htm#Cb02-User_Filters))"
  ". In the Kentik portal these filters are"
  " set on the Filters tab of the Edit User"
  " dialog in the Manage Users module. In t"
  "his API the filters are set in the `user"
  "` object with the `filter` attribute, wh"
  "ose type is string. The value of the att"
  "ribute is given in JSON notation. The re"
  "commended way to construct the JSON stri"
  "ng is to configure the desired filter fo"
  "r one user in the Kentik portal and then"
  " copy the value of the `user.filter` att"
  "ribute returned for that user by the `Ge"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fuser_2fv202211_2fuser_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fuser_2fv202211_2fuser_2eproto, "kentik/user/v202211/user.proto", 7927,

...
const char descriptor_table_protodef_kentik_2fsynthetics_2fv202202_2fsynthetics_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "-.kentik.synthetics.v202202.ActivationSe"
  ...
  "ddev\"X\n\014HostnameTest\022H\n\006target\030\001 \001(\tB0\222A"
  "-2+Fully qualified DNS name of the targe"
  "t hostR\006target\"H\n\006IpTest\022>\n\007targets\030\001 \003("
  "\tB$\222A!2\037List of IP addresses of targetsR"
  ...
  "Ip\"\213\007\n\010FlowTest\022\207\001\n\006target\030\001 \001(\tBo\222Al2jT"
  "arget ASN, CDN, Country, Region of City "
  "for autonomous test (type of value depen"
  "ds on flow test sub-type)R\006target\022\236\001\n\036ta"
  "rget_refresh_interval_millis\030\002 \001(\rBY\222AV2"
  "TPeriod (in milliseconds) for refreshing"
  " list of targets based on available flow"
  " dataR\033targetRefreshIntervalMillis\022^\n\rma"
  "x_providers\030\003 \001(\rB9\222A624Maximum number o"
  "f IP providers to track autonomouslyR\014ma"
  "xProviders\022p\n\016max_ip_targets\030\004 \001(\rBJ\222AG2"
  "EMaximum number of target IP addresses t"
  "o select based flow data queryR\014maxIpTar"
  "gets\022W\n\004type\030\005 \001(\tBC\222A@2>Autonomous test"
  " sub-type (asn | cdn | country | region "
  "| city)R\004type\022\250\001\n\016inet_direction\030\006 \001(\tB\200"
  "\001\222A}2{Selection of address from flow dat"
  "a (src = source address in inbound flows"
  " | dst = destination addresses in outbou"
  "nd flows)R\rinetDirection\022~\n\tdirection\030\007 "
  "\001(\tB`\222A]2[Direction of flows to match ta"
  "rget attribute for extraction of target "
  "addresses (src | dst)R\tdirection\"\357\002\n\007Dns"
  "Test\022>\n\006target\030\001 \001(\tB&\222A#2!Fully qualifi"
  "ed DNS name to queryR\006target\022F\n\007timeout\030"
  "\002 \001(\rB,\030\001\222A\'2%--- Deprecated: value is i"
  "gnored. ---R\007timeout\022g\n\013record_type\030\003 \001("
  "\0162$.kentik.synthetics.v202202.DNSRecordB"
  " \222A\0352\033Type of DNS record to queryR\nrecor"
  "dType\022B\n\007servers\030\004 \003(\tB(\222A%2#List of IP "
  "addresses of DNS serversR\007servers\022/\n\004por"
  "t\030\005 \001(\rB\033\222A\0302\026Target DNS server portR\004po"
  "rt\"\306\004\n\007UrlTest\0229\n\006target\030\001 \001(\tB!\222A\0362\034HTT"
  "P or HTTPS URL to requestR\006target\022I\n\007tim"
  "eout\030\002 \001(\rB/\222A,2*HTTP transaction timeou"
  "t (in milliseconds)R\007timeout\022Q\n\006method\030\003"
  " \001(\tB9\222A624HTTP method to use (GET | HEA"
  "D | PATCH | POST | PUT)R\006method\022\177\n\007heade"
  "rs\030\004 \003(\0132/.kentik.synthetics.v202202.Url"
  "Test.HeadersEntryB4\222A12/Map of HTTP head"
  "er values keyed by header namesR\007headers"
  "\022*\n\004body\030\005 \001(\tB\026\222A\0232\021HTTP request bodyR\004"
  "body\022y\n\021ignore_tls_errors\030\006 \001(\010BM\222AJ2HBo"
  "olean indicating whether to ignore TLS c"
  "ertificate verification errorsR\017ignoreTl"
  "sErrors\032:\n\014HeadersEntry\022\020\n\003key\030\001 \001(\tR\003ke"
  "y\022\024\n\005value\030\002 \001(\tR\005value:\0028\001\"\254\005\n\014PageLoad"
  "Test\0229\n\006target\030\001 \001(\tB!\222A\0362\034HTTP or HTTPS"
  " URL to requestR\006target\022I\n\007timeout\030\002 \001(\r"
  "B/\222A,2*HTTP transaction timeout (in mill"
  "iseconds)R\007timeout\022\204\001\n\007headers\030\003 \003(\01324.k"
  "entik.synthetics.v202202.PageLoadTest.He"
  "adersEntryB4\222A12/Map of HTTP header valu"
  "es keyed by header namesR\007headers\022y\n\021ign"
  "ore_tls_errors\030\004 \001(\010BM\222AJ2HBoolean indic"
  "ating whether to ignore TLS certificate "
  "verification errorsR\017ignoreTlsErrors\022\226\001\n"
  "\rcss_selectors\030\005 \003(\01329.kentik.synthetics"
  ".v202202.PageLoadTest.CssSelectorsEntryB"
  "6\222A321Map of CSS selector values keyed b"
  "y selector nameR\014cssSelectors\032:\n\014Headers"
  "Entry\022\020\n\003key\030\001 \001(\tR\003key\022\024\n\005value\030\002 \001(\tR\005"
  "value:\0028\001\032\?\n\021CssSelectorsEntry\022\020\n\003key\030\001 "
  "\001(\tR\003key\022\024\n\005value\030\002 \001(\tR\005value:\0028\001\"\221\001\n\017N"
  "etworkMeshTest\022~\n\014use_local_ip\030\001 \001(\010B\\\222A"
  "Y2WBoolean value indicating whether to u"
  "se local (private) IP address of the tar"
  "get agentsR\nuseLocalIp\"\307\002\n\nMetricData\0226\n"
  "\007current\030\001 \001(\rB\034\222A\0312\027Current value of me"
  "tricR\007current\022\?\n\013rolling_avg\030\002 \001(\rB\036\222A\0332"
  "\031Rolling average of metricR\nrollingAvg\022["
  "\n\016rolling_stddev\030\003 \001(\rB4\222A12/Rolling ave"
  "rage of standard deviation of metricR\rro"
  "llingStddev\022c\n\006health\030\004 \001(\tBK\222AH2FHealth"
  " evaluation status for the metric (healt"
  "hy | warning | critical)R\006health\"\257\001\n\016Pac"
  "ketLossData\0228\n\007current\030\001 \001(\001B\036\222A\0332\031Curre"
  "nt packet loss valueR\007current\022c\n\006health\030"
  "\002 \001(\tBK\222AH2FHealth evaluation status for"
  " the metric (healthy | warning | critica"
  "l)R\006health\"\326\003\n\013PingResults\022E\n\006target\030\001 \001"
  "(\tB-\222A*2(Hostname or address of the prob"
  "ed targetR\006target\022n\n\013packet_loss\030\002 \001(\0132)"
  ".kentik.synthetics.v202202.PacketLossDat"
  "aB\"\222A\0372\035Packet loss metric and healthR\np"
  "acketLoss\022f\n\007latency\030\003 \001(\0132%.kentik.synt"
  "hetics.v202202.MetricDataB%\222A\"2 Packet l"
  "atency metric and healthR\007latency\022o\n\006jit"
  "ter\030\004 \001(\0132%.kentik.synthetics.v202202.Me"
  "tricDataB0\222A-2+Latency jitter (variance)"
  " metric and healthR\006jitter\0227\n\006dst_ip\030\005 \001"
  "(\tB \222A\0352\033IP address of probed targetR\005ds"
  "tIp\"\371\001\n\020HTTPResponseData\0224\n\006status\030\001 \001(\r"
  "B\034\222A\0312\027HTTP status in responseR\006status\022>"
  "\n\004size\030\002 \001(\rB*\222A\'2%Total size of  receiv"
  "ed response bodyR\004size\022o\n\004data\030\003 \001(\tB[\222A"
  "X2VDetailed information about transactio"
  "n timing, connection characteristics and"
  " responseR\004data\"\344\002\n\013HTTPResults\022.\n\006targe"
  "t\030\001 \001(\tB\026\222A\0232\021Target probed URLR\006target\022"
  "m\n\007latency\030\002 \001(\0132%.kentik.synthetics.v20"
  "2202.MetricDataB,\222A)2\'HTTP response late"
  "ncy metric and healthR\007latency\022v\n\010respon"
  "se\030\004 \001(\0132+.kentik.synthetics.v202202.HTT"
  "PResponseDataB-\222A*2(Information about re"
  "ceived HTTP responseR\010response\022>\n\006dst_ip"
  "\030\005 \001(\tB\'\222A$2\"IP address of probed target"
  " serverR\005dstIp\"\207\001\n\017DNSResponseData\0220\n\006st"
  "atus\030\001 \001(\rB\030\222A\0252\023Received DNS statusR\006st"
  "atus\022B\n\004data\030\002 \001(\tB.\222A+2)Text rendering "
  "of received DNS resolutionR\004data\"\335\002\n\nDNS"
  "Results\022/\n\006target\030\001 \001(\tB\027\222A\0242\022Queried DN"
  "S recordR\006target\022:\n\006server\030\002 \001(\tB\"\222A\0372\035D"
  "NS server used for the queryR\006server\022l\n\007"
  "latency\030\003 \001(\0132%.kentik.synthetics.v20220"
  "2.MetricDataB+\222A(2&DNS response latency "
  "metric and healthR\007latency\022t\n\010response\030\005"
  " \001(\0132*.kentik.synthetics.v202202.DNSResp"
  "onseDataB,\222A)2\'Information about receive"
  "d DNS responseR\010response\"\203\003\n\013TaskResults"
  "\022e\n\004ping\030\001 \001(\0132&.kentik.synthetics.v2022"
  "02.PingResultsB\'\222A$2\"Entry containing pi"
  "ng task resultsH\000R\004ping\022e\n\004http\030\002 \001(\0132&."
  "kentik.synthetics.v202202.HTTPResultsB\'\222"
  "A$2\"Entry containing HTTP task resultsH\000"
  "R\004http\022a\n\003dns\030\003 \001(\0132%.kentik.synthetics."
  "v202202.DNSResultsB&\222A#2!Entry containin"
  "g DNS task resultsH\000R\003dns\0226\n\006health\030\004 \001("
  "\tB\036\222A\0332\031Health status of the taskR\006healt"
  "hB\013\n\ttask_type\"\236\002\n\014AgentResults\022A\n\010agent"
  "_id\030\001 \001(\tB&\222A#2!ID of the agent providin"
  "g resultsR\007agentId\022b\n\006health\030\002 \001(\tBJ\222AG2"
  "EOverall health status of all task for t"
  "he test executed by this agentR\006health\022g"
  "\n\005tasks\030\003 \003(\0132&.kentik.synthetics.v20220"
  "2.TaskResultsB)\222A&2$List of results for "
  "individual tasksR\005tasks\"\352\002\n\013TestResults\022"
  "K\n\007test_id\030\001 \001(\tB2\222A/2-ID of the test fo"
  "r which results are providedR\006testId\022L\n\004"
  "time\030\002 \001(\0132\032.google.protobuf.TimestampB\034"
  "\222A\0312\027Results timestamp (UTC)R\004time\0226\n\006he"
  "alth\030\003 \001(\tB\036\222A\0332\031Health status of the te"
  "stR\006health\022\207\001\n\006agents\030\004 \003(\0132\'.kentik.syn"
  "thetics.v202202.AgentResultsBF\222AC2AList "
  "of results from agents executing tasks o"
  "n behalf of the testR\006agents\"\201\001\n\005Stats\022,"
  "\n\007average\030\001 \001(\005B\022\222A\0172\rAverage valueR\007ave"
  "rage\022$\n\003min\030\002 \001(\005B\022\222A\0172\rMinimum valueR\003m"
  "in\022$\n\003max\030\003 \001(\005B\022\222A\0172\rMaximum valueR\003max"
  "\"\301\002\n\010Location\022C\n\010latitude\030\010 \001(\001B\'\222A$2\"La"
  "titude in signed decimal degreesR\010latitu"
  "de\022F\n\tlongitude\030\t \001(\001B(\222A%2#Longitude in"
  " signed decimal degreesR\tlongitude\0226\n\007co"
  "untry\030\001 \001(\tB\034\222A\0312\027Country of the locatio"
  "nR\007country\022A\n\006region\030\002 \001(\tB)\222A&2$Geograp"
  "hic region within the countryR\006region\022-\n"
  "\004city\030\003 \001(\tB\031\222A\0262\024City of the locationR\004"
  "city\"\206\005\n\007NetNode\022H\n\002ip\030\002 \001(\tB8\222A523IP ad"
  "dress of the node in standard textual no"
  "tationR\002ip\022\?\n\003asn\030\003 \001(\rB-\222A*2(AS number "
  "owning the address of the nodeR\003asn\022K\n\007a"
  "s_name\030\004 \001(\tB2\222A/2-Name of the AS owning"
  " the address of the nodeR\006asName\022h\n\010loca"
  "tion\030\005 \001(\0132#.kentik.synthetics.v202202.L"
  "ocationB\'\222A$2\"Location of IP address of "
  "the nodeR\010location\022Y\n\010dns_name\030\006 \001(\tB>\222A"
  ";29DNS name of the node (obtained by rev"
  "erse DNS resolution)R\007dnsName\022f\n\tdevice_"
  "id\030\007 \001(\tBI\222AF2DID of the device correspo"
  "nding with the node in Kentik configurat"
  "ionR\010deviceId\022v\n\007site_id\030\010 \001(\tB]\222AZ2XID "
  "of the site containing the device corres"
  "ponding with the node in Kentik configur"
  "ationR\006siteId\"\363\001\n\010TraceHop\022v\n\007latency\030\003 "
  "\001(\005B\\\222AY2WRound-trip packet latency to t"
  "he node (in microseconds) - 0 if no resp"
  "onse was receivedR\007latency\022o\n\007node_id\030\005 "
  "\001(\tBV\222AS2QID of the node for this hop in"
  " the Nodes map  - empty if no response w"
  "as receivedR\006nodeId\"\374\001\n\tPathTrace\022:\n\007as_"
  "path\030\001 \003(\005B!\222A\0362\034AS path of the network "
  "traceR\006asPath\022Z\n\013is_complete\030\002 \001(\010B9\222A62"
  "4Indication whether response from target"
  " was receivedR\nisComplete\022W\n\004hops\030\006 \003(\0132"
  "#.kentik.synthetics.v202202.TraceHopB\036\222A"
  "\0332\031List of hops in the traceR\004hops\"\250\004\n\004P"
  "ath\022H\n\010agent_id\030\001 \001(\tB-\222A*2(ID of the ag"
  "ent generating the path dataR\007agentId\022F\n"
  "\ttarget_ip\030\003 \001(\tB)\222A&2$IP address of the"
  " target of the pathR\010targetIp\022j\n\thop_cou"
  "nt\030\004 \001(\0132 .kentik.synthetics.v202202.Sta"
  "tsB+\222A(2&Hop count statistics across all"
  " tracesR\010hopCount\022]\n\022max_as_path_length\030"
  "\007 \001(\005B0\222A-2+Maximum length of AS path ac"
  "ross all tracesR\017maxAsPathLength\022]\n\006trac"
  "es\030\010 \003(\0132$.kentik.synthetics.v202202.Pat"
  "hTraceB\037\222A\0342\032Data for individual tracesR"
  "\006traces\022d\n\004time\030\t \001(\0132\032.google.protobuf."
  "TimestampB4\222A12/Timestamp (UTC) of initi"
  "ation of the path traceR\004time\"\225\005\n\031GetRes"
  "ultsForTestsRequest\022I\n\003ids\030\001 \003(\tB7\222A02.L"
  "ist of test IDs for which to retrieve re"
  "sults\342A\001\002R\003ids\022y\n\nstart_time\030\002 \001(\0132\032.goo"
  "gle.protobuf.TimestampB>\222A725Timestamp o"
  "f the oldest results to include in resul"
  "ts\342A\001\002R\tstartTime\022u\n\010end_time\030\003 \001(\0132\032.go"
  "ogle.protobuf.TimestampB>\222A725Timestamp "
  "of the newest results to include in resu"
  "lts\342A\001\002R\007endTime\022P\n\tagent_ids\030\004 \003(\tB3\222A0"
  "2.List of agent IDs from which to return"
  " resultsR\010agentIds\022]\n\007targets\030\005 \003(\tBC\222A@"
  "2>List of targets (test dependent) for w"
  "hich to retrieve resultsR\007targets\022\211\001\n\tag"
  "gregate\030\006 \001(\010Bk\222Ah2fIf true, retrieve re"
  "sult aggregated across the requested tim"
  "e period, else return complete time seri"
  "esR\taggregate\"^\n\032GetResultsForTestsRespo"
  "nse\022@\n\007results\030\001 \003(\0132&.kentik.synthetics"
  ".v202202.TestResultsR\007results\"\212\004\n\026GetTra"
  "ceForTestRequest\022M\n\002id\030\001 \001(\tB=\222A:28ID of"
  " test for which to retrieve network path"
  " trace dataR\002id\022y\n\nstart_time\030\002 \001(\0132\032.go"
  "ogle.protobuf.TimestampB>\222A725Timestamp "
  "of the oldest results to include in resu"
  "lts\342A\001\002R\tstartTime\022u\n\010end_time\030\003 \001(\0132\032.g"
  "oogle.protobuf.TimestampB>\222A725Timestamp"
  " of the newest results to include in res"
  "ults\342A\001\002R\007endTime\022P\n\tagent_ids\030\004 \003(\tB3\222A"
  "02.List of agent IDs from which to retur"
  "n resultsR\010agentIds\022]\n\ntarget_ips\030\005 \003(\tB"
  ">\222A;29List of target IP addresses for wh"
  "ich to retrieve resultsR\ttargetIps\"\346\002\n\027G"
  "etTraceForTestResponse\022\213\001\n\005nodes\030\001 \003(\0132="
  ".kentik.synthetics.v202202.GetTraceForTe"
  "stResponse.NodesEntryB6\222A321Map of netwo"
  "rk node information keyed by node IDsR\005n"
  "odes\022_\n\005paths\030\002 \003(\0132\037.kentik.synthetics."
  "v202202.PathB(\222A%2#List of retrieved net"
  "work path dataR\005paths\032\\\n\nNodesEntry\022\020\n\003k"
  "ey\030\001 \001(\tR\003key\0228\n\005value\030\002 \001(\0132\".kentik.sy"
  "nthetics.v202202.NetNodeR\005value:\0028\001\"\023\n\021L"
  "istAgentsRequest\"\324\001\n\022ListAgentsResponse\022"
  "W\n\006agents\030\001 \003(\0132 .kentik.synthetics.v202"
  "202.AgentB\035\222A\0322\030List of available agents"
  "R\006agents\022e\n\rinvalid_count\030\002 \001(\rB@\222A=2;Nu"
  "mber of invalid entries encountered whil"
  "e collecting dataR\014invalidCount\"E\n\017GetAg"
  "entRequest\0222\n\002id\030\001 \001(\tB\"\222A\0332\031ID of the r"
  "equested agent\342A\001\002R\002id\"t\n\020GetAgentRespon"
  "se\022`\n\005agent\030\001 \001(\0132 .kentik.synthetics.v2"
  "02202.AgentB(\222A%2#Agent configuration an"
  "d status dataR\005agent\"k\n\022UpdateAgentReque"
  "st\022U\n\005agent\030\001 \001(\0132 .kentik.synthetics.v2"
  "02202.AgentB\035\222A\0322\030Agent configuration da"
  "taR\005agent\"w\n\023UpdateAgentResponse\022`\n\005agen"
  "t\030\001 \001(\0132 .kentik.synthetics.v202202.Agen"
  "tB(\222A%2#Agent configuration and status d"
  "ataR\005agent\"L\n\022DeleteAgentRequest\0226\n\002id\030\001"
  " \001(\tB&\222A\0372\035ID of the agent to be deleted"
  "\342A\001\002R\002id\"\025\n\023DeleteAgentResponse\"\022\n\020ListT"
  "estsRequest\"\341\001\n\021ListTestsResponse\022e\n\005tes"
  "ts\030\001 \003(\0132\037.kentik.synthetics.v202202.Tes"
  "tB.\222A+2)List of configured active or pau"
  "sed testsR\005tests\022e\n\rinvalid_count\030\002 \001(\rB"
  ...
  "tik.synthetics.v202202.TestB \222A\0312\027Test c"
  "onfiguration data\342A\001\002R\004test\"r\n\022CreateTes"
  "tResponse\022\\\n\004test\030\001 \001(\0132\037.kentik.synthet"
  "ics.v202202.TestB\'\222A$2\"Test configuratio"
  "n and status dataR\004test\"\?\n\016GetTestReques"
  "t\022-\n\002id\030\001 \001(\tB\035\222A\0262\024ID of requested test"
  "\342A\001\002R\002id\"o\n\017GetTestResponse\022\\\n\004test\030\001 \001("
  "\0132\037.kentik.synthetics.v202202.TestB\'\222A$2"
  "\"Test configuration and status dataR\004tes"
  "t\"f\n\021UpdateTestRequest\022Q\n\004test\030\001 \001(\0132\037.k"
  "entik.synthetics.v202202.TestB\034\222A\0312\027Test"
  " configuration dataR\004test\"r\n\022UpdateTestR"
  "esponse\022\\\n\004test\030\001 \001(\0132\037.kentik.synthetic"
  "s.v202202.TestB\'\222A$2\"Test configuration "
  "and status dataR\004test\"J\n\021DeleteTestReque"
  "st\0225\n\002id\030\001 \001(\tB%\222A\0362\034ID of the test to b"
  "e deleted\342A\001\002R\002id\"\024\n\022DeleteTestResponse\""
  "\272\001\n\024SetTestStatusRequest\022F\n\002id\030\001 \001(\tB6\222A"
  "/2-ID of the test which status is to be "
  "modified\342A\001\002R\002id\022Z\n\006status\030\002 \001(\0162%.kenti"
  "k.synthetics.v202202.TestStatusB\033\222A\0242\022Ta"
  "rget test status\342A\001\002R\006status\"\027\n\025SetTestS"
  "tatusResponse*}\n\rImplementType\022\036\n\032IMPLEM"
  "ENT_TYPE_UNSPECIFIED\020\000\022\027\n\023IMPLEMENT_TYPE"
  "_RUST\020\001\022\027\n\023IMPLEMENT_TYPE_NODE\020\002\022\032\n\026IMPL"
  "EMENT_TYPE_NETWORK\020\003*]\n\010IPFamily\022\031\n\025IP_F"
  "AMILY_UNSPECIFIED\020\000\022\020\n\014IP_FAMILY_V4\020\001\022\020\n"
  "\014IP_FAMILY_V6\020\002\022\022\n\016IP_FAMILY_DUAL\020\003*\213\001\n\n"
  "TestStatus\022\033\n\027TEST_STATUS_UNSPECIFIED\020\000\022"
  "\026\n\022TEST_STATUS_ACTIVE\020\001\022\026\n\022TEST_STATUS_P"
  "AUSED\020\002\022\027\n\023TEST_STATUS_DELETED\020\003\022\027\n\023TEST"
  "_STATUS_PREVIEW\020\004*q\n\013AgentStatus\022\034\n\030AGEN"
  "T_STATUS_UNSPECIFIED\020\000\022\023\n\017AGENT_STATUS_O"
  "K\020\001\022\025\n\021AGENT_STATUS_WAIT\020\002\022\030\n\024AGENT_STAT"
  "US_DELETED\020\003*\310\001\n\tDNSRecord\022\032\n\026DNS_RECORD"
  "_UNSPECIFIED\020\000\022\020\n\014DNS_RECORD_A\020\001\022\023\n\017DNS_"
  "RECORD_AAAA\020\002\022\024\n\020DNS_RECORD_CNAME\020\003\022\024\n\020D"
  "NS_RECORD_DNAME\020\004\022\021\n\rDNS_RECORD_NS\020\005\022\021\n\r"
  "DNS_RECORD_MX\020\006\022\022\n\016DNS_RECORD_PTR\020\007\022\022\n\016D"
  "NS_RECORD_SOA\020\0102\312\005\n\025SyntheticsDataServic"
  "e\022\263\002\n\022GetResultsForTests\0224.kentik.synthe"
  "tics.v202202.GetResultsForTestsRequest\0325"
  ".kentik.synthetics.v202202.GetResultsFor"
  "TestsResponse\"\257\001\222As\022\025Get results for tes"
  "ts\032FReturns probe results for a set of t"
  "ests for specified period of time.*\022GetR"
  "esultsForTests\362\327\002\017synthetics:read\202\323\344\223\002 \""
  "\033/synthetics/v202202/results:\001*\022\320\002\n\017GetT"
  "raceForTest\0221.kentik.synthetics.v202202."
  "GetTraceForTestRequest\0322.kentik.syntheti"
  "cs.v202202.GetTraceForTestResponse\"\325\001\222A\232"
  "\001\022!Get network trace data for a test\032dGe"
  "t network trace data for a specific synt"
  "hetic test. The test must have tracerout"
  "e task configured.*\017GetTraceForTest\362\327\002\017s"
  "ynthetics:read\202\323\344\223\002\036\"\031/synthetics/v20220"
  "2/trace:\001*\032(\312A\023grpc.api.kentik.com\352\327\002\nsy"
  "nthetics\220\330\002\0032\312\030\n\026SyntheticsAdminService\022"
  "\247\002\n\nListAgents\022,.kentik.synthetics.v2022"
  "02.ListAgentsRequest\032-.kentik.synthetics"
  ".v202202.ListAgentsResponse\"\273\001\222Ac\022\025List "
  "available agents\032>Returns list of all sy"
  "nthetic agents available in the account."
  "*\nListAgents\362\327\002\025admin.synthetics:read\222\330\002"
  "\026synthetics.agent::read\202\323\344\223\002\034\022\032/syntheti"
  "cs/v202202/agents\022\247\002\n\010GetAgent\022*.kentik."
  "synthetics.v202202.GetAgentRequest\032+.ken"
  "tik.synthetics.v202202.GetAgentResponse\""
  "\301\001\222Ad\022\036Get information about an agent\0328R"
  "eturns information about the requested s"
  "ynthetic agent.*\010GetAgent\362\327\002\025admin.synth"
  "etics:read\222\330\002\026synthetics.agent::read\202\323\344\223"
  "\002!\022\037/synthetics/v202202/agents/{id}\022\263\002\n\013"
  "UpdateAgent\022-.kentik.synthetics.v202202."
  "UpdateAgentRequest\032..kentik.synthetics.v"
  "202202.UpdateAgentResponse\"\304\001\222A[\022 Update"
  " configuration of an agent\032*Update confi"
  "guration of a synthetic agent.*\013UpdateAg"
  "ent\362\327\002\026admin.synthetics:write\222\330\002\030synthet"
  "ics.agent::update\202\323\344\223\002*\032%/synthetics/v20"
  "2202/agents/{agent.id}:\001*\022\311\002\n\013DeleteAgen"
  "t\022-.kentik.synthetics.v202202.DeleteAgen"
  "tRequest\032..kentik.synthetics.v202202.Del"
  "eteAgentResponse\"\332\001\222Az\022\017Delete an agent\032"
  "ZDeletes the requested agent. The delete"
  "d agent is removed from configuration of"
  " all tests.*\013DeleteAgent\362\327\002\026admin.synthe"
  "tics:write\222\330\002\030synthetics.agent::delete\202\323"
  "\344\223\002!*\037/synthetics/v202202/agents/{id}\022\237\002"
  "\n\tListTests\022+.kentik.synthetics.v202202."
  "ListTestsRequest\032,.kentik.synthetics.v20"
  "2202.ListTestsResponse\"\266\001\222A`\022\016List all t"
  "ests\032CReturns a list of all configured a"
  "ctive and paused synthetic tests.*\tListT"
  "ests\362\327\002\025admin.synthetics:read\222\330\002\025synthet"
  "ics.test::read\202\323\344\223\002\033\022\031/synthetics/v20220"
  "2/tests\022\252\002\n\nCreateTest\022,.kentik.syntheti"
  "cs.v202202.CreateTestRequest\032-.kentik.sy"
  "nthetics.v202202.CreateTestResponse\"\276\001\222A"
  "b\022\rCreate a test\032ECreate synthetic test "
  "based on configuration provided in the r"
  "equest.*\nCreateTest\362\327\002\026admin.synthetics:"
  "write\222\330\002\027synthetics.test::create\202\323\344\223\002\036\"\031"
  "/synthetics/v202202/tests:\001*\022\251\002\n\007GetTest"
  "\022).kentik.synthetics.v202202.GetTestRequ"
  "est\032*.kentik.synthetics.v202202.GetTestR"
  "esponse\"\306\001\222Ak\022\034Get information about a t"
  "est\032BReturns configuration and status fo"
  "r the requested synthetic test.*\007GetTest"
  "\362\327\002\025admin.synthetics:read\222\330\002\025synthetics."
  "test::read\202\323\344\223\002 \022\036/synthetics/v202202/te"
  "sts/{id}\022\252\002\n\nUpdateTest\022,.kentik.synthet"
  "ics.v202202.UpdateTestRequest\032-.kentik.s"
  "ynthetics.v202202.UpdateTestResponse\"\276\001\222"
  "AX\022\036Update configuration of a test\032*Upda"
  "tes configuration of a synthetic test.*\n"
  "UpdateTest\362\327\002\026admin.synthetics:write\222\330\002\027"
  "synthetics.test::update\202\323\344\223\002(\032#/syntheti"
  "cs/v202202/tests/{test.id}:\001*\022\314\002\n\nDelete"
  "Test\022,.kentik.synthetics.v202202.DeleteT"
  "estRequest\032-.kentik.synthetics.v202202.D"
  "eleteTestResponse\"\340\001\222A\201\001\022\030Delete a synth"
  "etic test.\032YDeletes the synthetics test."
  " All accumulated results for the test ce"
  "ase to be accessible.*\nDeleteTest\362\327\002\026adm"
  "in.synthetics:write\222\330\002\027synthetics.test::"
  "delete\202\323\344\223\002 *\036/synthetics/v202202/tests/"
  "{id}\022\262\002\n\rSetTestStatus\022/.kentik.syntheti"
  "cs.v202202.SetTestStatusRequest\0320.kentik"
  ".synthetics.v202202.SetTestStatusRespons"
  "e\"\275\001\222AU\022!Update status of a synthetic te"
  "st\032!Update status of a synthetic test*\rS"
  "etTestStatus\362\327\002\026admin.synthetics:write\222\330"
  "\002\027synthetics.test::update\202\323\344\223\002*\032%/synthe"
  "tics/v202202/tests/{id}/status:\001*\032.\312A\023gr"
  "pc.api.kentik.com\352\327\002\020admin.synthetics\220\330\002"
  "\003B\303\?ZOgithub.com/kentik/api-schema-publi"
  "c/gen/go/kentik/synthetics/v202202;synth"
  "etics\222A\356>\022\204=\n\031Synthetics Monitoring API\022"
  "\226<# Overview\nThe Synthetics Monitoring A"
  "PI provides programmatic access to Kenti"
  "k\'s [synthetic monitoring system](https:"
  "//kb.kentik.com/v4/Ma00.htm). The API co"
  "nsists of two endpoints:\n| Endpoint | Pu"
  "rpose |\n|-----------|---------|\n| Synthe"
  "ticsAdminService | CRUD operations for s"
  "ynthetic tests and agents |\n| Synthetics"
  "DataService  | Retrieval of synthetic te"
  "st results and network traces |\n\nBoth RE"
  "ST endpoint and gRPC RPCs are provided.\n"
  "### Known Limitations\nThe API currently "
  "does not support the following [Syntheti"
  "c Test Types](https://kb.kentik.com/v4/M"
  "a00.htm#Ma00-Synthetic_Test_Types):\n* BG"
  "P Monitor tests, which are supported in "
  "a [separate API](https://github.com/kent"
  "ik/api-schema-public/blob/master/proto/k"
  "entik/bgp_monitoring/v202205beta1/bgp_mo"
  "nitoring.proto)\n* Transaction tests.\n\n##"
  "# Additional Public Resources\nKentik com"
  "munity [Python](https://github.com/kenti"
  "k/community_sdk_python) and [Go](https:/"
  "/github.com/kentik/community_sdk_golang)"
  " SDKs provide language-specific support "
  "for using this and other Kentik APIs. Th"
  "ese SDKs can be also used as example cod"
  "e for development. \n A [Terraform provid"
  "er](https://registry.terraform.io/provid"
  "ers/kentik/kentik-synthetics) is availab"
  "le for configuring tests and agents for "
  "Kentik synthetic monitoring.\n# Anatomy o"
  "f a Synthetic Test\nEach `Test` consists "
  "of one or more tasks. Tasks are executed"
  " by monitoring `Agents` that send synthe"
  "tic traffic (probes) over the network. T"
  "he API currently supports following task"
  "s:\n| Task name  | Purpose |\n|-----------"
  "-|---------|\n| ping       | Test basic a"
  "ddress, and optionally TCP port reachabi"
  "lity |\n| traceroute (a.k.a. trace)| Disc"
  "over unidirectional network path |\n| htt"
  "p | Perform a simple HTTP/HTTPS request "
  "|\n| page-load | Use headless Chromium to"
  " execute an HTTP/HTTPS request |\n| dns |"
  " Execute a DNS query|\n\nThe set of tasks "
  "executed on behalf of a given test depen"
  "ds on the `type` of that test. The follo"
  "wing test types are currently supported "
  "by the API:\n| API type | Portal (UI) equ"
  "ivalent | Tasks |\n|---------------|-----"
  "---------|-------|\n| ip | IP Address | p"
  "ing, traceroute |\n| hostname | Hostname "
  "| ping, traceroute |\n| network_grid | Ne"
  "twork Grid | ping, traceroute |\n| agent "
  "| Agent-to-Agent | ping, traceroute |\n| "
  "network_mesh | Network Mesh | ping, trac"
  "eroute |\n| flow | Autonomous Tests (5 va"
  "riants) | ping, traceroute |\n| url | HTT"
  "P(S) or API | http, ping (optional), tra"
  "ceroute (optional) |\n| page_load | Page "
  "Load | page-load, ping (optional), trace"
  "route (optional) |\n| dns | DNS Server Mo"
  "nitor | dns |\n| dns_grid | DNS Server Gr"
  "id | dns |\n\n***Note:*** `ping` and `trac"
  "eroute` tasks are always run together (n"
  "ever one without the other).\n\n# Test Att"
  "ributes and Settings\nThe attributes of t"
  "he test object enable configuration of t"
  "est settings, access to test metadata, a"
  "nd access to runtime state information.\n"
  "### State and Metadata Attributes\n The f"
  "ollowing table lists the metadata and st"
  "ate attributes:\n| Attribute | Access | P"
  "urpose |\n|-----------|--------|---------"
  "|\n| id | RO | System-generated unique id"
  "entifier of the test |\n| name | RW | Use"
  "r specified name for the test (need not "
  "be unique) |\n| type | RO (after creation"
  ") | Type of the test (set on creation; r"
  "ead-only thereafter) |\n| status | RW | L"
  "ife-cycle status of the test |\n| cdate |"
  " RO | Creation timestamp |\n| edate | RO "
  "| Last-modification timestamp |\n| create"
  "d_by | RO | Identity of the user that cr"
  "eated the test |\n| last_updated_by | RO "
  "| Identity of the latest user to modify "
  "the test |\n| labels | RW | List of names"
  " of labels applied to the test |\n\nTest c"
  "onfiguration is performed via the test\'s"
  " `settings` attribute. Some settings are"
  " common to all tests while others are sp"
  "ecific to tests of a given type.\n### Com"
  "mon Test Settings\nThe following settings"
  " are used for tests of all types:\n| Attr"
  "ibute | Purpose | Required |\n|----------"
  "-|---------|----------|\n| agentIds  | ID"
  "s of agents to execute tasks for the tes"
  "t | YES |\n| period | Test execution inte"
  "rval in seconds | NO (default 60s) |\n| f"
  "amily | IP address family. Used only for"
  " tests whose type is url or dns. Selects"
  " which type of DNS resource is queried f"
  "or resolving hostname to target address "
  "| NO (default IP_FAMILY_DUAL) |\n| notifi"
  "cationChannels | List of notification ch"
  "annels for the test | NO (default empty "
  "list) |\n| healthSettings | A HealthSetti"
  "ngs object that configures health settin"
  "gs for this test, which includes metric "
  "thresholds that define health status (wa"
  "rning and critical) and trigger associat"
  "ed alarms. | YES |\n| ping | A TestPingSe"
  "ttings object that configures the ping t"
  "ask of the test | NO (default depends on"
  " test type) |\n| trace | A TestTraceSetti"
  "ngs object that configures the trace tas"
  "k of the test | NO (default depends on t"
  "est type) |\n| tasks | List of names of t"
  "he tasks that will be executed for this "
  "test | YES |\n\n### Type-specific Settings"
  "\nEach test type has its own configuratio"
  "n object that represents the settings fo"
  "r that type. These type-specific objects"
  " are referenced by the attributes in `Te"
  "st.settings`:\n| Test type    | Settings "
  ...
  "| dnsGrid                 | DnsTest     "
  "              |\n\n# Test Results\nResults "
  "of synthetic tests are returned as a seq"
  "uence of `TestResults` objects. Each suc"
  "h object represents measurements and hea"
  "lth evaluation for a single test at spec"
  "ific point in time. Measurements and hea"
  "lth evaluation are grouped by agent and "
  "by task.\nGranularity of timestamps in te"
  "st results depends on the frequency (per"
  "iod) of the test and on the requested ti"
  "me range. The minimum granularity is 1 m"
  "inute (even when period < 1 minute). The"
  " longer the time range, the lower the gr"
  "anularity.\n# Network Traces\nSynthetic te"
  "sts that include the `traceroute` task c"
  "ollect the unidirectional network path f"
  "rom the agent to the target for each age"
  "nt/target pair. The trace data are retur"
  "ned in the `GetTraceForTestResponse` obj"
  "ect. The `paths` attribute of this objec"
  "t contains the collected network path fo"
  "r each agent/target pair and the round-t"
  "rip time (RTT) to each hop.\nHops in actu"
  "al network traces are identified by a `n"
  "odeId`. The mapping of node IDs to addre"
  "ss, name, location, and other attributes"
  " of the hop is provided in a map that is"
  " stored in the `nodes` attribute of the "
  "`GetTraceForTestResponse` object.\n# Agen"
  "ts\nThe Kentik synthetic monitoring syste"
  "m recognizes 2 types of agents:\n* **Glob"
  "al** (public): Managed by Kentik and ava"
  "ilable to every Kentik user. All informa"
  "tion about global agents in this API is "
  "read-only.\n* **Private**: Deployed by ea"
  "ch customer and available only to that c"
  "ustomer.\nTo be visible in this API, a pr"
  "ivate agent must first associate itself "
  "with a customer account by contacting th"
  "e Kentik system (via private API). Once "
  "the agent is associated it can be author"
  "ized via the API by changing its `status"
  "` to `AGENT_STATUS_OK`. For more informa"
  "tion about private agent deployment, see"
  " [**Synthetic Agent Deployments**](https"
  "://kb.kentik.com/v4/Ma01.htm#Ma01-Synthe"
  "tic_Agent_Deployments).\n\"E\n\026Kentik API E"
  "ngineering\022+https://github.com/kentik/ap"
  "i-schema-public2\007v202202*\001\0022\020application"
  "/json:\020application/jsonZD\n\036\n\005email\022\025\010\002\032\017"
  "X-CH-Auth-Email \002\n\"\n\005token\022\031\010\002\032\023X-CH-Aut"
  "h-API-Token \002b\026\n\t\n\005email\022\000\n\t\n\005token\022\000r`\n"
  "\"Kentik synthetic monitoring system\022:htt"
  "ps://kb.kentik.com/v4/Ma00.htm#Ma00-Synt"
  "hetics_Overviewb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fsynthetics_2fv202202_2fsynthetics_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fsynthetics_2fv202202_2fsynthetics_2eproto, "kentik/synthetics/v202202/synthetics.proto", 34903,

...
const char descriptor_table_protodef_kentik_2fsynthetics_2fv202202_2fsynthetics_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ":read\202\323\344\223\002\034\022\032/synthetics/v202202/agents\022"
  "\247\002\n\010GetAgent\022*.kentik.synthetics.v202202"
  ".GetAgentRequest\032+.kentik.synthetics.v20"
  "2202.GetAgentResponse\"\301\001\222Ad\022\036Get informa"
  ...
  "02202/agents/{id}\022\263\002\n\013UpdateAgent\022-.kent"
  "ik.synthetics.v202202.UpdateAgentRequest"
  "\032..kentik.synthetics.v202202.UpdateAgent"
  ...
  "synthetics.v202202.DeleteAgentResponse\"\332"
  ...
  "v202202/agents/{id}\022\237\002\n\tListTests\022+.kent"
  "ik.synthetics.v202202.ListTestsRequest\032,"
  ".kentik.synthetics.v202202.ListTestsResp"
  ...
  "\002\033\022\031/synthetics/v202202/tests\022\252\002\n\nCreate"
  ...
  "s.test::create\202\323\344\223\002\036\"\031/synthetics/v20220"
  "2/tests:\001*\022\251\002\n\007GetTest\022).kentik.syntheti"
  "cs.v202202.GetTestRequest\032*.kentik.synth"
  "etics.v202202.GetTestResponse\"\306\001\222Ak\022\034Get"
  ...
  "/synthetics/v202202/tests/{id}\022\252\002\n\nUpdat"
  "eTest\022,.kentik.synthetics.v202202.Update"
  ...
  "pdate\202\323\344\223\002(\032#/synthetics/v202202/tests/{"
  "test.id}:\001*\022\314\002\n\nDeleteTest\022,.kentik.synt"
  "hetics.v202202.DeleteTestRequest\032-.kenti"
  "k.synthetics.v202202.DeleteTestResponse\""
  ...
  "thetics/v202202/tests/{id}\022\262\002\n\rSetTestSt"
  "atus\022/.kentik.synthetics.v202202.SetTest"
  "StatusRequest\0320.kentik.synthetics.v20220"
  "2.SetTestStatusResponse\"\275\001\222AU\022!Update st"
  ...
  ":update\202\323\344\223\002*\032%/synthetics/v202202/tests"
  "/{id}/status:\001*\032.\312A\023grpc.api.kentik.com\352"
  "\327\002\020admin.synthetics\220\330\002\003B\303\?ZOgithub.com/k"
  "entik/api-schema-public/gen/go/kentik/sy"
  "nthetics/v202202;synthetics\222A\356>\022\204=\n\031Synt"
  "hetics Monitoring API\022\226<# Overview\nThe S"
  ...
  "ons\nThe API currently does not support t"
  "he following [Synthetic Test Types](http"
  "s://kb.kentik.com/v4/Ma00.htm#Ma00-Synth"
  "etic_Test_Types):\n* BGP Monitor tests, w"
  "hich are supported in a [separate API](h"
  "ttps://github.com/kentik/api-schema-publ"
  "ic/blob/master/proto/kentik/bgp_monitori"
  "ng/v202205beta1/bgp_monitoring.proto)\n* "
  "Transaction tests.\n\n### Additional Publi"
  "c Resources\nKentik community [Python](ht"
  "tps://github.com/kentik/community_sdk_py"
  "thon) and [Go](https://github.com/kentik"
  "/community_sdk_golang) SDKs provide lang"
  "uage-specific support for using this and"
  " other Kentik APIs. These SDKs can be al"
  "so used as example code for development."
  " \n A [Terraform provider](https://regist"
  "ry.terraform.io/providers/kentik/kentik-"
  "synthetics) is available for configuring"
  " tests and agents for Kentik synthetic m"
  "onitoring.\n# Anatomy of a Synthetic Test"
  "\nEach `Test` consists of one or more tas"
  "ks. Tasks are executed by monitoring `Ag"
  "ents` that send synthetic traffic (probe"
  "s) over the network. The API currently s"
  "upports following tasks:\n| Task name  | "
  "Purpose |\n|------------|---------|\n| pin"
  "g       | Test basic address, and option"
  "ally TCP port reachability |\n| tracerout"
  "e (a.k.a. trace)| Discover unidirectiona"
  "l network path |\n| http | Perform a simp"
  "le HTTP/HTTPS request |\n| page-load | Us"
  "e headless Chromium to execute an HTTP/H"
  "TTPS request |\n| dns | Execute a DNS que"
  "ry|\n\nThe set of tasks executed on behalf"
  " of a given test depends on the `type` o"
  "f that test. The following test types ar"
  "e currently supported by the API:\n| API "
  "type | Portal (UI) equivalent | Tasks |\n"
  "|---------------|--------------|-------|"
  "\n| ip | IP Address | ping, traceroute |\n"
  "| hostname | Hostname | ping, traceroute"
  " |\n| network_grid | Network Grid | ping,"
  " traceroute |\n| agent | Agent-to-Agent |"
  " ping, traceroute |\n| network_mesh | Net"
  "work Mesh | ping, traceroute |\n| flow | "
  "Autonomous Tests (5 variants) | ping, tr"
  "aceroute |\n| url | HTTP(S) or API | http"
  ", ping (optional), traceroute (optional)"
  " |\n| page_load | Page Load | page-load, "
  "ping (optional), traceroute (optional) |"
  "\n| dns | DNS Server Monitor | dns |\n| dn"
  "s_grid | DNS Server Grid | dns |\n\n***Not"
  "e:*** `ping` and `traceroute` tasks are "
  "always run together (never one without t"
  "he other).\n\n# Test Attributes and Settin"
  "gs\nThe attributes of the test object ena"
  "ble configuration of test settings, acce"
  "ss to test metadata, and access to runti"
  "me state information.\n### State and Meta"
  "data Attributes\n The following table lis"
  "ts the metadata and state attributes:\n| "
  "Attribute | Access | Purpose |\n|--------"
  "---|--------|---------|\n| id | RO | Syst"
  "em-generated unique identifier of the te"
  "st |\n| name | RW | User specified name f"
  "or the test (need not be unique) |\n| typ"
  "e | RO (after creation) | Type of the te"
  "st (set on creation; read-only thereafte"
  "r) |\n| status | RW | Life-cycle status o"
  "f the test |\n| cdate | RO | Creation tim"
  "estamp |\n| edate | RO | Last-modificatio"
  "n timestamp |\n| created_by | RO | Identi"
  "ty of the user that created the test |\n|"
  " last_updated_by | RO | Identity of the "
  "latest user to modify the test |\n| label"
  "s | RW | List of names of labels applied"
  " to the test |\n\nTest configuration is pe"
  "rformed via the test\'s `settings` attrib"
  "ute. Some settings are common to all tes"
  "ts while others are specific to tests of"
  " a given type.\n### Common Test Settings\n"
  "The following settings are used for test"
  "s of all types:\n| Attribute | Purpose | "
  "Required |\n|-----------|---------|------"
  "----|\n| agentIds  | IDs of agents to exe"
  "cute tasks for the test | YES |\n| period"
  " | Test execution interval in seconds | "
  "NO (default 60s) |\n| family | IP address"
  " family. Used only for tests whose type "
  "is url or dns. Selects which type of DNS"
  " resource is queried for resolving hostn"
  "ame to target address | NO (default IP_F"
  "AMILY_DUAL) |\n| notificationChannels | L"
  "ist of notification channels for the tes"
  "t | NO (default empty list) |\n| healthSe"
  "ttings | A HealthSettings object that co"
  "nfigures health settings for this test, "
  "which includes metric thresholds that de"
  "fine health status (warning and critical"
  ") and trigger associated alarms. | YES |"
  "\n| ping | A TestPingSettings object that"
  " configures the ping task of the test | "
  "NO (default depends on test type) |\n| tr"
  "ace | A TestTraceSettings object that co"
  "nfigures the trace task of the test | NO"
  " (default depends on test type) |\n| task"
  "s | List of names of the tasks that will"
  " be executed for this test | YES |\n\n### "
  "Type-specific Settings\nEach test type ha"
  "s its own configuration object that repr"
  "esents the settings for that type. These"
  " type-specific objects are referenced by"
  " the attributes in `Test.settings`:\n| Te"
  "st type    | Settings attribute | Config"
  "uration object |\n|--------------|-------"
  "------------------|---------------------"
  "------|\n| ip           | ip             "
  "         | IpTest                    |\n|"
  ...
  " are returned as a sequence of `TestResu"
  "lts` objects. Each such object represent"
  "s measurements and health evaluation for"
  " a single test at specific point in time"
  ". Measurements and health evaluation are"
  " grouped by agent and by task.\nGranulari"
  "ty of timestamps in test results depends"
  " on the frequency (period) of the test a"
  "nd on the requested time range. The mini"
  "mum granularity is 1 minute (even when p"
  "eriod < 1 minute). The longer the time r"
  "ange, the lower the granularity.\n# Netwo"
  "rk Traces\nSynthetic tests that include t"
  "he `traceroute` task collect the unidire"
  "ctional network path from the agent to t"
  "he target for each agent/target pair. Th"
  "e trace data are returned in the `GetTra"
  "ceForTestResponse` object. The `paths` a"
  "ttribute of this object contains the col"
  "lected network path for each agent/targe"
  "t pair and the round-trip time (RTT) to "
  "each hop.\nHops in actual network traces "
  "are identified by a `nodeId`. The mappin"
  "g of node IDs to address, name, location"
  ", and other attributes of the hop is pro"
  "vided in a map that is stored in the `no"
  "des` attribute of the `GetTraceForTestRe"
  "sponse` object.\n# Agents\nThe Kentik synt"
  "hetic monitoring system recognizes 2 typ"
  "es of agents:\n* **Global** (public): Man"
  "aged by Kentik and available to every Ke"
  "ntik user. All information about global "
  "agents in this API is read-only.\n* **Pri"
  "vate**: Deployed by each customer and av"
  "ailable only to that customer.\nTo be vis"
  "ible in this API, a private agent must f"
  "irst associate itself with a customer ac"
  "count by contacting the Kentik system (v"
  "ia private API). Once the agent is assoc"
  "iated it can be authorized via the API b"
  "y changing its `status` to `AGENT_STATUS"
  "_OK`. For more information about private"
  " agent deployment, see [**Synthetic Agen"
  "t Deployments**](https://kb.kentik.com/v"
  "4/Ma01.htm#Ma01-Synthetic_Agent_Deployme"
  "nts).\n\"E\n\026Kentik API Engineering\022+https:"
  "//github.com/kentik/api-schema-public2\007v"
  "202202*\001\0022\020application/json:\020application"
  "/jsonZD\n\036\n\005email\022\025\010\002\032\017X-CH-Auth-Email \002\n"
  "\"\n\005token\022\031\010\002\032\023X-CH-Auth-API-Token \002b\026\n\t\n"
  "\005email\022\000\n\t\n\005token\022\000r`\n\"Kentik synthetic "
  "monitoring system\022:https://kb.kentik.com"
  "/v4/Ma00.htm#Ma00-Synthetics_Overviewb\006p"
  "roto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fsynthetics_2fv202202_2fsynthetics_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fsynthetics_2fv202202_2fsynthetics_2eproto, "kentik/synthetics/v202202/synthetics.proto", 34325,

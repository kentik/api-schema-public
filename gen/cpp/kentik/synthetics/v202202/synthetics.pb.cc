...
const char descriptor_table_protodef_kentik_2fsynthetics_2fv202202_2fsynthetics_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "| dst)R\tdirection\"\334\002\n\007DnsTest\022>\n\006target\030"
  "\001 \001(\tB&\222A#2!Fully qualified DNS name to "
  "queryR\006target\0223\n\007timeout\030\002 \001(\rB\031\222A\0262\024---"
  " <deprecated> ---R\007timeout\022g\n\013record_typ"
  "e\030\003 \001(\0162$.kentik.synthetics.v202202.DNSR"
  "ecordB \222A\0352\033Type of DNS record to queryR"
  "\nrecordType\022B\n\007servers\030\004 \003(\tB(\222A%2#List "
  "of IP addresses of DNS serversR\007servers\022"
  "/\n\004port\030\005 \001(\rB\033\222A\0302\026Target DNS server po"
  "rtR\004port\"\306\004\n\007UrlTest\0229\n\006target\030\001 \001(\tB!\222A"
  "\0362\034HTTP or HTTPS URL to requestR\006target\022"
  "I\n\007timeout\030\002 \001(\rB/\222A,2*HTTP transaction "
  "timeout (in milliseconds)R\007timeout\022Q\n\006me"
  "thod\030\003 \001(\tB9\222A624HTTP method to use (GET"
  " | HEAD | PATCH | POST | PUT)R\006method\022\177\n"
  "\007headers\030\004 \003(\0132/.kentik.synthetics.v2022"
  "02.UrlTest.HeadersEntryB4\222A12/Map of HTT"
  "P header values keyed by header namesR\007h"
  "eaders\022*\n\004body\030\005 \001(\tB\026\222A\0232\021HTTP request "
  "bodyR\004body\022y\n\021ignore_tls_errors\030\006 \001(\010BM\222"
  "AJ2HBoolean indicating whether to ignore"
  " TLS certificate verification errorsR\017ig"
  "noreTlsErrors\032:\n\014HeadersEntry\022\020\n\003key\030\001 \001"
  "(\tR\003key\022\024\n\005value\030\002 \001(\tR\005value:\0028\001\"\254\005\n\014Pa"
  "geLoadTest\0229\n\006target\030\001 \001(\tB!\222A\0362\034HTTP or"
  " HTTPS URL to requestR\006target\022I\n\007timeout"
  "\030\002 \001(\rB/\222A,2*HTTP transaction timeout (i"
  "n milliseconds)R\007timeout\022\204\001\n\007headers\030\003 \003"
  "(\01324.kentik.synthetics.v202202.PageLoadT"
  "est.HeadersEntryB4\222A12/Map of HTTP heade"
  "r values keyed by header namesR\007headers\022"
  "y\n\021ignore_tls_errors\030\004 \001(\010BM\222AJ2HBoolean"
  " indicating whether to ignore TLS certif"
  "icate verification errorsR\017ignoreTlsErro"
  "rs\022\226\001\n\rcss_selectors\030\005 \003(\01329.kentik.synt"
  "hetics.v202202.PageLoadTest.CssSelectors"
  "EntryB6\222A321Map of CSS selector values k"
  "eyed by selector nameR\014cssSelectors\032:\n\014H"
  "eadersEntry\022\020\n\003key\030\001 \001(\tR\003key\022\024\n\005value\030\002"
  " \001(\tR\005value:\0028\001\032\?\n\021CssSelectorsEntry\022\020\n\003"
  "key\030\001 \001(\tR\003key\022\024\n\005value\030\002 \001(\tR\005value:\0028\001"
  "\"\221\001\n\017NetworkMeshTest\022~\n\014use_local_ip\030\001 \001"
  "(\010B\\\222AY2WBoolean value indicating whethe"
  "r to use local (private) IP address of t"
  "he target agentsR\nuseLocalIp\"\307\002\n\nMetricD"
  "ata\0226\n\007current\030\001 \001(\rB\034\222A\0312\027Current value"
  " of metricR\007current\022\?\n\013rolling_avg\030\002 \001(\r"
  "B\036\222A\0332\031Rolling average of metricR\nrollin"
  "gAvg\022[\n\016rolling_stddev\030\003 \001(\rB4\222A12/Rolli"
  "ng average of standard deviation of metr"
  "icR\rrollingStddev\022c\n\006health\030\004 \001(\tBK\222AH2F"
  "Health evaluation status for the metric "
  "(healthy | warning | critical)R\006health\"\257"
  "\001\n\016PacketLossData\0228\n\007current\030\001 \001(\001B\036\222A\0332"
  "\031Current packet loss valueR\007current\022c\n\006h"
  "ealth\030\002 \001(\tBK\222AH2FHealth evaluation stat"
  "us for the metric (healthy | warning | c"
  "ritical)R\006health\"\326\003\n\013PingResults\022E\n\006targ"
  "et\030\001 \001(\tB-\222A*2(Hostname or address of th"
  "e probed targetR\006target\022n\n\013packet_loss\030\002"
  " \001(\0132).kentik.synthetics.v202202.PacketL"
  "ossDataB\"\222A\0372\035Packet loss metric and hea"
  "lthR\npacketLoss\022f\n\007latency\030\003 \001(\0132%.kenti"
  "k.synthetics.v202202.MetricDataB%\222A\"2 Pa"
  "cket latency metric and healthR\007latency\022"
  "o\n\006jitter\030\004 \001(\0132%.kentik.synthetics.v202"
  "202.MetricDataB0\222A-2+Latency jitter (var"
  "iance) metric and healthR\006jitter\0227\n\006dst_"
  "ip\030\005 \001(\tB \222A\0352\033IP address of probed targ"
  "etR\005dstIp\"\371\001\n\020HTTPResponseData\0224\n\006status"
  "\030\001 \001(\rB\034\222A\0312\027HTTP status in responseR\006st"
  "atus\022>\n\004size\030\002 \001(\rB*\222A\'2%Total size of  "
  "received response bodyR\004size\022o\n\004data\030\003 \001"
  "(\tB[\222AX2VDetailed information about tran"
  "saction timing, connection characteristi"
  "cs and responseR\004data\"\344\002\n\013HTTPResults\022.\n"
  "\006target\030\001 \001(\tB\026\222A\0232\021Target probed URLR\006t"
  "arget\022m\n\007latency\030\002 \001(\0132%.kentik.syntheti"
  "cs.v202202.MetricDataB,\222A)2\'HTTP respons"
  "e latency metric and healthR\007latency\022v\n\010"
  "response\030\004 \001(\0132+.kentik.synthetics.v2022"
  "02.HTTPResponseDataB-\222A*2(Information ab"
  "out received HTTP responseR\010response\022>\n\006"
  "dst_ip\030\005 \001(\tB\'\222A$2\"IP address of probed "
  "target serverR\005dstIp\"\207\001\n\017DNSResponseData"
  "\0220\n\006status\030\001 \001(\rB\030\222A\0252\023Received DNS stat"
  "usR\006status\022B\n\004data\030\002 \001(\tB.\222A+2)Text rend"
  "ering of received DNS resolutionR\004data\"\335"
  "\002\n\nDNSResults\022/\n\006target\030\001 \001(\tB\027\222A\0242\022Quer"
  "ied DNS recordR\006target\022:\n\006server\030\002 \001(\tB\""
  "\222A\0372\035DNS server used for the queryR\006serv"
  "er\022l\n\007latency\030\003 \001(\0132%.kentik.synthetics."
  "v202202.MetricDataB+\222A(2&DNS response la"
  "tency metric and healthR\007latency\022t\n\010resp"
  "onse\030\005 \001(\0132*.kentik.synthetics.v202202.D"
  "NSResponseDataB,\222A)2\'Information about r"
  "eceived DNS responseR\010response\"\203\003\n\013TaskR"
  "esults\022e\n\004ping\030\001 \001(\0132&.kentik.synthetics"
  ".v202202.PingResultsB\'\222A$2\"Entry contain"
  "ing ping task resultsH\000R\004ping\022e\n\004http\030\002 "
  "\001(\0132&.kentik.synthetics.v202202.HTTPResu"
  "ltsB\'\222A$2\"Entry containing HTTP task res"
  "ultsH\000R\004http\022a\n\003dns\030\003 \001(\0132%.kentik.synth"
  "etics.v202202.DNSResultsB&\222A#2!Entry con"
  "taining DNS task resultsH\000R\003dns\0226\n\006healt"
  "h\030\004 \001(\tB\036\222A\0332\031Health status of the taskR"
  "\006healthB\013\n\ttask_type\"\236\002\n\014AgentResults\022A\n"
  "\010agent_id\030\001 \001(\tB&\222A#2!ID of the agent pr"
  "oviding resultsR\007agentId\022b\n\006health\030\002 \001(\t"
  "BJ\222AG2EOverall health status of all task"
  " for the test executed by this agentR\006he"
  "alth\022g\n\005tasks\030\003 \003(\0132&.kentik.synthetics."
  "v202202.TaskResultsB)\222A&2$List of result"
  "s for individual tasksR\005tasks\"\352\002\n\013TestRe"
  "sults\022K\n\007test_id\030\001 \001(\tB2\222A/2-ID of the t"
  "est for which results are providedR\006test"
  "Id\022L\n\004time\030\002 \001(\0132\032.google.protobuf.Times"
  "tampB\034\222A\0312\027Results timestamp (UTC)R\004time"
  "\0226\n\006health\030\003 \001(\tB\036\222A\0332\031Health status of "
  "the testR\006health\022\207\001\n\006agents\030\004 \003(\0132\'.kent"
  "ik.synthetics.v202202.AgentResultsBF\222AC2"
  "AList of results from agents executing t"
  "asks on behalf of the testR\006agents\"\201\001\n\005S"
  "tats\022,\n\007average\030\001 \001(\005B\022\222A\0172\rAverage valu"
  "eR\007average\022$\n\003min\030\002 \001(\005B\022\222A\0172\rMinimum va"
  "lueR\003min\022$\n\003max\030\003 \001(\005B\022\222A\0172\rMaximum valu"
  "eR\003max\"\301\002\n\010Location\022C\n\010latitude\030\010 \001(\001B\'\222"
  "A$2\"Latitude in signed decimal degreesR\010"
  "latitude\022F\n\tlongitude\030\t \001(\001B(\222A%2#Longit"
  "ude in signed decimal degreesR\tlongitude"
  "\0226\n\007country\030\001 \001(\tB\034\222A\0312\027Country of the l"
  "ocationR\007country\022A\n\006region\030\002 \001(\tB)\222A&2$G"
  "eographic region within the countryR\006reg"
  "ion\022-\n\004city\030\003 \001(\tB\031\222A\0262\024City of the loca"
  "tionR\004city\"\206\005\n\007NetNode\022H\n\002ip\030\002 \001(\tB8\222A52"
  "3IP address of the node in standard text"
  "ual notationR\002ip\022\?\n\003asn\030\003 \001(\rB-\222A*2(AS n"
  "umber owning the address of the nodeR\003as"
  "n\022K\n\007as_name\030\004 \001(\tB2\222A/2-Name of the AS "
  "owning the address of the nodeR\006asName\022h"
  "\n\010location\030\005 \001(\0132#.kentik.synthetics.v20"
  "2202.LocationB\'\222A$2\"Location of IP addre"
  "ss of the nodeR\010location\022Y\n\010dns_name\030\006 \001"
  "(\tB>\222A;29DNS name of the node (obtained "
  "by reverse DNS resolution)R\007dnsName\022f\n\td"
  "evice_id\030\007 \001(\tBI\222AF2DID of the device co"
  "rresponding with the node in Kentik conf"
  "igurationR\010deviceId\022v\n\007site_id\030\010 \001(\tB]\222A"
  "Z2XID of the site containing the device "
  "corresponding with the node in Kentik co"
  "nfigurationR\006siteId\"\363\001\n\010TraceHop\022v\n\007late"
  "ncy\030\003 \001(\005B\\\222AY2WRound-trip packet latenc"
  "y to the node (in microseconds) - 0 if n"
  "o response was receivedR\007latency\022o\n\007node"
  "_id\030\005 \001(\tBV\222AS2QID of the node for this "
  "hop in the Nodes map  - empty if no resp"
  "onse was receivedR\006nodeId\"\374\001\n\tPathTrace\022"
  ":\n\007as_path\030\001 \003(\005B!\222A\0362\034AS path of the ne"
  "twork traceR\006asPath\022Z\n\013is_complete\030\002 \001(\010"
  "B9\222A624Indication whether response from "
  "target was receivedR\nisComplete\022W\n\004hops\030"
  "\006 \003(\0132#.kentik.synthetics.v202202.TraceH"
  "opB\036\222A\0332\031List of hops in the traceR\004hops"
  "\"\250\004\n\004Path\022H\n\010agent_id\030\001 \001(\tB-\222A*2(ID of "
  "the agent generating the path dataR\007agen"
  "tId\022F\n\ttarget_ip\030\003 \001(\tB)\222A&2$IP address "
  "of the target of the pathR\010targetIp\022j\n\th"
  "op_count\030\004 \001(\0132 .kentik.synthetics.v2022"
  "02.StatsB+\222A(2&Hop count statistics acro"
  "ss all tracesR\010hopCount\022]\n\022max_as_path_l"
  "ength\030\007 \001(\005B0\222A-2+Maximum length of AS p"
  "ath across all tracesR\017maxAsPathLength\022]"
  "\n\006traces\030\010 \003(\0132$.kentik.synthetics.v2022"
  "02.PathTraceB\037\222A\0342\032Data for individual t"
  "racesR\006traces\022d\n\004time\030\t \001(\0132\032.google.pro"
  "tobuf.TimestampB4\222A12/Timestamp (UTC) of"
  " initiation of the path traceR\004time\"\225\005\n\031"
  "GetResultsForTestsRequest\022I\n\003ids\030\001 \003(\tB7"
  "\222A02.List of test IDs for which to retri"
  "eve results\342A\001\002R\003ids\022y\n\nstart_time\030\002 \001(\013"
  "2\032.google.protobuf.TimestampB>\222A725Times"
  "tamp of the oldest results to include in"
  " results\342A\001\002R\tstartTime\022u\n\010end_time\030\003 \001("
  "\0132\032.google.protobuf.TimestampB>\222A725Time"
  "stamp of the newest results to include i"
  "n results\342A\001\002R\007endTime\022P\n\tagent_ids\030\004 \003("
  "\tB3\222A02.List of agent IDs from which to "
  "return resultsR\010agentIds\022]\n\007targets\030\005 \003("
  "\tBC\222A@2>List of targets (test dependent)"
  " for which to retrieve resultsR\007targets\022"
  "\211\001\n\taggregate\030\006 \001(\010Bk\222Ah2fIf true, retri"
  "eve result aggregated across the request"
  "ed time period, else return complete tim"
  "e seriesR\taggregate\"^\n\032GetResultsForTest"
  "sResponse\022@\n\007results\030\001 \003(\0132&.kentik.synt"
  "hetics.v202202.TestResultsR\007results\"\212\004\n\026"
  "GetTraceForTestRequest\022M\n\002id\030\001 \001(\tB=\222A:2"
  "8ID of test for which to retrieve networ"
  "k path trace dataR\002id\022y\n\nstart_time\030\002 \001("
  "\0132\032.google.protobuf.TimestampB>\222A725Time"
  "stamp of the oldest results to include i"
  "n results\342A\001\002R\tstartTime\022u\n\010end_time\030\003 \001"
  "(\0132\032.google.protobuf.TimestampB>\222A725Tim"
  "estamp of the newest results to include "
  "in results\342A\001\002R\007endTime\022P\n\tagent_ids\030\004 \003"
  "(\tB3\222A02.List of agent IDs from which to"
  " return resultsR\010agentIds\022]\n\ntarget_ips\030"
  "\005 \003(\tB>\222A;29List of target IP addresses "
  "for which to retrieve resultsR\ttargetIps"
  "\"\346\002\n\027GetTraceForTestResponse\022\213\001\n\005nodes\030\001"
  " \003(\0132=.kentik.synthetics.v202202.GetTrac"
  "eForTestResponse.NodesEntryB6\222A321Map of"
  " network node information keyed by node "
  "IDsR\005nodes\022_\n\005paths\030\002 \003(\0132\037.kentik.synth"
  "etics.v202202.PathB(\222A%2#List of retriev"
  "ed network path dataR\005paths\032\\\n\nNodesEntr"
  "y\022\020\n\003key\030\001 \001(\tR\003key\0228\n\005value\030\002 \001(\0132\".ken"
  "tik.synthetics.v202202.NetNodeR\005value:\0028"
  "\001\"\023\n\021ListAgentsRequest\"\324\001\n\022ListAgentsRes"
  "ponse\022W\n\006agents\030\001 \003(\0132 .kentik.synthetic"
  "s.v202202.AgentB\035\222A\0322\030List of available "
  "agentsR\006agents\022e\n\rinvalid_count\030\002 \001(\rB@\222"
  "A=2;Number of invalid entries encountere"
  "d while collecting dataR\014invalidCount\"E\n"
  "\017GetAgentRequest\0222\n\002id\030\001 \001(\tB\"\222A\0332\031ID of"
  " the requested agent\342A\001\002R\002id\"t\n\020GetAgent"
  "Response\022`\n\005agent\030\001 \001(\0132 .kentik.synthet"
  "ics.v202202.AgentB(\222A%2#Agent configurat"
  "ion and status dataR\005agent\"k\n\022UpdateAgen"
  "tRequest\022U\n\005agent\030\001 \001(\0132 .kentik.synthet"
  "ics.v202202.AgentB\035\222A\0322\030Agent configurat"
  "ion dataR\005agent\"w\n\023UpdateAgentResponse\022`"
  "\n\005agent\030\001 \001(\0132 .kentik.synthetics.v20220"
  "2.AgentB(\222A%2#Agent configuration and st"
  "atus dataR\005agent\"L\n\022DeleteAgentRequest\0226"
  "\n\002id\030\001 \001(\tB&\222A\0372\035ID of the agent to be d"
  "eleted\342A\001\002R\002id\"\025\n\023DeleteAgentResponse\"\022\n"
  "\020ListTestsRequest\"\341\001\n\021ListTestsResponse\022"
  "e\n\005tests\030\001 \003(\0132\037.kentik.synthetics.v2022"
  "02.TestB.\222A+2)List of configured active "
  "or paused testsR\005tests\022e\n\rinvalid_count\030"
  ...
  "2\037.kentik.synthetics.v202202.TestB \222A\0312\027"
  "Test configuration data\342A\001\002R\004test\"r\n\022Cre"
  "ateTestResponse\022\\\n\004test\030\001 \001(\0132\037.kentik.s"
  "ynthetics.v202202.TestB\'\222A$2\"Test config"
  "uration and status dataR\004test\"\?\n\016GetTest"
  "Request\022-\n\002id\030\001 \001(\tB\035\222A\0262\024ID of requeste"
  "d test\342A\001\002R\002id\"o\n\017GetTestResponse\022\\\n\004tes"
  "t\030\001 \001(\0132\037.kentik.synthetics.v202202.Test"
  "B\'\222A$2\"Test configuration and status dat"
  "aR\004test\"f\n\021UpdateTestRequest\022Q\n\004test\030\001 \001"
  "(\0132\037.kentik.synthetics.v202202.TestB\034\222A\031"
  "2\027Test configuration dataR\004test\"r\n\022Updat"
  "eTestResponse\022\\\n\004test\030\001 \001(\0132\037.kentik.syn"
  "thetics.v202202.TestB\'\222A$2\"Test configur"
  "ation and status dataR\004test\"J\n\021DeleteTes"
  "tRequest\0225\n\002id\030\001 \001(\tB%\222A\0362\034ID of the tes"
  "t to be deleted\342A\001\002R\002id\"\024\n\022DeleteTestRes"
  "ponse\"\272\001\n\024SetTestStatusRequest\022F\n\002id\030\001 \001"
  "(\tB6\222A/2-ID of the test which status is "
  "to be modified\342A\001\002R\002id\022Z\n\006status\030\002 \001(\0162%"
  ".kentik.synthetics.v202202.TestStatusB\033\222"
  "A\0242\022Target test status\342A\001\002R\006status\"\027\n\025Se"
  "tTestStatusResponse*}\n\rImplementType\022\036\n\032"
  "IMPLEMENT_TYPE_UNSPECIFIED\020\000\022\027\n\023IMPLEMEN"
  "T_TYPE_RUST\020\001\022\027\n\023IMPLEMENT_TYPE_NODE\020\002\022\032"
  "\n\026IMPLEMENT_TYPE_NETWORK\020\003*]\n\010IPFamily\022\031"
  "\n\025IP_FAMILY_UNSPECIFIED\020\000\022\020\n\014IP_FAMILY_V"
  "4\020\001\022\020\n\014IP_FAMILY_V6\020\002\022\022\n\016IP_FAMILY_DUAL\020"
  "\003*r\n\nTestStatus\022\033\n\027TEST_STATUS_UNSPECIFI"
  "ED\020\000\022\026\n\022TEST_STATUS_ACTIVE\020\001\022\026\n\022TEST_STA"
  "TUS_PAUSED\020\002\022\027\n\023TEST_STATUS_DELETED\020\003*q\n"
  "\013AgentStatus\022\034\n\030AGENT_STATUS_UNSPECIFIED"
  "\020\000\022\023\n\017AGENT_STATUS_OK\020\001\022\025\n\021AGENT_STATUS_"
  "WAIT\020\002\022\030\n\024AGENT_STATUS_DELETED\020\003*\310\001\n\tDNS"
  "Record\022\032\n\026DNS_RECORD_UNSPECIFIED\020\000\022\020\n\014DN"
  "S_RECORD_A\020\001\022\023\n\017DNS_RECORD_AAAA\020\002\022\024\n\020DNS"
  "_RECORD_CNAME\020\003\022\024\n\020DNS_RECORD_DNAME\020\004\022\021\n"
  "\rDNS_RECORD_NS\020\005\022\021\n\rDNS_RECORD_MX\020\006\022\022\n\016D"
  "NS_RECORD_PTR\020\007\022\022\n\016DNS_RECORD_SOA\020\0102\306\005\n\025"
  "SyntheticsDataService\022\263\002\n\022GetResultsForT"
  "ests\0224.kentik.synthetics.v202202.GetResu"
  "ltsForTestsRequest\0325.kentik.synthetics.v"
  "202202.GetResultsForTestsResponse\"\257\001\222As\022"
  "\025Get results for tests\032FReturns probe re"
  "sults for a set of tests for specified p"
  "eriod of time.*\022GetResultsForTests\362\327\002\017sy"
  "nthetics:read\202\323\344\223\002 \"\033/synthetics/v202202"
  "/results:\001*\022\320\002\n\017GetTraceForTest\0221.kentik"
  ".synthetics.v202202.GetTraceForTestReque"
  "st\0322.kentik.synthetics.v202202.GetTraceF"
  "orTestResponse\"\325\001\222A\232\001\022!Get network trace"
  " data for a test\032dGet network trace data"
  " for a specific synthetic test. The test"
  " must have traceroute task configured.*\017"
  "GetTraceForTest\362\327\002\017synthetics:read\202\323\344\223\002\036"
  "\"\031/synthetics/v202202/trace:\001*\032$\312A\023grpc."
  "api.kentik.com\352\327\002\nsynthetics2\274\026\n\026Synthet"
  "icsAdminService\022\215\002\n\nListAgents\022,.kentik."
  "synthetics.v202202.ListAgentsRequest\032-.k"
  "entik.synthetics.v202202.ListAgentsRespo"
  "nse\"\241\001\222Ac\022\025List available agents\032>Return"
  "s list of all synthetic agents available"
  " in the account.*\nListAgents\362\327\002\025admin.sy"
  "nthetics:read\202\323\344\223\002\034\022\032/synthetics/v202202"
  "/agents\022\215\002\n\010GetAgent\022*.kentik.synthetics"
  ".v202202.GetAgentRequest\032+.kentik.synthe"
  "tics.v202202.GetAgentResponse\"\247\001\222Ad\022\036Get"
  " information about an agent\0328Returns inf"
  "ormation about the requested synthetic a"
  "gent.*\010GetAgent\362\327\002\025admin.synthetics:read"
  "\202\323\344\223\002!\022\037/synthetics/v202202/agents/{id}\022"
  "\227\002\n\013UpdateAgent\022-.kentik.synthetics.v202"
  "202.UpdateAgentRequest\032..kentik.syntheti"
  "cs.v202202.UpdateAgentResponse\"\250\001\222A[\022 Up"
  "date configuration of an agent\032*Update c"
  "onfiguration of a synthetic agent.*\013Upda"
  "teAgent\362\327\002\026admin.synthetics:write\202\323\344\223\002*\032"
  "%/synthetics/v202202/agents/{agent.id}:\001"
  "*\022\255\002\n\013DeleteAgent\022-.kentik.synthetics.v2"
  "02202.DeleteAgentRequest\032..kentik.synthe"
  "tics.v202202.DeleteAgentResponse\"\276\001\222Az\022\017"
  "Delete an agent\032ZDeletes the requested a"
  "gent. The deleted agent is removed from "
  "configuration of all tests.*\013DeleteAgent"
  "\362\327\002\026admin.synthetics:write\202\323\344\223\002!*\037/synth"
  "etics/v202202/agents/{id}\022\206\002\n\tListTests\022"
  "+.kentik.synthetics.v202202.ListTestsReq"
  "uest\032,.kentik.synthetics.v202202.ListTes"
  "tsResponse\"\235\001\222A`\022\016List all tests\032CReturn"
  "s a list of all configured active and pa"
  "used synthetic tests.*\tListTests\362\327\002\025admi"
  "n.synthetics:read\202\323\344\223\002\033\022\031/synthetics/v20"
  "2202/tests\022\217\002\n\nCreateTest\022,.kentik.synth"
  "etics.v202202.CreateTestRequest\032-.kentik"
  ".synthetics.v202202.CreateTestResponse\"\243"
  ...
  "cs:write\202\323\344\223\002\036\"\031/synthetics/v202202/test"
  "s:\001*\022\220\002\n\007GetTest\022).kentik.synthetics.v20"
  "2202.GetTestRequest\032*.kentik.synthetics."
  "v202202.GetTestResponse\"\255\001\222Ak\022\034Get infor"
  "mation about a test\032BReturns configurati"
  "on and status for the requested syntheti"
  "c test.*\007GetTest\362\327\002\025admin.synthetics:rea"
  "d\202\323\344\223\002 \022\036/synthetics/v202202/tests/{id}\022"
  "\217\002\n\nUpdateTest\022,.kentik.synthetics.v2022"
  "02.UpdateTestRequest\032-.kentik.synthetics"
  ".v202202.UpdateTestResponse\"\243\001\222AX\022\036Updat"
  "e configuration of a test\032*Updates confi"
  "guration of a synthetic test.*\nUpdateTes"
  "t\362\327\002\026admin.synthetics:write\202\323\344\223\002(\032#/synt"
  "hetics/v202202/tests/{test.id}:\001*\022\261\002\n\nDe"
  "leteTest\022,.kentik.synthetics.v202202.Del"
  "eteTestRequest\032-.kentik.synthetics.v2022"
  "02.DeleteTestResponse\"\305\001\222A\201\001\022\030Delete a s"
  "ynthetic test.\032YDeletes the synthetics t"
  "est. All accumulated results for the tes"
  "t cease to be accessible.*\nDeleteTest\362\327\002"
  "\026admin.synthetics:write\202\323\344\223\002 *\036/syntheti"
  "cs/v202202/tests/{id}\022\227\002\n\rSetTestStatus\022"
  "/.kentik.synthetics.v202202.SetTestStatu"
  "sRequest\0320.kentik.synthetics.v202202.Set"
  "TestStatusResponse\"\242\001\222AU\022!Update status "
  "of a synthetic test\032!Update status of a "
  "synthetic test*\rSetTestStatus\362\327\002\026admin.s"
  "ynthetics:write\202\323\344\223\002*\032%/synthetics/v2022"
  "02/tests/{id}/status:\001*\032*\312A\023grpc.api.ken"
  "tik.com\352\327\002\020admin.syntheticsB\274\?ZHgithub.c"
  "om/kentik/api-schema/gen/go/kentik/synth"
  "etics/v202202;synthetics\222A\356>\022\204=\n\031Synthet"
  "ics Monitoring API\022\226<# Overview\nThe Synt"
  "hetics Monitoring API provides programma"
  "tic access to Kentik\'s [synthetic monito"
  "ring system](https://kb.kentik.com/v4/Ma"
  "00.htm). The API consists of two endpoin"
  "ts:\n| Endpoint | Purpose |\n|-----------|"
  "---------|\n| SyntheticsAdminService | CR"
  "UD operations for synthetic tests and ag"
  "ents |\n| SyntheticsDataService  | Retrie"
  "val of synthetic test results and networ"
  "k traces |\n\nBoth REST endpoint and gRPC "
  "RPCs are provided.\n### Known Limitations"
  ...
  "\n\nThe set of tasks executed on behalf of"
  " a given test depends on the `type` of t"
  "hat test. The following test types are c"
  "urrently supported by the API:\n| API typ"
  "e | Portal (UI) equivalent | Tasks |\n|--"
  "-------------|--------------|-------|\n| "
  "ip | IP Address | ping, traceroute |\n| h"
  "ostname | Hostname | ping, traceroute |\n"
  "| network_grid | Network Grid | ping, tr"
  "aceroute |\n| agent | Agent-to-Agent | pi"
  "ng, traceroute |\n| network_mesh | Networ"
  "k Mesh | ping, traceroute |\n| flow | Aut"
  "onomous Tests (5 variants) | ping, trace"
  "route |\n| url | HTTP(S) or API | http, p"
  "ing (optional), traceroute (optional) |\n"
  "| page_load | Page Load | page-load, pin"
  "g (optional), traceroute (optional) |\n| "
  "dns | DNS Server Monitor | dns |\n| dns_g"
  "rid | DNS Server Grid | dns |\n\n***Note:*"
  "** `ping` and `traceroute` tasks are alw"
  "ays run together (never one without the "
  "other).\n\n# Test Attributes and Settings\n"
  "The attributes of the test object enable"
  " configuration of test settings, access "
  "to test metadata, and access to runtime "
  "state information.\n### State and Metadat"
  "a Attributes\n The following table lists "
  "the metadata and state attributes:\n| Att"
  "ribute | Access | Purpose |\n|-----------"
  "|--------|---------|\n| id | RO | System-"
  ...
  "|\n| status | RW | Life-cycle status of t"
  "he test |\n| cdate | RO | Creation timest"
  "amp |\n| edate | RO | Last-modification t"
  "imestamp |\n| created_by | RO | Identity "
  "of the user that created the test |\n| la"
  "st_updated_by | RO | Identity of the lat"
  "est user to modify the test |\n| labels |"
  " RW | List of names of labels applied to"
  " the test |\n\nTest configuration is perfo"
  "rmed via the test\'s `settings` attribute"
  ". Some settings are common to all tests "
  "while others are specific to tests of a "
  "given type.\n### Common Test Settings\nThe"
  " following settings are used for tests o"
  "f all types:\n| Attribute | Purpose | Req"
  "uired |\n|-----------|---------|---------"
  "-|\n| agentIds  | IDs of agents to execut"
  "e tasks for the test | YES |\n| period | "
  "Test execution interval in seconds | NO "
  "(default 60s) |\n| family | IP address fa"
  "mily. Used only for tests whose type is "
  "url or dns. Selects which type of DNS re"
  "source is queried for resolving hostname"
  " to target address | NO (default IP_FAMI"
  "LY_DUAL) |\n| notificationChannels | List"
  " of notification channels for the test |"
  " NO (default empty list) |\n| healthSetti"
  "ngs | A HealthSettings object that confi"
  "gures health settings for this test, whi"
  "ch includes metric thresholds that defin"
  "e health status (warning and critical) a"
  "nd trigger associated alarms. | YES |\n| "
  "ping | A TestPingSettings object that co"
  "nfigures the ping task of the test | NO "
  "(default depends on test type) |\n| trace"
  " | A TestTraceSettings object that confi"
  "gures the trace task of the test | NO (d"
  "efault depends on test type) |\n| tasks |"
  " List of names of the tasks that will be"
  " executed for this test | YES |\n\n### Typ"
  "e-specific Settings\nEach test type has i"
  "ts own configuration object that represe"
  "nts the settings for that type. These ty"
  "pe-specific objects are referenced by th"
  "e attributes in `Test.settings`:\n| Test "
  "type    | Settings attribute | Configura"
  "tion object |\n|--------------|----------"
  "---------------|------------------------"
  "---|\n| ip           | ip                "
  "      | IpTest                    |\n| ho"
  ...
  "      | url                     | UrlTes"
  "t                   |\n| page_load    | p"
  "ageLoad                | PageLoadTest   "
  "           |\n| dns          | dns       "
  "              | DnsTest                 "
  "  |\n| dns_grid     | dnsGrid            "
  "     | DnsTest                   |\n\n# Te"
  "st Results\nResults of synthetic tests ar"
  "e returned as a sequence of `TestResults"
  "` objects. Each such object represents m"
  "easurements and health evaluation for a "
  "single test at specific point in time. M"
  "easurements and health evaluation are gr"
  "ouped by agent and by task.\nGranularity "
  "of timestamps in test results depends on"
  " the frequency (period) of the test and "
  "on the requested time range. The minimum"
  " granularity is 1 minute (even when peri"
  "od < 1 minute). The longer the time rang"
  "e, the lower the granularity.\n# Network "
  "Traces\nSynthetic tests that include the "
  "`traceroute` task collect the unidirecti"
  "onal network path from the agent to the "
  "target for each agent/target pair. The t"
  "race data are returned in the `GetTraceF"
  "orTestResponse` object. The `paths` attr"
  "ibute of this object contains the collec"
  "ted network path for each agent/target p"
  "air and the round-trip time (RTT) to eac"
  "h hop.\nHops in actual network traces are"
  " identified by a `nodeId`. The mapping o"
  "f node IDs to address, name, location, a"
  "nd other attributes of the hop is provid"
  "ed in a map that is stored in the `nodes"
  "` attribute of the `GetTraceForTestRespo"
  "nse` object.\n# Agents\nThe Kentik synthet"
  "ic monitoring system recognizes 2 types "
  "of agents:\n* **Global** (public): Manage"
  "d by Kentik and available to every Kenti"
  "k user. All information about global age"
  "nts in this API is read-only.\n* **Privat"
  "e**: Deployed by each customer and avail"
  "able only to that customer.\nTo be visibl"
  "e in this API, a private agent must firs"
  "t associate itself with a customer accou"
  "nt by contacting the Kentik system (via "
  "private API). Once the agent is associat"
  "ed it can be authorized via the API by c"
  "hanging its `status` to `AGENT_STATUS_OK"
  "`. For more information about private ag"
  "ent deployment, see [**Synthetic Agent D"
  "eployments**](https://kb.kentik.com/v4/M"
  "a01.htm#Ma01-Synthetic_Agent_Deployments"
  ").\n\"E\n\026Kentik API Engineering\022+https://g"
  "ithub.com/kentik/api-schema-public2\007v202"
  "202*\001\0022\020application/json:\020application/js"
  "onZD\n\036\n\005email\022\025\010\002\032\017X-CH-Auth-Email \002\n\"\n\005"
  "token\022\031\010\002\032\023X-CH-Auth-API-Token \002b\026\n\t\n\005em"
  "ail\022\000\n\t\n\005token\022\000r`\n\"Kentik synthetic mon"
  "itoring system\022:https://kb.kentik.com/v4"
  "/Ma00.htm#Ma00-Synthetics_Overviewb\006prot"
  "o3"
  ;

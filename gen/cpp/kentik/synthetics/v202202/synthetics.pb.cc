...
const char descriptor_table_protodef_kentik_2fsynthetics_2fv202202_2fsynthetics_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "thetics\220\330\002\003B\303\?ZOgithub.com/kentik/api-sc"
  "hema-public/gen/go/kentik/synthetics/v20"
  "2202;synthetics\222A\356>\022\204=\n\031Synthetics Monit"
  "oring API\022\226<# Overview\nThe Synthetics Mo"
  "nitoring API provides programmatic acces"
  "s to Kentik\'s [synthetic monitoring syst"
  "em](https://kb.kentik.com/v4/Ma00.htm). "
  "The API consists of two endpoints:\n| End"
  "point | Purpose |\n|-----------|---------"
  "|\n| SyntheticsAdminService | CRUD operat"
  "ions for synthetic tests and agents |\n| "
  "SyntheticsDataService  | Retrieval of sy"
  "nthetic test results and network traces "
  "|\n\nBoth REST endpoint and gRPC RPCs are "
  "provided.\n### Known Limitations\nThe API "
  "currently does not support the following"
  " [Synthetic Test Types](https://kb.kenti"
  "k.com/v4/Ma00.htm#Ma00-Synthetic_Test_Ty"
  "pes):\n* BGP Monitor tests, which are sup"
  "ported in a [separate API](https://githu"
  "b.com/kentik/api-schema-public/blob/mast"
  "er/proto/kentik/bgp_monitoring/v202205be"
  "ta1/bgp_monitoring.proto)\n* Transaction "
  ...
  ".io/providers/kentik/kentik-synthetics) "
  "is available for configuring tests and a"
  "gents for Kentik synthetic monitoring.\n#"
  " Anatomy of a Synthetic Test\nEach `Test`"
  " consists of one or more tasks. Tasks ar"
  "e executed by monitoring `Agents` that s"
  "end synthetic traffic (probes) over the "
  "network. The API currently supports foll"
  "owing tasks:\n| Task name  | Purpose |\n|-"
  "-----------|---------|\n| ping       | Te"
  "st basic address, and optionally TCP por"
  "t reachability |\n| traceroute (a.k.a. tr"
  "ace)| Discover unidirectional network pa"
  "th |\n| http | Perform a simple HTTP/HTTP"
  "S request |\n| page-load | Use headless C"
  "hromium to execute an HTTP/HTTPS request"
  " |\n| dns | Execute a DNS query|\n\nThe set"
  " of tasks executed on behalf of a given "
  "test depends on the `type` of that test."
  " The following test types are currently "
  "supported by the API:\n| API type | Porta"
  "l (UI) equivalent | Tasks |\n|-----------"
  "----|--------------|-------|\n| ip | IP A"
  "ddress | ping, traceroute |\n| hostname |"
  " Hostname | ping, traceroute |\n| network"
  "_grid | Network Grid | ping, traceroute "
  "|\n| agent | Agent-to-Agent | ping, trace"
  "route |\n| network_mesh | Network Mesh | "
  "ping, traceroute |\n| flow | Autonomous T"
  "ests (5 variants) | ping, traceroute |\n|"
  " url | HTTP(S) or API | http, ping (opti"
  "onal), traceroute (optional) |\n| page_lo"
  "ad | Page Load | page-load, ping (option"
  "al), traceroute (optional) |\n| dns | DNS"
  " Server Monitor | dns |\n| dns_grid | DNS"
  " Server Grid | dns |\n\n***Note:*** `ping`"
  " and `traceroute` tasks are always run t"
  "ogether (never one without the other).\n\n"
  "# Test Attributes and Settings\nThe attri"
  "butes of the test object enable configur"
  "ation of test settings, access to test m"
  "etadata, and access to runtime state inf"
  "ormation.\n### State and Metadata Attribu"
  "tes\n The following table lists the metad"
  "ata and state attributes:\n| Attribute | "
  "Access | Purpose |\n|-----------|--------"
  "|---------|\n| id | RO | System-generated"
  " unique identifier of the test |\n| name "
  "| RW | User specified name for the test "
  "(need not be unique) |\n| type | RO (afte"
  "r creation) | Type of the test (set on c"
  "reation; read-only thereafter) |\n| statu"
  "s | RW | Life-cycle status of the test |"
  "\n| cdate | RO | Creation timestamp |\n| e"
  "date | RO | Last-modification timestamp "
  "|\n| created_by | RO | Identity of the us"
  "er that created the test |\n| last_update"
  "d_by | RO | Identity of the latest user "
  "to modify the test |\n| labels | RW | Lis"
  "t of names of labels applied to the test"
  " |\n\nTest configuration is performed via "
  "the test\'s `settings` attribute. Some se"
  "ttings are common to all tests while oth"
  "ers are specific to tests of a given typ"
  "e.\n### Common Test Settings\nThe followin"
  "g settings are used for tests of all typ"
  "es:\n| Attribute | Purpose | Required |\n|"
  "-----------|---------|----------|\n| agen"
  "tIds  | IDs of agents to execute tasks f"
  "or the test | YES |\n| period | Test exec"
  "ution interval in seconds | NO (default "
  "60s) |\n| family | IP address family. Use"
  "d only for tests whose type is url or dn"
  "s. Selects which type of DNS resource is"
  " queried for resolving hostname to targe"
  "t address | NO (default IP_FAMILY_DUAL) "
  "|\n| notificationChannels | List of notif"
  "ication channels for the test | NO (defa"
  "ult empty list) |\n| healthSettings | A H"
  "ealthSettings object that configures hea"
  "lth settings for this test, which includ"
  "es metric thresholds that define health "
  "status (warning and critical) and trigge"
  "r associated alarms. | YES |\n| ping | A "
  "TestPingSettings object that configures "
  "the ping task of the test | NO (default "
  "depends on test type) |\n| trace | A Test"
  "TraceSettings object that configures the"
  " trace task of the test | NO (default de"
  "pends on test type) |\n| tasks | List of "
  ...
  "/kentik/api-schema-public2\007v202202*\001\0022\020a"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fsynthetics_2fv202202_2fsynthetics_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fsynthetics_2fv202202_2fsynthetics_2eproto, "kentik/synthetics/v202202/synthetics.proto", 34033,

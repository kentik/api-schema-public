...
const char descriptor_table_protodef_kentik_2fsynthetics_2fv202202_2fsynthetics_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "thetics2\274\026\n\026SyntheticsAdminService\022\215\002\n\nL"
  "istAgents\022,.kentik.synthetics.v202202.Li"
  "stAgentsRequest\032-.kentik.synthetics.v202"
  "202.ListAgentsResponse\"\241\001\222Ac\022\025List avail"
  "able agents\032>Returns list of all synthet"
  "ic agents available in the account.*\nLis"
  "tAgents\362\327\002\025admin.synthetics:read\202\323\344\223\002\034\022\032"
  "/synthetics/v202202/agents\022\215\002\n\010GetAgent\022"
  "*.kentik.synthetics.v202202.GetAgentRequ"
  "est\032+.kentik.synthetics.v202202.GetAgent"
  "Response\"\247\001\222Ad\022\036Get information about an"
  " agent\0328Returns information about the re"
  "quested synthetic agent.*\010GetAgent\362\327\002\025ad"
  "min.synthetics:read\202\323\344\223\002!\022\037/synthetics/v"
  "202202/agents/{id}\022\227\002\n\013UpdateAgent\022-.ken"
  "tik.synthetics.v202202.UpdateAgentReques"
  "t\032..kentik.synthetics.v202202.UpdateAgen"
  "tResponse\"\250\001\222A[\022 Update configuration of"
  " an agent\032*Update configuration of a syn"
  "thetic agent.*\013UpdateAgent\362\327\002\026admin.synt"
  "hetics:write\202\323\344\223\002*\032%/synthetics/v202202/"
  "agents/{agent.id}:\001*\022\255\002\n\013DeleteAgent\022-.k"
  "entik.synthetics.v202202.DeleteAgentRequ"
  "est\032..kentik.synthetics.v202202.DeleteAg"
  "entResponse\"\276\001\222Az\022\017Delete an agent\032ZDele"
  "tes the requested agent. The deleted age"
  "nt is removed from configuration of all "
  "tests.*\013DeleteAgent\362\327\002\026admin.synthetics:"
  "write\202\323\344\223\002!*\037/synthetics/v202202/agents/"
  "{id}\022\206\002\n\tListTests\022+.kentik.synthetics.v"
  "202202.ListTestsRequest\032,.kentik.synthet"
  "ics.v202202.ListTestsResponse\"\235\001\222A`\022\016Lis"
  "t all tests\032CReturns a list of all confi"
  "gured active and paused synthetic tests."
  "*\tListTests\362\327\002\025admin.synthetics:read\202\323\344\223"
  "\002\033\022\031/synthetics/v202202/tests\022\217\002\n\nCreate"
  "Test\022,.kentik.synthetics.v202202.CreateT"
  "estRequest\032-.kentik.synthetics.v202202.C"
  "reateTestResponse\"\243\001\222Ab\022\rCreate a test\032E"
  "Create synthetic test based on configura"
  "tion provided in the request.*\nCreateTes"
  "t\362\327\002\026admin.synthetics:write\202\323\344\223\002\036\"\031/synt"
  "hetics/v202202/tests:\001*\022\220\002\n\007GetTest\022).ke"
  "ntik.synthetics.v202202.GetTestRequest\032*"
  ".kentik.synthetics.v202202.GetTestRespon"
  "se\"\255\001\222Ak\022\034Get information about a test\032B"
  "Returns configuration and status for the"
  " requested synthetic test.*\007GetTest\362\327\002\025a"
  "dmin.synthetics:read\202\323\344\223\002 \022\036/synthetics/"
  "v202202/tests/{id}\022\217\002\n\nUpdateTest\022,.kent"
  "ik.synthetics.v202202.UpdateTestRequest\032"
  "-.kentik.synthetics.v202202.UpdateTestRe"
  "sponse\"\243\001\222AX\022\036Update configuration of a "
  "test\032*Updates configuration of a synthet"
  "ic test.*\nUpdateTest\362\327\002\026admin.synthetics"
  ":write\202\323\344\223\002(\032#/synthetics/v202202/tests/"
  "{test.id}:\001*\022\261\002\n\nDeleteTest\022,.kentik.syn"
  "thetics.v202202.DeleteTestRequest\032-.kent"
  "ik.synthetics.v202202.DeleteTestResponse"
  "\"\305\001\222A\201\001\022\030Delete a synthetic test.\032YDelet"
  "es the synthetics test. All accumulated "
  "results for the test cease to be accessi"
  "ble.*\nDeleteTest\362\327\002\026admin.synthetics:wri"
  "te\202\323\344\223\002 *\036/synthetics/v202202/tests/{id}"
  "\022\227\002\n\rSetTestStatus\022/.kentik.synthetics.v"
  "202202.SetTestStatusRequest\0320.kentik.syn"
  "thetics.v202202.SetTestStatusResponse\"\242\001"
  "\222AU\022!Update status of a synthetic test\032!"
  "Update status of a synthetic test*\rSetTe"
  "stStatus\362\327\002\026admin.synthetics:write\202\323\344\223\002*"
  "\032%/synthetics/v202202/tests/{id}/status:"
  "\001*\032*\312A\023grpc.api.kentik.com\352\327\002\020admin.synt"
  "heticsB\274\?ZHgithub.com/kentik/api-schema/"
  "gen/go/kentik/synthetics/v202202;synthet"
  "ics\222A\356>\022\204=\n\031Synthetics Monitoring API\022\226<"
  ...
  "thetic tests and agents |\n| SyntheticsDa"
  "taService  | Retrieval of synthetic test"
  " results and network traces |\n\nBoth REST"
  " endpoint and gRPC RPCs are provided.\n##"
  "# Known Limitations\nThe API currently do"
  "es not support the following [Synthetic "
  "Test Types](https://kb.kentik.com/v4/Ma0"
  "0.htm#Ma00-Synthetic_Test_Types):\n* BGP "
  "Monitor tests, which are supported in a "
  "[separate API](https://github.com/kentik"
  "/api-schema-public/blob/master/proto/ken"
  "tik/bgp_monitoring/v202205beta1/bgp_moni"
  "toring.proto)\n* Transaction tests.\n\n### "
  "Additional Public Resources\nKentik commu"
  "nity [Python](https://github.com/kentik/"
  "community_sdk_python) and [Go](https://g"
  "ithub.com/kentik/community_sdk_golang) S"
  "DKs provide language-specific support fo"
  "r using this and other Kentik APIs. Thes"
  "e SDKs can be also used as example code "
  "for development. \n A [Terraform provider"
  "](https://registry.terraform.io/provider"
  "s/kentik/kentik-synthetics) is available"
  " for configuring tests and agents for Ke"
  "ntik synthetic monitoring.\n# Anatomy of "
  "a Synthetic Test\nEach `Test` consists of"
  " one or more tasks. Tasks are executed b"
  "y monitoring `Agents` that send syntheti"
  "c traffic (probes) over the network. The"
  " API currently supports following tasks:"
  "\n| Task name  | Purpose |\n|------------|"
  "---------|\n| ping       | Test basic add"
  "ress, and optionally TCP port reachabili"
  "ty |\n| traceroute (a.k.a. trace)| Discov"
  "er unidirectional network path |\n| http "
  "| Perform a simple HTTP/HTTPS request |\n"
  "| page-load | Use headless Chromium to e"
  "xecute an HTTP/HTTPS request |\n| dns | E"
  "xecute a DNS query|\n\nThe set of tasks ex"
  "ecuted on behalf of a given test depends"
  " on the `type` of that test. The followi"
  "ng test types are currently supported by"
  " the API:\n| API type | Portal (UI) equiv"
  "alent | Tasks |\n|---------------|-------"
  "-------|-------|\n| ip | IP Address | pin"
  "g, traceroute |\n| hostname | Hostname | "
  "ping, traceroute |\n| network_grid | Netw"
  "ork Grid | ping, traceroute |\n| agent | "
  "Agent-to-Agent | ping, traceroute |\n| ne"
  "twork_mesh | Network Mesh | ping, tracer"
  "oute |\n| flow | Autonomous Tests (5 vari"
  "ants) | ping, traceroute |\n| url | HTTP("
  "S) or API | http, ping (optional), trace"
  "route (optional) |\n| page_load | Page Lo"
  "ad | page-load, ping (optional), tracero"
  "ute (optional) |\n| dns | DNS Server Moni"
  "tor | dns |\n| dns_grid | DNS Server Grid"
  " | dns |\n\n***Note:*** `ping` and `tracer"
  "oute` tasks are always run together (nev"
  "er one without the other).\n\n# Test Attri"
  "butes and Settings\nThe attributes of the"
  " test object enable configuration of tes"
  "t settings, access to test metadata, and"
  " access to runtime state information.\n##"
  "# State and Metadata Attributes\n The fol"
  "lowing table lists the metadata and stat"
  "e attributes:\n| Attribute | Access | Pur"
  "pose |\n|-----------|--------|---------|\n"
  "| id | RO | System-generated unique iden"
  "tifier of the test |\n| name | RW | User "
  "specified name for the test (need not be"
  " unique) |\n| type | RO (after creation) "
  "| Type of the test (set on creation; rea"
  "d-only thereafter) |\n| status | RW | Lif"
  "e-cycle status of the test |\n| cdate | R"
  "O | Creation timestamp |\n| edate | RO | "
  "Last-modification timestamp |\n| created_"
  "by | RO | Identity of the user that crea"
  "ted the test |\n| last_updated_by | RO | "
  "Identity of the latest user to modify th"
  "e test |\n| labels | RW | List of names o"
  "f labels applied to the test |\n\nTest con"
  "figuration is performed via the test\'s `"
  "settings` attribute. Some settings are c"
  "ommon to all tests while others are spec"
  "ific to tests of a given type.\n### Commo"
  "n Test Settings\nThe following settings a"
  "re used for tests of all types:\n| Attrib"
  "ute | Purpose | Required |\n|-----------|"
  "---------|----------|\n| agentIds  | IDs "
  "of agents to execute tasks for the test "
  "| YES |\n| period | Test execution interv"
  "al in seconds | NO (default 60s) |\n| fam"
  "ily | IP address family. Used only for t"
  "ests whose type is url or dns. Selects w"
  "hich type of DNS resource is queried for"
  " resolving hostname to target address | "
  "NO (default IP_FAMILY_DUAL) |\n| notifica"
  "tionChannels | List of notification chan"
  "nels for the test | NO (default empty li"
  "st) |\n| healthSettings | A HealthSetting"
  "s object that configures health settings"
  " for this test, which includes metric th"
  "resholds that define health status (warn"
  "ing and critical) and trigger associated"
  " alarms. | YES |\n| ping | A TestPingSett"
  "ings object that configures the ping tas"
  "k of the test | NO (default depends on t"
  "est type) |\n| trace | A TestTraceSetting"
  "s object that configures the trace task "
  "of the test | NO (default depends on tes"
  "t type) |\n| tasks | List of names of the"
  " tasks that will be executed for this te"
  "st | YES |\n\n### Type-specific Settings\nE"
  "ach test type has its own configuration "
  "object that represents the settings for "
  "that type. These type-specific objects a"
  "re referenced by the attributes in `Test"
  ".settings`:\n| Test type    | Settings at"
  "tribute | Configuration object |\n|------"
  "--------|-------------------------|-----"
  "----------------------|\n| ip           |"
  " ip                      | IpTest       "
  "             |\n| hostname     | hostname"
  ...
  "dnsGrid                 | DnsTest       "
  "            |\n\n# Test Results\nResults of"
  " synthetic tests are returned as a seque"
  "nce of `TestResults` objects. Each such "
  "object represents measurements and healt"
  "h evaluation for a single test at specif"
  "ic point in time. Measurements and healt"
  "h evaluation are grouped by agent and by"
  " task.\nGranularity of timestamps in test"
  " results depends on the frequency (perio"
  "d) of the test and on the requested time"
  " range. The minimum granularity is 1 min"
  "ute (even when period < 1 minute). The l"
  "onger the time range, the lower the gran"
  "ularity.\n# Network Traces\nSynthetic test"
  "s that include the `traceroute` task col"
  "lect the unidirectional network path fro"
  "m the agent to the target for each agent"
  "/target pair. The trace data are returne"
  "d in the `GetTraceForTestResponse` objec"
  "t. The `paths` attribute of this object "
  "contains the collected network path for "
  "each agent/target pair and the round-tri"
  "p time (RTT) to each hop.\nHops in actual"
  " network traces are identified by a `nod"
  "eId`. The mapping of node IDs to address"
  ", name, location, and other attributes o"
  "f the hop is provided in a map that is s"
  "tored in the `nodes` attribute of the `G"
  "etTraceForTestResponse` object.\n# Agents"
  "\nThe Kentik synthetic monitoring system "
  "recognizes 2 types of agents:\n* **Global"
  "** (public): Managed by Kentik and avail"
  "able to every Kentik user. All informati"
  "on about global agents in this API is re"
  "ad-only.\n* **Private**: Deployed by each"
  " customer and available only to that cus"
  "tomer.\nTo be visible in this API, a priv"
  "ate agent must first associate itself wi"
  "th a customer account by contacting the "
  "Kentik system (via private API). Once th"
  "e agent is associated it can be authoriz"
  "ed via the API by changing its `status` "
  "to `AGENT_STATUS_OK`. For more informati"
  "on about private agent deployment, see ["
  "**Synthetic Agent Deployments**](https:/"
  "/kb.kentik.com/v4/Ma01.htm#Ma01-Syntheti"
  "c_Agent_Deployments).\n\"E\n\026Kentik API Eng"
  "ineering\022+https://github.com/kentik/api-"
  "schema-public2\007v202202*\001\0022\020application/j"
  "son:\020application/jsonZD\n\036\n\005email\022\025\010\002\032\017X-"
  "CH-Auth-Email \002\n\"\n\005token\022\031\010\002\032\023X-CH-Auth-"
  "API-Token \002b\026\n\t\n\005email\022\000\n\t\n\005token\022\000r`\n\"K"
  "entik synthetic monitoring system\022:https"
  "://kb.kentik.com/v4/Ma00.htm#Ma00-Synthe"
  "tics_Overviewb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fsynthetics_2fv202202_2fsynthetics_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fsynthetics_2fv202202_2fsynthetics_2eproto, "kentik/synthetics/v202202/synthetics.proto", 34181,

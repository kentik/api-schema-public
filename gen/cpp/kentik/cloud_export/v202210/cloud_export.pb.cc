...
const char descriptor_table_protodef_kentik_2fcloud_5fexport_2fv202210_2fcloud_5fexport_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "oud_export\220\330\002\003B\363\035ZOgithub.com/kentik/api"
  "-schema-public/go/kentik/cloud_export/v2"
  "02210;cloud_export\222A\236\035\022\317\033\n\036Cloud Export "
  "Configuration API\022\334\032# Overview\nIn Kentik"
  ", a \"cloud export\" is an object whose pr"
  "operties are the values that Kentik need"
  "s to access network flow logs from a giv"
  "en set of resources in a given cloud pro"
  "vider (see [Cloud Exports and Devices](h"
  "ttps://kb.kentik.com/v4/Na00.htm#Na00-Cl"
  "oud_Exports_and_Devices)). The Cloud Exp"
  "ort API enables programmatic management "
  "of cloud exports, serving two primary fu"
  "nctions:\n* Configuration of the Kentik r"
  "esources required to export network flow"
  " logs and metadata from [public clouds]("
  "https://kb.kentik.com/v4/Na00.htm).\n* Ba"
  "sic status information on active export "
  "processes.\n\n### Supported Cloud Provider"
  "s\nThe functionality and configuration pa"
  "rameters supported by this API differ by"
  " cloud provider. The API currently suppo"
  "rts the following providers:\n* [Amazon W"
  "eb Services](https://kb.kentik.com/v0/Bd"
  "06.htm) (AWS)\n* [Microsoft Azure](https:"
  "//kb.kentik.com/v0/Bd08.htm)\n* [Google C"
  "loud](https://kb.kentik.com/v0/Bd07.htm)"
  " (GCP)\n* [IBM Cloud](https://kb.kentik.c"
  "om/v0/Bd09.htm)\n\n### Additional Public R"
  "esources\nThe following additional resour"
  "ces are available for working with this "
  "API:\n* Kentik community [Python](https:/"
  "/github.com/kentik/community_sdk_python)"
  " and [Go](https://github.com/kentik/comm"
  "unity_sdk_golang) SDKs provide language-"
  "specific support for using this and othe"
  "r Kentik APIs. These SDKs can be also us"
  "ed as example code for development.\n* A "
  "[Terraform provider](https://registry.te"
  "rraform.io/providers/kentik/kentik-cloud"
  "export) is available for configuring `cl"
  "oud_export` instances in Kentik. Terrafo"
  "rm modules are available for [AWS](https"
  "://github.com/kentik/config-snippets-clo"
  "ud/tree/master/cloud_AWS/terraform/modul"
  "e), [Azure](https://github.com/kentik/co"
  "nfig-snippets-cloud/tree/master/cloud_Az"
  "ure/terraform/module) \nand [GCP](https:/"
  "/github.com/kentik/config-snippets-cloud"
  "/tree/master/cloud_GCP/terraform/module)"
  ".\nThese modules support onboarding and o"
  "ngoing management of all resources (in p"
  "ublic clouds and in Kentik) required to "
  "export flow logs to Kentik.\n\n# Anatomy o"
  "f a Cloud Export\nConfiguration and statu"
  "s of a `cloud_export` instance is repres"
  "ented by the `CloudExport` object, which"
  " contains three categories of attributes"
  ":\n* Common Configuration Attributes\n* Cl"
  "oud Provider Configuration Attributes\n* "
  "Metadata and Status Attributes\n\n### Comm"
  "on Configuration Attributes\nThe configur"
  "ation attributes in the table below are "
  "common to `CloudExport` objects for all "
  "cloud providers.\n| Attribute | Required "
  "| Default |\n|-----------|----------| ---"
  "---- |\n| enabled | No | False |\n| name |"
  " Yes |   |\n| description | No | <empty s"
  "tring> |\n| type | Yes | |\n| cloud_provid"
  "er | Yes | |\n| plan_id | Yes | |\n\n### Cl"
  "oud Provider Specific Attributes\nThe att"
  "ributes listed in the table below are ob"
  "jects whose parameters are specific to e"
  "ach cloud provider.\n| Cloud Provider | A"
  "ttribute | Object Name |\n|-----------|--"
  "--------| ------- |\n| AWS | aws | AwsPro"
  "perties |\n| Azure | azure | AzurePropert"
  "ies |\n| Google Cloud | gce | GceProperti"
  "es |\n| IBM Cloud | ibm | IbmProperties |"
  "\n\n### Metadata and Status Attributes\nThe"
  " attributes in the table below provide r"
  "ead-only metadata and status for a `clou"
  "d_export` instance.\n| Attribute | Purpos"
  "e |\n|-----------|---------|\n| id | Syste"
  "m-generated unique identifier of the ins"
  "tance |\n| cdate | Creation timestamp |\n|"
  " edate | Last-modification timestamp |\n|"
  " current_status | Runtime status of the "
  "flow and metadata collection process |\n\n"
  "\"E\n\026Kentik API Engineering\022+https://gith"
  "ub.com/kentik/api-schema-public2\007v202210"
  "*\001\0022\020application/json:\020application/jsonZ"
  "D\n\036\n\005email\022\025\010\002\032\017X-CH-Auth-Email \002\n\"\n\005tok"
  "en\022\031\010\002\032\023X-CH-Auth-API-Token \002b\026\n\t\n\005email"
  "\022\000\n\t\n\005token\022\000rE\n Kentik support for publ"
  "ic clouds\022!https://kb.kentik.com/v4/Na00"
  ".htmb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fcloud_5fexport_2fv202210_2fcloud_5fexport_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fcloud_5fexport_2fv202210_2fcloud_5fexport_2eproto, "kentik/cloud_export/v202210/cloud_export.proto", 10412,

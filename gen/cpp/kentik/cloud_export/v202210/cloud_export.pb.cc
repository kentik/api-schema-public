...
const char descriptor_table_protodef_kentik_2fcloud_5fexport_2fv202210_2fcloud_5fexport_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "oud_export\220\330\002\003B\360\035ZLgithub.com/kentik/api"
  "-schema/gen/go/kentik/cloud_export/v2022"
  "10;cloud_export\222A\236\035\022\317\033\n\036Cloud Export Con"
  "figuration API\022\334\032# Overview\nIn Kentik, a"
  " \"cloud export\" is an object whose prope"
  "rties are the values that Kentik needs t"
  "o access network flow logs from a given "
  "set of resources in a given cloud provid"
  "er (see [Cloud Exports and Devices](http"
  "s://kb.kentik.com/v4/Na00.htm#Na00-Cloud"
  "_Exports_and_Devices)). The Cloud Export"
  " API enables programmatic management of "
  "cloud exports, serving two primary funct"
  "ions:\n* Configuration of the Kentik reso"
  "urces required to export network flow lo"
  "gs and metadata from [public clouds](htt"
  "ps://kb.kentik.com/v4/Na00.htm).\n* Basic"
  " status information on active export pro"
  "cesses.\n\n### Supported Cloud Providers\nT"
  "he functionality and configuration param"
  "eters supported by this API differ by cl"
  "oud provider. The API currently supports"
  " the following providers:\n* [Amazon Web "
  "Services](https://kb.kentik.com/v0/Bd06."
  "htm) (AWS)\n* [Microsoft Azure](https://k"
  "b.kentik.com/v0/Bd08.htm)\n* [Google Clou"
  "d](https://kb.kentik.com/v0/Bd07.htm) (G"
  "CP)\n* [IBM Cloud](https://kb.kentik.com/"
  "v0/Bd09.htm)\n\n### Additional Public Reso"
  "urces\nThe following additional resources"
  " are available for working with this API"
  ":\n* Kentik community [Python](https://gi"
  "thub.com/kentik/community_sdk_python) an"
  "d [Go](https://github.com/kentik/communi"
  "ty_sdk_golang) SDKs provide language-spe"
  "cific support for using this and other K"
  "entik APIs. These SDKs can be also used "
  "as example code for development.\n* A [Te"
  "rraform provider](https://registry.terra"
  "form.io/providers/kentik/kentik-cloudexp"
  "ort) is available for configuring `cloud"
  "_export` instances in Kentik. Terraform "
  "modules are available for [AWS](https://"
  "github.com/kentik/config-snippets-cloud/"
  "tree/master/cloud_AWS/terraform/module),"
  " [Azure](https://github.com/kentik/confi"
  "g-snippets-cloud/tree/master/cloud_Azure"
  "/terraform/module) \nand [GCP](https://gi"
  "thub.com/kentik/config-snippets-cloud/tr"
  "ee/master/cloud_GCP/terraform/module).\nT"
  "hese modules support onboarding and ongo"
  "ing management of all resources (in publ"
  "ic clouds and in Kentik) required to exp"
  "ort flow logs to Kentik.\n\n# Anatomy of a"
  " Cloud Export\nConfiguration and status o"
  "f a `cloud_export` instance is represent"
  "ed by the `CloudExport` object, which co"
  "ntains three categories of attributes:\n*"
  " Common Configuration Attributes\n* Cloud"
  " Provider Configuration Attributes\n* Met"
  "adata and Status Attributes\n\n### Common "
  "Configuration Attributes\nThe configurati"
  "on attributes in the table below are com"
  "mon to `CloudExport` objects for all clo"
  "ud providers.\n| Attribute | Required | D"
  "efault |\n|-----------|----------| ------"
  "- |\n| enabled | No | False |\n| name | Ye"
  "s |   |\n| description | No | <empty stri"
  "ng> |\n| type | Yes | |\n| cloud_provider "
  "| Yes | |\n| plan_id | Yes | |\n\n### Cloud"
  " Provider Specific Attributes\nThe attrib"
  "utes listed in the table below are objec"
  "ts whose parameters are specific to each"
  " cloud provider.\n| Cloud Provider | Attr"
  "ibute | Object Name |\n|-----------|-----"
  "-----| ------- |\n| AWS | aws | AwsProper"
  ...
  "tributes in the table below provide read"
  "-only metadata and status for a `cloud_e"
  "xport` instance.\n| Attribute | Purpose |"
  "\n|-----------|---------|\n| id | System-g"
  "enerated unique identifier of the instan"
  "ce |\n| cdate | Creation timestamp |\n| ed"
  "ate | Last-modification timestamp |\n| cu"
  "rrent_status | Runtime status of the flo"
  "w and metadata collection process |\n\n\"E\n"
  ...
  "clouds\022!https://kb.kentik.com/v4/Na00.ht"
  "mb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fcloud_5fexport_2fv202210_2fcloud_5fexport_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fcloud_5fexport_2fv202210_2fcloud_5fexport_2eproto, "kentik/cloud_export/v202210/cloud_export.proto", 10409,

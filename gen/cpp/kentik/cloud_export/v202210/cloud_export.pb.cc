...
const char descriptor_table_protodef_kentik_2fcloud_5fexport_2fv202210_2fcloud_5fexport_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Unique identifier of the instance\342A\001\003R\002i"
  "d\022r\n\004type\030\002 \001(\0162,.kentik.cloud_export.v2"
  "02210.CloudExportTypeB0\222A-2+Ownership of"
  " the cloud export process/agentR\004type\022W\n"
  "\007enabled\030\003 \001(\010B=\222A624Attribute controlli"
  "ng whether the instance is active\342A\001\002R\007e"
  "nabled\022\?\n\004name\030\004 \001(\tB+\222A$2\"User selected"
  " name of the instance\342A\001\002R\004name\022B\n\013descr"
  "iption\030\005 \001(\tB \222A\0352\033Description of the in"
  "stanceR\013description\022Q\n\007plan_id\030\006 \001(\tB8\222A"
  "12/Identifier of the billing plan for th"
  "e instance\342A\001\002R\006planId\022y\n\016cloud_provider"
  "\030\007 \001(\0162*.kentik.cloud_export.v202210.Clo"
  "udProviderB&\222A\0372\035Cloud provider identifi"
  "cation\342A\001\002R\rcloudProvider\022>\n\003aws\030\010 \001(\0132*"
  ".kentik.cloud_export.v202210.AwsProperti"
  "esH\000R\003aws\022D\n\005azure\030\t \001(\0132,.kentik.cloud_"
  "export.v202210.AzurePropertiesH\000R\005azure\022"
  ">\n\003gce\030\n \001(\0132*.kentik.cloud_export.v2022"
  "10.GcePropertiesH\000R\003gce\022>\n\003ibm\030\013 \001(\0132*.k"
  "entik.cloud_export.v202210.IbmProperties"
  "H\000R\003ibm\022\204\001\n\016current_status\030\r \001(\0132..kenti"
  "k.cloud_export.v202210.CloudExportStatus"
  "B-\222A&2$Runtime status of the export proc"
  "ess\342A\001\003R\rcurrentStatus\022S\n\005cdate\030\016 \001(\0132\032."
  "google.protobuf.TimestampB!\222A\0322\030Creation"
  ...
  "Y\222AR2PARN of the IAM role granted access"
  " to the S3 bucket and describe API end-p"
  "oints.\342A\001\002R\niamRoleArn\022S\n\006region\030\003 \001(\tB;"
  "\222A422Name of AWS region from which to ex"
  "port flow logs.\342A\001\002R\006region\022r\n\021delete_af"
  "ter_read\030\004 \001(\010BF\222AC2ADelete from logs fr"
  "om the S3 bucket after export (default f"
  ...
  "port\220\330\002\003B\363\035ZOgithub.com/kentik/api-schem"
  "a-public/go/kentik/cloud_export/v202210;"
  "cloud_export\222A\236\035\022\317\033\n\036Cloud Export Config"
  "uration API\022\334\032# Overview\nIn Kentik, a \"c"
  "loud export\" is an object whose properti"
  "es are the values that Kentik needs to a"
  "ccess network flow logs from a given set"
  " of resources in a given cloud provider "
  "(see [Cloud Exports and Devices](https:/"
  "/kb.kentik.com/v4/Na00.htm#Na00-Cloud_Ex"
  "ports_and_Devices)). The Cloud Export AP"
  "I enables programmatic management of clo"
  "ud exports, serving two primary function"
  "s:\n* Configuration of the Kentik resourc"
  "es required to export network flow logs "
  "and metadata from [public clouds](https:"
  "//kb.kentik.com/v4/Na00.htm).\n* Basic st"
  "atus information on active export proces"
  "ses.\n\n### Supported Cloud Providers\nThe "
  "functionality and configuration paramete"
  "rs supported by this API differ by cloud"
  " provider. The API currently supports th"
  "e following providers:\n* [Amazon Web Ser"
  "vices](https://kb.kentik.com/v0/Bd06.htm"
  ") (AWS)\n* [Microsoft Azure](https://kb.k"
  "entik.com/v0/Bd08.htm)\n* [Google Cloud]("
  "https://kb.kentik.com/v0/Bd07.htm) (GCP)"
  "\n* [IBM Cloud](https://kb.kentik.com/v0/"
  "Bd09.htm)\n\n### Additional Public Resourc"
  "es\nThe following additional resources ar"
  "e available for working with this API:\n*"
  " Kentik community [Python](https://githu"
  "b.com/kentik/community_sdk_python) and ["
  "Go](https://github.com/kentik/community_"
  "sdk_golang) SDKs provide language-specif"
  "ic support for using this and other Kent"
  "ik APIs. These SDKs can be also used as "
  "example code for development.\n* A [Terra"
  "form provider](https://registry.terrafor"
  "m.io/providers/kentik/kentik-cloudexport"
  ") is available for configuring `cloud_ex"
  "port` instances in Kentik. Terraform mod"
  "ules are available for [AWS](https://git"
  "hub.com/kentik/config-snippets-cloud/tre"
  "e/master/cloud_AWS/terraform/module), [A"
  "zure](https://github.com/kentik/config-s"
  "nippets-cloud/tree/master/cloud_Azure/te"
  "rraform/module) \nand [GCP](https://githu"
  "b.com/kentik/config-snippets-cloud/tree/"
  "master/cloud_GCP/terraform/module).\nThes"
  "e modules support onboarding and ongoing"
  " management of all resources (in public "
  "clouds and in Kentik) required to export"
  " flow logs to Kentik.\n\n# Anatomy of a Cl"
  "oud Export\nConfiguration and status of a"
  " `cloud_export` instance is represented "
  "by the `CloudExport` object, which conta"
  "ins three categories of attributes:\n* Co"
  "mmon Configuration Attributes\n* Cloud Pr"
  "ovider Configuration Attributes\n* Metada"
  "ta and Status Attributes\n\n### Common Con"
  "figuration Attributes\nThe configuration "
  "attributes in the table below are common"
  " to `CloudExport` objects for all cloud "
  "providers.\n| Attribute | Required | Defa"
  "ult |\n|-----------|----------| ------- |"
  "\n| enabled | No | False |\n| name | Yes |"
  "   |\n| description | No | <empty string>"
  " |\n| type | Yes | |\n| cloud_provider | Y"
  "es | |\n| plan_id | Yes | |\n\n### Cloud Pr"
  "ovider Specific Attributes\nThe attribute"
  "s listed in the table below are objects "
  "whose parameters are specific to each cl"
  "oud provider.\n| Cloud Provider | Attribu"
  "te | Object Name |\n|-----------|--------"
  "--| ------- |\n| AWS | aws | AwsPropertie"
  "s |\n| Azure | azure | AzureProperties |\n"
  "| Google Cloud | gce | GceProperties |\n|"
  " IBM Cloud | ibm | IbmProperties |\n\n### "
  "Metadata and Status Attributes\nThe attri"
  "butes in the table below provide read-on"
  "ly metadata and status for a `cloud_expo"
  "rt` instance.\n| Attribute | Purpose |\n|-"
  "----------|---------|\n| id | System-gene"
  "rated unique identifier of the instance "
  "|\n| cdate | Creation timestamp |\n| edate"
  " | Last-modification timestamp |\n| curre"
  "nt_status | Runtime status of the flow a"
  "nd metadata collection process |\n\n\"E\n\026Ke"
  "ntik API Engineering\022+https://github.com"
  "/kentik/api-schema-public2\007v202210*\001\0022\020a"
  ...
  "token\022\000rE\n Kentik support for public clo"
  "uds\022!https://kb.kentik.com/v4/Na00.htmb\006"
  "proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fcloud_5fexport_2fv202210_2fcloud_5fexport_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fcloud_5fexport_2fv202210_2fcloud_5fexport_2eproto, "kentik/cloud_export/v202210/cloud_export.proto", 10406,

...
template <> struct is_proto_enum< ::kentik::core::v202012alpha1::ServiceVisibility> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::kentik::core::v202012alpha1::ServiceVisibility>() {
  return ::kentik::core::v202012alpha1::ServiceVisibility_descriptor();
}

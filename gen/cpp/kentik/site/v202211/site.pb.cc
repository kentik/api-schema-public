...
const char descriptor_table_protodef_kentik_2fsite_2fv202211_2fsite_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "012alpha1/annotations.proto\"\272\003\n\033SiteIpAd"
  "dressClassification\022\225\001\n\027infrastructure_n"
  "etworks\030\001 \003(\tB\\\222AY2WList of IP address p"
  "refixes (in standard CIDR notation) used"
  " in infrastructure networksR\026infrastruct"
  "ureNetworks\022\206\001\n\024user_access_networks\030\002 \003"
  "(\tBT\222AQ2OList of IP address prefixes (in"
  " standard CIDR notation) used in access "
  "networksR\022userAccessNetworks\022z\n\016other_ne"
  "tworks\030\003 \003(\tBS\222AP2NList of IP address pr"
  "efixes (in standard CIDR notation) used "
  "in other networksR\rotherNetworks\"\237\001\n\005Lay"
  "er\0222\n\004name\030\001 \001(\tB\036\222A\0332\031Name of the netwo"
  "rk layerR\004name\022b\n\ndevice_ids\030\002 \003(\tBC\222A@2"
  ">IDs of devices that are deemed to be pa"
  "rt of the network layerR\tdeviceIds\"d\n\010La"
  "yerSet\022X\n\006layers\030\001 \003(\0132\032.kentik.site.v20"
  "2211.LayerB$\222A!2\037List of parallel networ"
  "k layersR\006layers\"\257\002\n\rPostalAddress\0221\n\007ad"
  "dress\030\001 \001(\tB\027\222A\0202\016Street address\342A\001\002R\007ad"
  "dress\022-\n\004city\030\002 \001(\tB\031\222A\0222\020City (full nam"
  "e)\342A\001\002R\004city\0220\n\006region\030\003 \001(\tB\030\222A\0252\023Geogr"
  "aphical regionR\006region\022B\n\013postal_code\030\004 "
  "\001(\tB!\222A\0362\034Country specific postal codeR\n"
  "postalCode\022F\n\007country\030\005 \001(\tB,\222A%2#Countr"
  "y (full name or country code)\342A\001\002R\007count"
  "ry\"\364\005\n\004Site\022;\n\002id\030\001 \001(\tB+\222A$2\"System gen"
  "erated unique identifier\342A\001\003R\002id\0227\n\005titl"
  "e\030\002 \001(\tB!\222A\0322\030User selected title/name\342A"
  "\001\002R\005title\0228\n\003lat\030\004 \001(\001B&\222A#2!Latitude (s"
  "igned decimal degrees)R\003lat\0229\n\003lon\030\005 \001(\001"
  "B\'\222A$2\"Longitude (signed decimal degrees"
  ")R\003lon\022^\n\016postal_address\030\006 \001(\0132\".kentik."
  "site.v202211.PostalAddressB\023\222A\0202\016Postal "
  "addressR\rpostalAddress\022H\n\004type\030\007 \001(\0162\035.k"
  "entik.site.v202211.SiteTypeB\025\222A\0162\014Type o"
  "f site\342A\001\002R\004type\022\223\001\n\026address_classificat"
  "ion\030\010 \001(\01320.kentik.site.v202211.SiteIpAd"
  "dressClassificationB*\222A\'2%Classification"
  " of site\'s IP addressesR\025addressClassifi"
  "cation\022m\n\014architecture\030\t \003(\0132\035.kentik.si"
  "te.v202211.LayerSetB*\222A\'2%Logical networ"
  "k topology/architectureR\014architecture\022R\n"
  "\013site_market\030\n \001(\tB1\222A.2,Name of the Sit"
  "e Market this sire belongs toR\nsiteMarke"
  "t\"\022\n\020ListSitesRequest\"\333\001\n\021ListSitesRespo"
  "nse\022_\n\005sites\030\001 \003(\0132\031.kentik.site.v202211"
  ".SiteB.\222A+2)List of configurations of re"
  "quested sitesR\005sites\022e\n\rinvalid_count\030\002 "
  "\001(\rB@\222A=2;Number of invalid entries enco"
  "untered while collecting dataR\014invalidCo"
  "unt\"C\n\016GetSiteRequest\0221\n\002id\030\001 \001(\tB!\222A\0322\030"
  "ID of the requested site\342A\001\002R\002id\"j\n\017GetS"
  "iteResponse\022W\n\004site\030\001 \001(\0132\031.kentik.site."
  "v202211.SiteB(\222A%2#Configuration of the "
  "requested siteR\004site\"j\n\021CreateSiteReques"
  "t\022U\n\004site\030\001 \001(\0132\031.kentik.site.v202211.Si"
  "teB&\222A\0372\035Configuration of the new site\342A"
  "\001\002R\004site\"q\n\022CreateSiteResponse\022[\n\004site\030\001"
  " \001(\0132\031.kentik.site.v202211.SiteB,\222A)2\'Co"
  "nfiguration of the newly created siteR\004s"
  "ite\"\204\001\n\021UpdateSiteRequest\022o\n\004site\030\001 \001(\0132"
  "\031.kentik.site.v202211.SiteB@\222A927New con"
  "figuration attributes for the site to be"
  " updated\342A\001\002R\004site\"k\n\022UpdateSiteResponse"
  "\022U\n\004site\030\001 \001(\0132\031.kentik.site.v202211.Sit"
  "eB&\222A#2!Updated configuration of the sit"
  "eR\004site\"J\n\021DeleteSiteRequest\0225\n\002id\030\001 \001(\t"
  "B%\222A\0362\034ID of the site to be deleted\342A\001\002R"
  "\002id\"\024\n\022DeleteSiteResponse\"\303\003\n\nSiteMarket"
  "\022;\n\002id\030\001 \001(\tB+\222A$2\"System generated uniq"
  "ue identifier\342A\001\003R\002id\0226\n\004name\030\002 \001(\tB\"\222A\033"
  "2\031User selected unique name\342A\001\002R\004name\022<\n"
  "\013description\030\003 \001(\tB\032\222A\0272\025Free-form descr"
  "iptionR\013description\022O\n\017number_of_sites\030\004"
  " \001(\rB\'\222A 2\036Number of sites in this marke"
  "t\342A\001\003R\rnumberOfSites\022S\n\005cdate\030\005 \001(\0132\032.go"
  "ogle.protobuf.TimestampB!\222A\0322\030Creation t"
  "imestamp (UTC)\342A\001\003R\005cdate\022\\\n\005edate\030\006 \001(\013"
  ...
  "rketsResponse\022y\n\014site_markets\030\001 \003(\0132\037.ke"
  "ntik.site.v202211.SiteMarketB5\222A220List "
  "of configurations of requested site mark"
  "etsR\013siteMarkets\022e\n\rinvalid_count\030\002 \001(\rB"
  "@\222A=2;Number of invalid entries encounte"
  "red while collecting dataR\014invalidCount\""
  "P\n\024GetSiteMarketRequest\0228\n\002id\030\001 \001(\tB(\222A!"
  "2\037ID of the requested site market\342A\001\002R\002i"
  "d\"\212\001\n\025GetSiteMarketResponse\022q\n\013site_mark"
  "et\030\001 \001(\0132\037.kentik.site.v202211.SiteMarke"
  "tB/\222A,2*Configuration of the requested s"
  "ite marketR\nsiteMarket\"\212\001\n\027CreateSiteMar"
  "ketRequest\022o\n\013site_market\030\001 \001(\0132\037.kentik"
  ".site.v202211.SiteMarketB-\222A&2$Configura"
  "tion of the new site market\342A\001\002R\nsiteMar"
  "ket\"\221\001\n\030CreateSiteMarketResponse\022u\n\013site"
  "_market\030\001 \001(\0132\037.kentik.site.v202211.Site"
  "MarketB3\222A02.Configuration of the newly "
  "created site marketR\nsiteMarket\"\236\001\n\027Upda"
  "teSiteMarketRequest\022\202\001\n\013site_market\030\001 \001("
  "\0132\037.kentik.site.v202211.SiteMarketB@\222A92"
  "7New configuration attributes for the si"
  "te to be updated\342A\001\002R\nsiteMarket\"\213\001\n\030Upd"
  "ateSiteMarketResponse\022o\n\013site_market\030\001 \001"
  "(\0132\037.kentik.site.v202211.SiteMarketB-\222A*"
  "2(Updated configuration of the site mark"
  "etR\nsiteMarket\"W\n\027DeleteSiteMarketReques"
  "t\022<\n\002id\030\001 \001(\tB,\222A%2#ID of the site marke"
  "t to be deleted\342A\001\002R\002id\"\032\n\030DeleteSiteMar"
  "ketResponse*\264\001\n\010SiteType\022\031\n\025SITE_TYPE_UN"
  "SPECIFIED\020\000\022\031\n\025SITE_TYPE_DATA_CENTER\020\001\022\023"
  "\n\017SITE_TYPE_CLOUD\020\002\022\024\n\020SITE_TYPE_BRANCH\020"
  "\003\022\032\n\026SITE_TYPE_CONNECTIVITY\020\004\022\026\n\022SITE_TY"
  "PE_CUSTOMER\020\005\022\023\n\017SITE_TYPE_OTHER\020\0062\213\026\n\013S"
  "iteService\022\314\001\n\tListSites\022%.kentik.site.v"
  "202211.ListSitesRequest\032&.kentik.site.v2"
  "02211.ListSitesResponse\"p\222A\?\022\017List all s"
  "ites.\032!Returns list of configured sites."
  "*\tListSites\362\327\002\017admin.site:read\202\323\344\223\002\025\022\023/s"
  "ite/v202211/sites\022\353\001\n\007GetSite\022#.kentik.s"
  "ite.v202211.GetSiteRequest\032$.kentik.site"
  ".v202211.GetSiteResponse\"\224\001\222A^\022!Retrieve"
  " configuration of a site.\0320Returns confi"
  "guration of a site specified by ID.*\007Get"
  "Site\362\327\002\017admin.site:read\202\323\344\223\002\032\022\030/site/v20"
  "2211/sites/{id}\022\207\002\n\nCreateSite\022&.kentik."
  "site.v202211.CreateSiteRequest\032\'.kentik."
  "site.v202211.CreateSiteResponse\"\247\001\222Ar\022\025C"
  "onfigure a new site.\032MCreate configurati"
  "on for a new site. Returns the newly cre"
  "ated configuration.*\nCreateSite\362\327\002\020admin"
  ".site:write\202\323\344\223\002\030\"\023/site/v202211/sites:\001"
  "*\022\263\002\n\nUpdateSite\022&.kentik.site.v202211.U"
  "pdateSiteRequest\032\'.kentik.site.v202211.U"
  "pdateSiteResponse\"\323\001\222A\223\001\022 Updates config"
  "uration of a site.\032cReplaces configurati"
  "on of a site with attributes in the requ"
  "est. Returns the updated configuration.*"
  "\nUpdateSite\362\327\002\020admin.site:write\202\323\344\223\002\"\032\035/"
  "site/v202211/sites/{site.id}:\001*\022\367\001\n\nDele"
  "teSite\022&.kentik.site.v202211.DeleteSiteR"
  "equest\032\'.kentik.site.v202211.DeleteSiteR"
  "esponse\"\227\001\222A`\022\037Delete configuration of a"
  " site.\0321Deletes configuration of a site "
  "with specific ID.*\nDeleteSite\362\327\002\020admin.s"
  "ite:write\202\323\344\223\002\032*\030/site/v202211/sites/{id"
  "}\022\372\001\n\017ListSiteMarkets\022+.kentik.site.v202"
  "211.ListSiteMarketsRequest\032,.kentik.site"
  ".v202211.ListSiteMarketsResponse\"\213\001\222AS\022\026"
  "List all site markets.\032(Returns list of "
  "configured site markets.*\017ListSiteMarket"
  "s\362\327\002\017admin.site:read\202\323\344\223\002\034\022\032/site/v20221"
  "1/site_markets\022\230\002\n\rGetSiteMarket\022).kenti"
  "k.site.v202211.GetSiteMarketRequest\032*.ke"
  "ntik.site.v202211.GetSiteMarketResponse\""
  "\257\001\222Ar\022(Retrieve configuration of a site "
  "market.\0327Returns configuration of a site"
  " market specified by ID.*\rGetSiteMarket\362"
  "\327\002\017admin.site:read\202\323\344\223\002!\022\037/site/v202211/"
  "site_markets/{id}\022\265\002\n\020CreateSiteMarket\022,"
  ".kentik.site.v202211.CreateSiteMarketReq"
  "uest\032-.kentik.site.v202211.CreateSiteMar"
  "ketResponse\"\303\001\222A\206\001\022\034Configure a new site"
  " market.\032TCreate configuration for a new"
  " site market. Returns the newly created "
  "configuration.*\020CreateSiteMarket\362\327\002\020admi"
  "n.site:write\202\323\344\223\002\037\"\032/site/v202211/site_m"
  "arkets:\001*\022\347\002\n\020UpdateSiteMarket\022,.kentik."
  "site.v202211.UpdateSiteMarketRequest\032-.k"
  "entik.site.v202211.UpdateSiteMarketRespo"
  "nse\"\365\001\222A\247\001\022\'Updates configuration of a s"
  "ite market.\032jReplaces configuration of a"
  " site market with attributes in the requ"
  "est. Returns the updated configuration.*"
  "\020UpdateSiteMarket\362\327\002\020admin.site:write\202\323\344"
  "\223\0020\032+/site/v202211/site_markets/{site_ma"
  "rket.id}:\001*\022\244\002\n\020DeleteSiteMarket\022,.kenti"
  "k.site.v202211.DeleteSiteMarketRequest\032-"
  ".kentik.site.v202211.DeleteSiteMarketRes"
  "ponse\"\262\001\222At\022&Delete configuration of a s"
  "ite market.\0328Deletes configuration of a "
  "site market with specific ID.*\020DeleteSit"
  "eMarket\362\327\002\020admin.site:write\202\323\344\223\002!*\037/site"
  "/v202211/site_markets/{id}\032$\312A\023grpc.api."
  "kentik.com\352\327\002\nadmin.siteB\374\013Z<github.com/"
  "kentik/api-schema/gen/go/kentik/site/v20"
  "2211;site\222A\272\013\022\323\t\n\026Site Configuration API"
  "\022\350\010# Overview\nThe Site Configuration API"
  " provides programmatic access to configu"
  "ration of Sites and Site Markets:\n\n* **S"
  "ite**: A site is a specific user-defined"
  " physical location (e.g. a data center a"
  "t a given address) or logical location a"
  "t which there is hosting of your devices"
  ", services, providers, or partner networ"
  "ks. Information that can be associated w"
  "ith a site includes the classification o"
  "f IP addresses and the site\'s logical ne"
  "twork topology/architecture.\n* **Site Ma"
  "rket**: Sites with any common characteri"
  "stics of your choosing (e.g. all PoPs in"
  " a particular region) can be logically g"
  "rouped into a site market.\n\nBoth REST en"
  "dpoint and gRPC RPCs are provided.\n\n***N"
  "otes:*** \n    - Once a site is created i"
  "n Kentik, you can assign one or more dev"
  "ices to the site via the settings for th"
  "ose devices; to do so programmatically y"
  "ou\'d use the v5 Device API (see [Device "
  "Create](https://kb.kentik.com/v0/Ec05.ht"
  "m#Ec05-Device_Create)).\n    - Sites can "
  "also be managed using the legacy REST-on"
  "ly [Site API](https://kb.kentik.com/v0/E"
  "c10.htm#Ec10-Site_API), which provides a"
  "ccess to a subset of site configuration "
  "attributes.\"E\n\026Kentik API Engineering\022+h"
  "ttps://github.com/kentik/api-schema-publ"
  "ic2\007v202211*\001\0022\020application/json:\020applic"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fsite_2fv202211_2fsite_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fsite_2fv202211_2fsite_2eproto, "kentik/site/v202211/site.proto", 9247,

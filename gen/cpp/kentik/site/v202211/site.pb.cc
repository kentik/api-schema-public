...
const char descriptor_table_protodef_kentik_2fsite_2fv202211_2fsite_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "kentik.com\352\327\002\nadmin.site\220\330\002\003B\377\013Z\?github."
  "com/kentik/api-schema-public/go/kentik/s"
  "ite/v202211;site\222A\272\013\022\323\t\n\026Site Configurat"
  "ion API\022\350\010# Overview\nThe Site Configurat"
  "ion API provides programmatic access to "
  "configuration of Sites and Site Markets:"
  "\n\n* **Site**: A site is a specific user-"
  "defined physical location (e.g. a data c"
  "enter at a given address) or logical loc"
  "ation at which there is hosting of your "
  "devices, services, providers, or partner"
  " networks. Information that can be assoc"
  "iated with a site includes the classific"
  "ation of IP addresses and the site\'s log"
  "ical network topology/architecture.\n* **"
  "Site Market**: Sites with any common cha"
  "racteristics of your choosing (e.g. all "
  "PoPs in a particular region) can be logi"
  "cally grouped into a site market.\n\nBoth "
  "REST endpoint and gRPC RPCs are provided"
  ".\n\n***Notes:*** \n    - Once a site is cr"
  "eated in Kentik, you can assign one or m"
  "ore devices to the site via the settings"
  " for those devices; to do so programmati"
  "cally you\'d use the v5 Device API (see ["
  "Device Create](https://kb.kentik.com/v0/"
  "Ec05.htm#Ec05-Device_Create)).\n    - Sit"
  "es can also be managed using the legacy "
  "REST-only [Site API](https://kb.kentik.c"
  "om/v0/Ec10.htm#Ec10-Site_API), which pro"
  "vides access to a subset of site configu"
  "ration attributes.\"E\n\026Kentik API Enginee"
  "ring\022+https://github.com/kentik/api-sche"
  "ma-public2\007v202211*\001\0022\020application/json:"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fsite_2fv202211_2fsite_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fsite_2fv202211_2fsite_2eproto, "kentik/site/v202211/site.proto", 9254,

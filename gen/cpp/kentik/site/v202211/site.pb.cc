...
const char descriptor_table_protodef_kentik_2fsite_2fv202211_2fsite_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "kentik.com\352\327\002\nadmin.site\220\330\002\003B\374\013Z<github."
  "com/kentik/api-schema/gen/go/kentik/site"
  "/v202211;site\222A\272\013\022\323\t\n\026Site Configuration"
  " API\022\350\010# Overview\nThe Site Configuration"
  " API provides programmatic access to con"
  "figuration of Sites and Site Markets:\n\n*"
  " **Site**: A site is a specific user-def"
  "ined physical location (e.g. a data cent"
  "er at a given address) or logical locati"
  "on at which there is hosting of your dev"
  "ices, services, providers, or partner ne"
  "tworks. Information that can be associat"
  "ed with a site includes the classificati"
  "on of IP addresses and the site\'s logica"
  "l network topology/architecture.\n* **Sit"
  "e Market**: Sites with any common charac"
  "teristics of your choosing (e.g. all PoP"
  "s in a particular region) can be logical"
  "ly grouped into a site market.\n\nBoth RES"
  "T endpoint and gRPC RPCs are provided.\n\n"
  "***Notes:*** \n    - Once a site is creat"
  "ed in Kentik, you can assign one or more"
  " devices to the site via the settings fo"
  "r those devices; to do so programmatical"
  "ly you\'d use the v5 Device API (see [Dev"
  "ice Create](https://kb.kentik.com/v0/Ec0"
  "5.htm#Ec05-Device_Create)).\n    - Sites "
  "can also be managed using the legacy RES"
  "T-only [Site API](https://kb.kentik.com/"
  "v0/Ec10.htm#Ec10-Site_API), which provid"
  "es access to a subset of site configurat"
  "ion attributes.\"E\n\026Kentik API Engineerin"
  "g\022+https://github.com/kentik/api-schema-"
  "public2\007v202211*\001\0022\020application/json:\020ap"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fsite_2fv202211_2fsite_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fsite_2fv202211_2fsite_2eproto, "kentik/site/v202211/site.proto", 9251,

...
const char descriptor_table_protodef_kentik_2fsite_2fv202211_2fsite_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ".com\352\327\002\nadmin.site\220\330\002\003B\377\013Z\?github.com/ke"
  "ntik/api-schema-public/go/kentik/site/v2"
  "02211;site\222A\272\013\022\323\t\n\026Site Configuration AP"
  "I\022\350\010# Overview\nThe Site Configuration AP"
  "I provides programmatic access to config"
  "uration of Sites and Site Markets:\n\n* **"
  "Site**: A site is a specific user-define"
  "d physical location (e.g. a data center "
  "at a given address) or logical location "
  "at which there is hosting of your device"
  "s, services, providers, or partner netwo"
  "rks. Information that can be associated "
  "with a site includes the classification "
  "of IP addresses and the site\'s logical n"
  "etwork topology/architecture.\n* **Site M"
  "arket**: Sites with any common character"
  "istics of your choosing (e.g. all PoPs i"
  "n a particular region) can be logically "
  "grouped into a site market.\n\nBoth REST e"
  "ndpoint and gRPC RPCs are provided.\n\n***"
  "Notes:*** \n    - Once a site is created "
  "in Kentik, you can assign one or more de"
  "vices to the site via the settings for t"
  "hose devices; to do so programmatically "
  "you\'d use the v5 Device API (see [Device"
  " Create](https://kb.kentik.com/v0/Ec05.h"
  "tm#Ec05-Device_Create)).\n    - Sites can"
  " also be managed using the legacy REST-o"
  "nly [Site API](https://kb.kentik.com/v0/"
  "Ec10.htm#Ec10-Site_API), which provides "
  "access to a subset of site configuration"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fsite_2fv202211_2fsite_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fsite_2fv202211_2fsite_2eproto, "kentik/site/v202211/site.proto", 9248,

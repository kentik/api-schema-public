...
const char descriptor_table_protodef_kentik_2flabel_2fv202203alpha1_2flabel_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "oto\032\030google/type/latlng.proto\032 google/ty"
  "pe/postal_address.proto\032.protoc-gen-open"
  "apiv2/options/annotations.proto\032+kentik/"
  "core/v202012alpha1/annotations.proto\032\037go"
  "ogle/protobuf/timestamp.proto\"\307\001\n\005Label\022"
  ...
  "oogle.protobuf.TimestampR\005edate\"\023\n\021ListL"
  "abelsRequest\"t\n\022ListLabelsResponse\0229\n\006la"
  "bels\030\001 \003(\0132!.kentik.label.v202203alpha1."
  "LabelR\006labels\022#\n\rinvalid_count\030\002 \001(\005R\014in"
  "validCount\"M\n\022CreateLabelRequest\0227\n\005labe"
  "l\030\001 \001(\0132!.kentik.label.v202203alpha1.Lab"
  "elR\005label\"N\n\023CreateLabelResponse\0227\n\005labe"
  "l\030\001 \001(\0132!.kentik.label.v202203alpha1.Lab"
  "elR\005label\"M\n\022UpdateLabelRequest\0227\n\005label"
  "\030\001 \001(\0132!.kentik.label.v202203alpha1.Labe"
  "lR\005label\"N\n\023UpdateLabelResponse\0227\n\005label"
  "\030\001 \001(\0132!.kentik.label.v202203alpha1.Labe"
  "lR\005label\"$\n\022DeleteLabelRequest\022\016\n\002id\030\001 \001"
  "(\tR\002id\"\025\n\023DeleteLabelResponse2\276\010\n\014LabelS"
  "ervice\022\367\001\n\nListLabels\022-.kentik.label.v20"
  "2203alpha1.ListLabelsRequest\032..kentik.la"
  "bel.v202203alpha1.ListLabelsResponse\"\211\001\222"
  "AO\022\023Fetch Search Labels\032-Return list of "
  "labels matches search critera.*\tListLabe"
  "l\362\327\002\020admin.label:read\202\323\344\223\002\035\022\033/label/v202"
  "203alpha1/labels\022\374\001\n\013CreateLabel\022..kenti"
  "k.label.v202203alpha1.CreateLabelRequest"
  "\032/.kentik.label.v202203alpha1.CreateLabe"
  "lResponse\"\213\001\222AM\022\017Create a label.\032-Create"
  " a label from request. returns created.*"
  "\013LabelCreate\362\327\002\021admin.label:write\202\323\344\223\002 \""
  "\033/label/v202203alpha1/labels:\001*\022\221\002\n\013Upda"
  "teLabel\022..kentik.label.v202203alpha1.Upd"
  "ateLabelRequest\032/.kentik.label.v202203al"
  "pha1.UpdateLabelResponse\"\240\001\222AW\022\017Update a"
  " label.\0327Replaces the entire label attri"
  "butes specified with id.*\013LabelUpdate\362\327\002"
  "\021admin.label:write\202\323\344\223\002+\"&/label/v202203"
  "alpha1/labels/{label.id}:\001*\022\365\001\n\013DeleteLa"
  "bel\022..kentik.label.v202203alpha1.DeleteL"
  "abelRequest\032/.kentik.label.v202203alpha1"
  ".DeleteLabelResponse\"\204\001\222AD\022\017Delete a lab"
  "el.\032$Deletes the label specified with id"
  ".*\013LabelDelete\362\327\002\021admin.label:write\202\323\344\223\002"
  "\"* /label/v202203alpha1/labels/{id}\032)\312A\023"
  "grpc.api.kentik.com\352\327\002\013admin.label\220\330\002\003B\261"
  "\003ZDgithub.com/kentik/api-schema/gen/go/k"
  "entik/label/v202203alpha1;label\222A\347\002\022\200\001\n\t"
  "Label API\022K--- This API has been depreca"
  "ted and will be removed in the near futu"
  "re ---\"\030\n\026Kentik API Engineering2\014202203"
  "alpha1*\001\0022\020application/json:\020application"
  ...
  "o3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_kentik_2flabel_2fv202203alpha1_2flabel_2eproto_deps[7] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2flabel_2fv202203alpha1_2flabel_2eproto = {
  false, false, descriptor_table_protodef_kentik_2flabel_2fv202203alpha1_2flabel_2eproto, "kentik/label/v202203alpha1/label.proto", 2562,
  &descriptor_table_kentik_2flabel_2fv202203alpha1_2flabel_2eproto_once, descriptor_table_kentik_2flabel_2fv202203alpha1_2flabel_2eproto_sccs, descriptor_table_kentik_2flabel_2fv202203alpha1_2flabel_2eproto_deps, 9, 7,

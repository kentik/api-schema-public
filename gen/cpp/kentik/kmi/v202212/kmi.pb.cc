...
const char descriptor_table_protodef_kentik_2fkmi_2fv202212_2fkmi_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "i\220\330\002\003B\311\017ZAgithub.com/kentik/api-schema-p"
  "ublic/gen/go/kentik/kmi/v202212;kmi\222A\202\017\022"
  "\233\r\n$Kentik Market Intelligence (KMI) API"
  "\022\242\014# Overview\nThe Kentik Market Intellig"
  "ence (KMI) API provides programmatic acc"
  "ess to information related to KMI rankin"
  "gs, KMI markets, and the customers, prov"
  "iders, and peers of individual Autonomou"
  "s Systems (ASes). This information is de"
  "rived from analysis of the global routin"
  "g table, which enables us to classify th"
  "e peering and transit relationships betw"
  "een ASes and to identify the providers, "
  "peers, and customers of a given AS in an"
  "y geography (market). KMI estimates the "
  "volume of IP space transited by ASes in "
  "different geographies and produces ranki"
  "ngs based on that volume, thereby enabli"
  "ng users to compare ASes in various mark"
  "ets.\n\n# KMI Ranking Types\n\nThe following"
  " types of rankings are shown:\n- **Custom"
  "er Base**: Ranked by the size of the ove"
  "rall customer base, estimated by determi"
  "ning how much IP address space a given A"
  "S transits relative to other ASes:\n    -"
  " Retail networks  provide services (e.g."
  " originate content) or have end-users th"
  "at are consumers of services (e.g. ISPs "
  "or \"eyeball\" networks).\n    - Wholesale "
  "networks  connect retail networks to bac"
  "kbone networks.\n    - Backbone networks "
  "carry high volumes of traffic between wh"
  "olesale networks.\n- **Customer Growth**:"
  " Ranked by the change in overall custome"
  "r base (gain/loss of prefixes) over the "
  "last 20 days.\n- **Peering**: Ranked by t"
  "he amount of IP address space sent to th"
  "e AS over a settlement-free peering sess"
  "ion.\n\nBoth REST endpoint and gRPC RPCs a"
  "re provided.\n\n**_Note:_** More informati"
  "on about KMI can be found at [Kentik Mar"
  "ket Intelligence](https://kb.kentik.com/"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fkmi_2fv202212_2fkmi_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fkmi_2fv202212_2fkmi_2eproto, "kentik/kmi/v202212/kmi.proto", 6929,

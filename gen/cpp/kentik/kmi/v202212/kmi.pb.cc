...
const char descriptor_table_protodef_kentik_2fkmi_2fv202212_2fkmi_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "2\007Markets\342A\001\003R\007markets\"\240\004\n\022GetRankingsRe"
  "quest\022g\n\tmarket_id\030\001 \001(\tBJ\222AC2AUnique Ge"
  "o Market identifier (as provided by the "
  "ListMarkets RPC)\342A\001\002R\010marketId\022\342\001\n\trank_"
  "type\030\002 \001(\tB\304\001\222A\300\0012\275\001Type of the requeste"
  "d ranking (\'customer_base\', \'customer_ba"
  "se_retail\', \'customer_base_wholesome\', \'"
  "customer_base_backbone\', \'customer_growt"
  "h\', \'peering_base\'). Defaults to \'custom"
  "er_base\'.R\010rankType\022]\n\002ip\030\003 \001(\tBM\222AJ2HIP"
  " Address Family (\'v4\' or \'v6\') of reques"
  "ted ranking. Defaults to \'v4\'.R\002ip\022S\n\005li"
  "mit\030\004 \001(\rB8\222A523Maximum number of entrie"
  "s returned. (Default: 600).H\000R\005limit\210\001\001B"
  "\010\n\006_limit\"\314\001\n\023GetRankingsResponse\022N\n\010ran"
  "kings\030\001 \003(\0132\033.kentik.kmi.v202212.Ranking"
  "B\025\222A\0222\020List of rankingsR\010rankings\022e\n\rinv"
  "alid_count\030\002 \001(\rB@\222A=2;Number of invalid"
  " entries encountered while collecting da"
  "taR\014invalidCount\"\354\005\n\024GetASNDetailsReques"
  "t\022g\n\tmarket_id\030\001 \001(\tBJ\222AC2AUnique Geo Ma"
  "rket identifier (as provided by the List"
  "Markets RPC)\342A\001\002R\010marketId\0229\n\003asn\030\002 \001(\tB"
  "\'\222A 2\036Autonomous System Number (ASN)\342A\001\002"
  "R\003asn\022H\n\002ip\030\003 \001(\tB8\222A523IP Address Famil"
  "y (\'v4\' or \'v6\'). Defaults to \'v4\'.R\002ip\022"
  "n\n\004type\030\004 \001(\tBZ\222AW2UType of the requeste"
  "d ASN (\'all\', \'customer\', \'provider\', \'p"
  "eer\'). Defaults to \'all\'.R\004type\022v\n\017mutua"
  "l_provider\030\005 \001(\tBM\222AJ2HFilter by mutual "
  "provider (\'all\', \'only\', \'exclude\'). Def"
  "aults to \'all\'.R\016mutualProvider\022v\n\017mutua"
  "l_customer\030\006 \001(\tBM\222AJ2HFilter by mutual "
  "customer (\'all\', \'only\', \'exclude\'). Def"
  "aults to \'all\'.R\016mutualCustomer\022\205\001\n\024sing"
  "lehomed_customer\030\007 \001(\tBR\222AO2MFilter by s"
  "inglehomed customer (\'all\', \'only\', \'exc"
  "lude\'). Defaults to \'all\'.R\023singlehomedC"
  "ustomer\"\255\001\n\025GetASNDetailsResponse\022\223\001\n\013as"
  "n_details\030\001 \001(\0132\036.kentik.kmi.v202212.ASN"
  "DetailsBR\222AO2MMetadata and list of custo"
  "mers, providers, and peers for an Autono"
  "mous SystemR\nasnDetails2\253\007\n\nKmiService\022\344"
  "\001\n\013ListMarkets\022&.kentik.kmi.v202212.List"
  "MarketsRequest\032\'.kentik.kmi.v202212.List"
  "MarketsResponse\"\203\001\222AR\022\035List all geo mark"
  "ets for KMI.\032$Returns list of geo market"
  "s for KMI.*\013ListMarkets\362\327\002\016admin.kmi:rea"
  "d\202\323\344\223\002\026\022\024/kmi/v202212/markets\022\221\002\n\013GetRan"
  "kings\022&.kentik.kmi.v202212.GetRankingsRe"
  "quest\032\'.kentik.kmi.v202212.GetRankingsRe"
  "sponse\"\260\001\222A\\\022.List KMI rankings by geo m"
  "arket and rank type.\032\035Returns list of KM"
  ...
  "Response\"\221\002\222A\274\001\022SList metadata and list "
  "of customers, providers, and peers for a"
  "n Autonomous System.\032VReturns metadata a"
  "nd list of customers, providers, and pee"
  "rs for an Autonomous System.*\rGetASNDeta"
  "ils\362\327\002\016admin.kmi:read\202\323\344\223\0029\"4/kmi/v20221"
  "2/market/{market_id}/network/{asn}/{type"
  "}:\001*\032\'\312A\023grpc.api.kentik.com\352\327\002\tadmin.km"
  "i\220\330\002\003B\305\017Z=github.com/kentik/api-schema-p"
  "ublic/go/kentik/kmi/v202212;kmi\222A\202\017\022\233\r\n$"
  "Kentik Market Intelligence (KMI) API\022\242\014#"
  " Overview\nThe Kentik Market Intelligence"
  " (KMI) API provides programmatic access "
  "to information related to KMI rankings, "
  "KMI markets, and the customers, provider"
  "s, and peers of individual Autonomous Sy"
  "stems (ASes). This information is derive"
  "d from analysis of the global routing ta"
  "ble, which enables us to classify the pe"
  "ering and transit relationships between "
  "ASes and to identify the providers, peer"
  "s, and customers of a given AS in any ge"
  "ography (market). KMI estimates the volu"
  "me of IP space transited by ASes in diff"
  "erent geographies and produces rankings "
  "based on that volume, thereby enabling u"
  "sers to compare ASes in various markets."
  "\n\n# KMI Ranking Types\n\nThe following typ"
  "es of rankings are shown:\n- **Customer B"
  "ase**: Ranked by the size of the overall"
  " customer base, estimated by determining"
  " how much IP address space a given AS tr"
  "ansits relative to other ASes:\n    - Ret"
  "ail networks  provide services (e.g. ori"
  "ginate content) or have end-users that a"
  "re consumers of services (e.g. ISPs or \""
  "eyeball\" networks).\n    - Wholesale netw"
  "orks  connect retail networks to backbon"
  "e networks.\n    - Backbone networks carr"
  "y high volumes of traffic between wholes"
  "ale networks.\n- **Customer Growth**: Ran"
  "ked by the change in overall customer ba"
  "se (gain/loss of prefixes) over the last"
  " 20 days.\n- **Peering**: Ranked by the a"
  "mount of IP address space sent to the AS"
  " over a settlement-free peering session."
  "\n\nBoth REST endpoint and gRPC RPCs are p"
  "rovided.\n\n**_Note:_** More information a"
  "bout KMI can be found at [Kentik Market "
  "Intelligence](https://kb.kentik.com/v4/H"
  "a04.htm).\"E\n\026Kentik API Engineering\022+htt"
  "ps://github.com/kentik/api-schema-public"
  "2\007v202212*\001\0022\020application/json:\020applicat"
  "ion/jsonZD\n\036\n\005email\022\025\010\002\032\017X-CH-Auth-Email"
  " \002\n\"\n\005token\022\031\010\002\032\023X-CH-Auth-API-Token \002b\026"
  "\n\t\n\005email\022\000\n\t\n\005token\022\000r]\n%General inform"
  "ation about Kentik APIs\0224https://kb.kent"
  "ik.com/v0/Ab09.htm#Ab09-APIs_Overviewb\006p"
  "roto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fkmi_2fv202212_2fkmi_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fkmi_2fv202212_2fkmi_2eproto, "kentik/kmi/v202212/kmi.proto", 6925,

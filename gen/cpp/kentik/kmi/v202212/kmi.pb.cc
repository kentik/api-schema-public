...
const char descriptor_table_protodef_kentik_2fkmi_2fv202212_2fkmi_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "min.kmi\220\330\002\003B\305\017Z=github.com/kentik/api-sc"
  "hema-public/go/kentik/kmi/v202212;kmi\222A\202"
  "\017\022\233\r\n$Kentik Market Intelligence (KMI) A"
  "PI\022\242\014# Overview\nThe Kentik Market Intell"
  "igence (KMI) API provides programmatic a"
  "ccess to information related to KMI rank"
  "ings, KMI markets, and the customers, pr"
  "oviders, and peers of individual Autonom"
  "ous Systems (ASes). This information is "
  "derived from analysis of the global rout"
  "ing table, which enables us to classify "
  "the peering and transit relationships be"
  "tween ASes and to identify the providers"
  ", peers, and customers of a given AS in "
  "any geography (market). KMI estimates th"
  "e volume of IP space transited by ASes i"
  "n different geographies and produces ran"
  "kings based on that volume, thereby enab"
  "ling users to compare ASes in various ma"
  "rkets.\n\n# KMI Ranking Types\n\nThe followi"
  "ng types of rankings are shown:\n- **Cust"
  "omer Base**: Ranked by the size of the o"
  "verall customer base, estimated by deter"
  "mining how much IP address space a given"
  " AS transits relative to other ASes:\n   "
  " - Retail networks  provide services (e."
  "g. originate content) or have end-users "
  "that are consumers of services (e.g. ISP"
  "s or \"eyeball\" networks).\n    - Wholesal"
  "e networks  connect retail networks to b"
  "ackbone networks.\n    - Backbone network"
  "s carry high volumes of traffic between "
  "wholesale networks.\n- **Customer Growth*"
  "*: Ranked by the change in overall custo"
  "mer base (gain/loss of prefixes) over th"
  "e last 20 days.\n- **Peering**: Ranked by"
  " the amount of IP address space sent to "
  "the AS over a settlement-free peering se"
  "ssion.\n\nBoth REST endpoint and gRPC RPCs"
  " are provided.\n\n**_Note:_** More informa"
  "tion about KMI can be found at [Kentik M"
  "arket Intelligence](https://kb.kentik.co"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fkmi_2fv202212_2fkmi_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fkmi_2fv202212_2fkmi_2eproto, "kentik/kmi/v202212/kmi.proto", 6931,

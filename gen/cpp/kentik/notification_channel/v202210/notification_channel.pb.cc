...
const char descriptor_table_protodef_kentik_2fnotification_5fchannel_2fv202210_2fnotification_5fchannel_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "search:\001*\0324\312A\023grpc.api.kentik.com\352\327\002\032adm"
  "in.notification_channelB\266\nZ\\github.com/k"
  "entik/api-schema/gen/go/kentik/notificat"
  "ion_channel/v202210;notification_channel"
  "\222A\324\t\022\225\010\n\030Notification Channel API\022\250\007# Ov"
  "erview\nThe Notification Channel APIs ena"
  "ble you to retrieve IDs for the channels"
  " in your organization\'s collection of no"
  "tification channels (see [Notifications]"
  "(https://kb.kentik.com/v4/Cb24.htm)). Ea"
  "ch channel includes a channel type (e.g."
  " email, Slack, PagerDuty, etc.) and a se"
  "t of targets (recipients). Using the ID "
  "of a given channel, you can assign a set"
  " of recipients to receive notifications "
  "from Kentik alerts and synthetic tests, "
  "including those generated by the [Synthe"
  "tics Monitoring APIs](https://kb.kentik."
  "com/v0/Oa09.htm) and [BGP Monitoring API"
  "s](https://kb.kentik.com/v0/Oa07.htm).\n\n"
  "Both REST endpoints and gRPC RPCs are pr"
  "ovided.\n# Limitations\nThe use of this AP"
  "I is currently subject to the following "
  "limitations:\n* **Read-only**: Creation, "
  "modification, and deletion of channels i"
  "s not supported.\n* **No v3 channels**: N"
  "o support is (or will be) provided for n"
  "otification channels created in Kentik\'s"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fnotification_5fchannel_2fv202210_2fnotification_5fchannel_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fnotification_5fchannel_2fv202210_2fnotification_5fchannel_2eproto, "kentik/notification_channel/v202210/notification_channel.proto", 5448,

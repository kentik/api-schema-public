...
const char descriptor_table_protodef_kentik_2fnotification_5fchannel_2fv202210_2fnotification_5fchannel_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "in.notification_channel\220\330\002\003B\271\nZ_github.c"
  "om/kentik/api-schema-public/go/kentik/no"
  "tification_channel/v202210;notification_"
  "channel\222A\324\t\022\225\010\n\030Notification Channel API"
  "\022\250\007# Overview\nThe Notification Channel A"
  "PIs enable you to retrieve IDs for the c"
  "hannels in your organization\'s collectio"
  "n of notification channels (see [Notific"
  "ations](https://kb.kentik.com/v4/Cb24.ht"
  "m)). Each channel includes a channel typ"
  "e (e.g. email, Slack, PagerDuty, etc.) a"
  "nd a set of targets (recipients). Using "
  "the ID of a given channel, you can assig"
  "n a set of recipients to receive notific"
  "ations from Kentik alerts and synthetic "
  "tests, including those generated by the "
  "[Synthetics Monitoring APIs](https://kb."
  "kentik.com/v0/Oa09.htm) and [BGP Monitor"
  "ing APIs](https://kb.kentik.com/v0/Oa07."
  "htm).\n\nBoth REST endpoints and gRPC RPCs"
  " are provided.\n# Limitations\nThe use of "
  "this API is currently subject to the fol"
  "lowing limitations:\n* **Read-only**: Cre"
  "ation, modification, and deletion of cha"
  "nnels is not supported.\n* **No v3 channe"
  "ls**: No support is (or will be) provide"
  "d for notification channels created in K"
  "entik\'s v3 portal.\n\"E\n\026Kentik API Engine"
  "ering\022+https://github.com/kentik/api-sch"
  "ema-public2\007v202210*\001\0022\020application/json"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fnotification_5fchannel_2fv202210_2fnotification_5fchannel_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fnotification_5fchannel_2fv202210_2fnotification_5fchannel_2eproto, "kentik/notification_channel/v202210/notification_channel.proto", 5455,

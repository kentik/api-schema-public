...
const char descriptor_table_protodef_kentik_2fnotification_5fchannel_2fv202210_2fnotification_5fchannel_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ification_channel\220\330\002\003B\275\nZcgithub.com/ken"
  "tik/api-schema-public/gen/go/kentik/noti"
  "fication_channel/v202210;notification_ch"
  "annel\222A\324\t\022\225\010\n\030Notification Channel API\022\250"
  "\007# Overview\nThe Notification Channel API"
  "s enable you to retrieve IDs for the cha"
  "nnels in your organization\'s collection "
  "of notification channels (see [Notificat"
  "ions](https://kb.kentik.com/v4/Cb24.htm)"
  "). Each channel includes a channel type "
  "(e.g. email, Slack, PagerDuty, etc.) and"
  " a set of targets (recipients). Using th"
  "e ID of a given channel, you can assign "
  "a set of recipients to receive notificat"
  "ions from Kentik alerts and synthetic te"
  "sts, including those generated by the [S"
  "ynthetics Monitoring APIs](https://kb.ke"
  "ntik.com/v0/Oa09.htm) and [BGP Monitorin"
  "g APIs](https://kb.kentik.com/v0/Oa07.ht"
  "m).\n\nBoth REST endpoints and gRPC RPCs a"
  "re provided.\n# Limitations\nThe use of th"
  "is API is currently subject to the follo"
  "wing limitations:\n* **Read-only**: Creat"
  "ion, modification, and deletion of chann"
  "els is not supported.\n* **No v3 channels"
  "**: No support is (or will be) provided "
  "for notification channels created in Ken"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fnotification_5fchannel_2fv202210_2fnotification_5fchannel_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fnotification_5fchannel_2fv202210_2fnotification_5fchannel_2eproto, "kentik/notification_channel/v202210/notification_channel.proto", 5453,

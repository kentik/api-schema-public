...
const char descriptor_table_protodef_kentik_2fnotification_5fchannel_2fv202210_2fnotification_5fchannel_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ogle/protobuf/timestamp.proto\"\347\003\n\023Notifi"
  "cationChannel\0229\n\002id\030\001 \001(\tB)\222A\"2 Unique i"
  "dentifier of the channel\342A\001\003R\002id\022>\n\004name"
  "\030\002 \001(\tB*\222A#2!User selected name of the c"
  "hannel\342A\001\003R\004name\022h\n\004type\030\003 \001(\01620.kentik."
  "notification_channel.v202210.ChannelType"
  "B\"\222A\0332\031Notification channel type\342A\001\003R\004ty"
  "pe\0228\n\007enabled\030\004 \001(\010B\036\222A\0272\025Administrative"
  " status\342A\001\003R\007enabled\022S\n\005cdate\030\005 \001(\0132\032.go"
  ...
  "!\n\037ListNotificationChannelsRequest\"\277\002\n L"
  "istNotificationChannelsResponse\022\225\001\n\025noti"
  "fication_channels\030\001 \003(\01328.kentik.notific"
  "ation_channel.v202210.NotificationChanne"
  "lB&\222A\0372\035List of notification channels\342A\001"
  "\003R\024notificationChannels\022\202\001\n\rinvalid_coun"
  "t\030\002 \001(\005B]\222AV2TNumber of invalid entries "
  "that were not included in the list (shou"
  "ld be always zero)\342A\001\003R\014invalidCount\"M\n\035"
  "GetNotificationChannelRequest\022,\n\002id\030\001 \001("
  "\tB\034\222A\0252\023Request channel ID.\342A\001\003R\002id\"\270\001\n\036"
  "GetNotificationChannelResponse\022\225\001\n\024notif"
  "ication_channel\030\001 \001(\01328.kentik.notificat"
  "ion_channel.v202210.NotificationChannelB"
  "(\222A!2\037Data for the requested channel.\342A\001"
  "\003R\023notificationChannel\"\205\004\n!SearchNotific"
  "ationChannelsRequest\022\343\001\n\014name_pattern\030\001 "
  "\001(\tB\277\001\222A\273\0012\270\001Regular expression pattern "
  "for matching the name attribute of chann"
  "els. Empty string matches any name, othe"
  "rwise the regular expression must consum"
  "e all characters in the channel name.R\013n"
  "amePattern\022\233\001\n\005types\030\002 \003(\01620.kentik.noti"
  "fication_channel.v202210.ChannelTypeBS\222A"
  "P2NList of ChannelType enum values to ma"
  "tch. Empty list matches any channel type"
  ".R\005types\022\\\n\020include_disabled\030\003 \001(\010B1\222A.2"
  "%Include disabled channels in results.:\005"
  "falseR\017includeDisabled\"\313\002\n\"SearchNotific"
  "ationChannelsResponse\022\237\001\n\025notification_c"
  "hannels\030\001 \003(\01328.kentik.notification_chan"
  "nel.v202210.NotificationChannelB0\222A)2\'Li"
  "st of matching notification channels.\342A\001"
  "\003R\024notificationChannels\022\202\001\n\rinvalid_coun"
  "t\030\002 \001(\005B]\222AV2TNumber of invalid entries "
  "that were not included in the list (shou"
  "ld be always zero)\342A\001\003R\014invalidCount*\352\002\n"
  "\013ChannelType\022\034\n\030CHANNEL_TYPE_UNSPECIFIED"
  "\020\000\022\031\n\025CHANNEL_TYPE_XMATTERS\020\001\022\026\n\022CHANNEL"
  "_TYPE_SLACK\020\002\022\033\n\027CHANNEL_TYPE_SERVICENOW"
  "\020\003\022\027\n\023CHANNEL_TYPE_SYSLOG\020\004\022\031\n\025CHANNEL_T"
  "YPE_OPSGENIE\020\005\022\037\n\033CHANNEL_TYPE_CUSTOM_WE"
  "BHOOK\020\006\022\027\n\023CHANNEL_TYPE_SPLUNK\020\007\022\030\n\024CHAN"
  "NEL_TYPE_MSTEAMS\020\010\022\025\n\021CHANNEL_TYPE_JSON\020"
  "\t\022\026\n\022CHANNEL_TYPE_EMAIL\020\n\022\032\n\026CHANNEL_TYP"
  "E_VICTOROPS\020\013\022\032\n\026CHANNEL_TYPE_PAGERDUTY\020"
  "\0142\261\013\n\032NotificationChannelService\022\202\003\n\030Lis"
  "tNotificationChannels\022D.kentik.notificat"
  "ion_channel.v202210.ListNotificationChan"
  "nelsRequest\032E.kentik.notification_channe"
  "l.v202210.ListNotificationChannelsRespon"
  "se\"\330\001\222Aw\022$List available notification ch"
  "annels\0325Returns list of all configured n"
  "otification channels.*\030ListNotificationC"
  "hannels\362\327\002\037admin.notification_channel:re"
  "ad\202\323\344\223\0025\0223/notification_channel/v202210/"
  "notification_channels\022\225\003\n\026GetNotificatio"
  "nChannel\022B.kentik.notification_channel.v"
  "202210.GetNotificationChannelRequest\032C.k"
  "entik.notification_channel.v202210.GetNo"
  "tificationChannelResponse\"\361\001\222A\212\001\022,Get in"
  "formation about a notification channel\032B"
  "Returns information about a notification"
  " channel with specific ID.*\026GetNotificat"
  "ionChannel\362\327\002\037admin.notification_channel"
  ":read\202\323\344\223\002:\0228/notification_channel/v2022"
  "10/notification_channels/{id}\022\273\004\n\032Search"
  "NotificationChannels\022F.kentik.notificati"
  "on_channel.v202210.SearchNotificationCha"
  "nnelsRequest\032G.kentik.notification_chann"
  "el.v202210.SearchNotificationChannelsRes"
  "ponse\"\213\003\222A\237\002\0221Retrieve notification chan"
  "nels matching criteria.\032\315\001Returns list o"
  "f all notification channels matching req"
  "uest criteria. Match criteria are treate"
  "d as a logical AND, i.e. all provided cr"
  "iteria must match in order for an entry "
  "to be included in the response.*\032SearchN"
  "otificationChannels\362\327\002\037admin.notificatio"
  "n_channel:read\202\323\344\223\002\?\":/notification_chan"
  "nel/v202210/notification_channels/search"
  ":\001*\0328\312A\023grpc.api.kentik.com\352\327\002\032admin.not"
  "ification_channel\220\330\002\003B\271\nZ_github.com/ken"
  "tik/api-schema-public/go/kentik/notifica"
  "tion_channel/v202210;notification_channe"
  "l\222A\324\t\022\225\010\n\030Notification Channel API\022\250\007# O"
  "verview\nThe Notification Channel APIs en"
  "able you to retrieve IDs for the channel"
  "s in your organization\'s collection of n"
  "otification channels (see [Notifications"
  "](https://kb.kentik.com/v4/Cb24.htm)). E"
  "ach channel includes a channel type (e.g"
  ". email, Slack, PagerDuty, etc.) and a s"
  "et of targets (recipients). Using the ID"
  " of a given channel, you can assign a se"
  "t of recipients to receive notifications"
  " from Kentik alerts and synthetic tests,"
  " including those generated by the [Synth"
  "etics Monitoring APIs](https://kb.kentik"
  ".com/v0/Oa09.htm) and [BGP Monitoring AP"
  "Is](https://kb.kentik.com/v0/Oa07.htm).\n"
  "\nBoth REST endpoints and gRPC RPCs are p"
  "rovided.\n# Limitations\nThe use of this A"
  "PI is currently subject to the following"
  " limitations:\n* **Read-only**: Creation,"
  " modification, and deletion of channels "
  "is not supported.\n* **No v3 channels**: "
  "No support is (or will be) provided for "
  "notification channels created in Kentik\'"
  "s v3 portal.\n\"E\n\026Kentik API Engineering\022"
  "+https://github.com/kentik/api-schema-pu"
  "blic2\007v202210*\001\0022\020application/json:\020appl"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fnotification_5fchannel_2fv202210_2fnotification_5fchannel_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fnotification_5fchannel_2fv202210_2fnotification_5fchannel_2eproto, "kentik/notification_channel/v202210/notification_channel.proto", 5449,

...
const char descriptor_table_protodef_kentik_2fbgp_5fmonitoring_2fv202210_2fbgp_5fmonitoring_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "com\352\327\002\nsynthetics\220\330\002\003B\363\032ZPgithub.com/ken"
  "tik/api-schema/gen/go/kentik/bgp_monitor"
  "ing/v202210;bgp_monitoring\222A\235\032\022\260\030\n\022BGP M"
  "onitoring API\022\311\027# Overview\nThe BGP Monit"
  "oring API provides programmatic access t"
  "o Kentik\'s BGP monitoring system. The AP"
  "Is handle two distinct functions:\n* **Ad"
  "min service**: manages monitoring of adv"
  "ertised BGP prefixes as collected from g"
  "lobal vantage points.\n* **Data service**"
  ": handles retrieval of two classes of da"
  "ta for any IP prefix:\n    - metrics for "
  "reachability and path changes, which pro"
  "vide a time series for a specified inter"
  "val;\n    - routes, which provide a snaps"
  "hot of routing information for particula"
  "r timestamp.\n\nThe services described abo"
  "ve use the following endpoints:\n| Endpoi"
  "nt | Purpose |\n|-----------|---------|\n|"
  " BgpMonitoringAdminService | CRUD operat"
  "ions for BGP monitors |\n| BgpMonitoringD"
  "ataService  | Retrieval of BGP monitorin"
  "g data |\n\nBoth REST endpoints and gRPC R"
  "PCs are provided.\n### Known Limitations\n"
  "The API currently does not support retri"
  "eval of BGP event history.\n# BGP Monitor"
  "ing Data\n\nKentik\'s BGP monitoring API pr"
  "ovides the following information about n"
  "etwork prefixes:\n* **Reachability**: exp"
  "ressed as the percentage of vantage poin"
  "ts reporting the prefix\n* **Path changes"
  "**: the number of changes in a given tim"
  "e range\n* **Routes**: AS Path, next hop\n"
  "### Data Retrieval Limitations\n\nThe foll"
  "owing considerations apply to data retri"
  "eval using these APIs:\n* BGP metrics and"
  " routes can be retrieved for any prefix "
  "with prefix length greater than 14 and a"
  "ny time interval. Prefixes with smaller "
  "length must be split into subnets (sub-p"
  "refixes) and requested individually.\n* R"
  "equests for BGP metrics can can specify "
  "one or more metric types to be retrieved"
  " for a single prefix. Observed data are "
  "returned as a sequence of messages, one "
  "for each metric type and observation tim"
  "e.\n* Route requests retrieve snapshot of"
  " information for specified prefix and ti"
  "me. Responses contain also mapping of AS"
  "Ns to AS names for convenience.\n# Workin"
  "g with BGP Monitoring\n\nThe topics below "
  "cover important information related to u"
  "sing Kentik\'s BGP monitoring APIs.\n### B"
  "GP Prefixes\n\nThese APIs represent BGP pr"
  "efixes using NLRI (Network Layer Reachab"
  "ility Information) objects. While NLRI o"
  "bjects allow representation of any type "
  "of network address, the system currently"
  " supports only IPv4 and IPv6 unicast in "
  "standard textual representation:\n* **IPv"
  "4**: dotted-decimal notation\n* **IPv6**:"
  " [RFC 5952](https://www.rfc-editor.org/r"
  "fc/rfc5952) syntax\n### BGP Monitor Tests"
  "\n\nBGP Monitors enable the generation of "
  "alerts for group network prefixes (IPv4 "
  "or IPv6) based on the following factors:"
  "\n* Visibility/reachability of prefixes\n*"
  " Mismatch of originating ASNs with a spe"
  "cified list of valid originators\n* Valid"
  "ity of advertisements with respect to RP"
  "KI (Resource Public Key Infrastructure)\n"
  "\n### Configuration Limitations \n\nThe fol"
  "lowing considerations apply when configu"
  "ring a BGP monitor test:\n* Each BGP moni"
  "tor instance can monitor up to 10 prefix"
  "es.\n* The length of each monitored (IPv4"
  " or IPv6) prefix must be greater than 14"
  ". Prefixes with smaller length must be s"
  "plit into subnets (sub-prefixes).\"E\n\026Ken"
  ...
  "oken\022\000rc\n More about Kentik BGP monitori"
  "ng\022\?https://kb.kentik.com/v4/Ma03.htm#Ma"
  "03-BGP_Monitor_Details_Pageb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fbgp_5fmonitoring_2fv202210_2fbgp_5fmonitoring_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fbgp_5fmonitoring_2fv202210_2fbgp_5fmonitoring_2eproto, "kentik/bgp_monitoring/v202210/bgp_monitoring.proto", 13315,

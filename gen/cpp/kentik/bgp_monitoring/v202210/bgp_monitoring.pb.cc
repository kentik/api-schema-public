...
const char descriptor_table_protodef_kentik_2fbgp_5fmonitoring_2fv202210_2fbgp_5fmonitoring_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "GP_METRIC_TYPE_PATH_CHANGES\020\0022\264\017\n\031BgpMon"
  ...
  "tMetricsForTarget\0229.kentik.bgp_monitorin"
  "g.v202210.GetMetricsForTargetRequest\032:.k"
  "entik.bgp_monitoring.v202210.GetMetricsF"
  "orTargetResponse\"\263\001\222As\022\035Get metrics for "
  "a BGP prefix.\032=Retrieve metric data for "
  "single BGP prefix and time interval.*\023Ge"
  "tMetricsForTarget\362\327\002\017synthetics:read\202\323\344\223"
  "\002$\"\037/bgp_monitoring/v202210/metrics:\001*\022\316"
  "\002\n\022GetRoutesForTarget\0228.kentik.bgp_monit"
  "oring.v202210.GetRoutesForTargetRequest\032"
  "9.kentik.bgp_monitoring.v202210.GetRoute"
  "sForTargetResponse\"\302\001\222A\202\001\022\034Get routes fo"
  "r a BGP prefix.\032NRetrieve snapshot of ro"
  "ute information for single BGP prefix at"
  " specific time.*\022GetRoutesForTarget\362\327\002\017s"
  "ynthetics:read\202\323\344\223\002#\"\036/bgp_monitoring/v2"
  "02210/routes:\001*\032$\312A\023grpc.api.kentik.com\352"
  "\327\002\nsyntheticsB\363\032ZPgithub.com/kentik/api-"
  "schema/gen/go/kentik/bgp_monitoring/v202"
  "210;bgp_monitoring\222A\235\032\022\260\030\n\022BGP Monitorin"
  "g API\022\311\027# Overview\nThe BGP Monitoring AP"
  "I provides programmatic access to Kentik"
  "\'s BGP monitoring system. The APIs handl"
  "e two distinct functions:\n* **Admin serv"
  "ice**: manages monitoring of advertised "
  "BGP prefixes as collected from global va"
  "ntage points.\n* **Data service**: handle"
  "s retrieval of two classes of data for a"
  "ny IP prefix:\n    - metrics for reachabi"
  "lity and path changes, which provide a t"
  "ime series for a specified interval;\n   "
  " - routes, which provide a snapshot of r"
  "outing information for particular timest"
  "amp.\n\nThe services described above use t"
  "he following endpoints:\n| Endpoint | Pur"
  "pose |\n|-----------|---------|\n| BgpMoni"
  "toringAdminService | CRUD operations for"
  " BGP monitors |\n| BgpMonitoringDataServi"
  "ce  | Retrieval of BGP monitoring data |"
  "\n\nBoth REST endpoints and gRPC RPCs are "
  "provided.\n### Known Limitations\nThe API "
  "currently does not support retrieval of "
  "BGP event history.\n# BGP Monitoring Data"
  "\n\nKentik\'s BGP monitoring API provides t"
  "he following information about network p"
  "refixes:\n* **Reachability**: expressed a"
  "s the percentage of vantage points repor"
  "ting the prefix\n* **Path changes**: the "
  "number of changes in a given time range\n"
  "* **Routes**: AS Path, next hop\n### Data"
  " Retrieval Limitations\n\nThe following co"
  "nsiderations apply to data retrieval usi"
  "ng these APIs:\n* BGP metrics and routes "
  "can be retrieved for any prefix with pre"
  "fix length greater than 14 and any time "
  "interval. Prefixes with smaller length m"
  "ust be split into subnets (sub-prefixes)"
  " and requested individually.\n* Requests "
  "for BGP metrics can can specify one or m"
  "ore metric types to be retrieved for a s"
  "ingle prefix. Observed data are returned"
  " as a sequence of messages, one for each"
  " metric type and observation time.\n* Rou"
  "te requests retrieve snapshot of informa"
  "tion for specified prefix and time. Resp"
  "onses contain also mapping of ASNs to AS"
  " names for convenience.\n# Working with B"
  "GP Monitoring\n\nThe topics below cover im"
  "portant information related to using Ken"
  "tik\'s BGP monitoring APIs.\n### BGP Prefi"
  "xes\n\nThese APIs represent BGP prefixes u"
  "sing NLRI (Network Layer Reachability In"
  "formation) objects. While NLRI objects a"
  "llow representation of any type of netwo"
  "rk address, the system currently support"
  "s only IPv4 and IPv6 unicast in standard"
  " textual representation:\n* **IPv4**: dot"
  "ted-decimal notation\n* **IPv6**: [RFC 59"
  "52](https://www.rfc-editor.org/rfc/rfc59"
  "52) syntax\n### BGP Monitor Tests\n\nBGP Mo"
  "nitors enable the generation of alerts f"
  "or group network prefixes (IPv4 or IPv6)"
  " based on the following factors:\n* Visib"
  "ility/reachability of prefixes\n* Mismatc"
  "h of originating ASNs with a specified l"
  "ist of valid originators\n* Validity of a"
  "dvertisements with respect to RPKI (Reso"
  "urce Public Key Infrastructure)\n\n### Con"
  "figuration Limitations \n\nThe following c"
  "onsiderations apply when configuring a B"
  "GP monitor test:\n* Each BGP monitor inst"
  "ance can monitor up to 10 prefixes.\n* Th"
  "e length of each monitored (IPv4 or IPv6"
  ") prefix must be greater than 14. Prefix"
  "es with smaller length must be split int"
  "o subnets (sub-prefixes).\"E\n\026Kentik API "
  ...
  "\n More about Kentik BGP monitoring\022\?http"
  "s://kb.kentik.com/v4/Ma03.htm#Ma03-BGP_M"
  "onitor_Details_Pageb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fbgp_5fmonitoring_2fv202210_2fbgp_5fmonitoring_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fbgp_5fmonitoring_2fv202210_2fbgp_5fmonitoring_2eproto, "kentik/bgp_monitoring/v202210/bgp_monitoring.proto", 13307,

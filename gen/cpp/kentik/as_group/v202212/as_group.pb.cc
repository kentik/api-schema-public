...
const char descriptor_table_protodef_kentik_2fas_5fgroup_2fv202212_2fas_5fgroup_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\002 \001(\tR\004name\"\367\002\n\016ASGroupConcise\022;\n\002id\030\001 \001"
  "(\tB+\222A$2\"System generated unique identif"
  "ier\342A\001\003R\002id\0226\n\004name\030\002 \001(\tB\"\222A\0332\031User sel"
  "ected unique name\342A\001\002R\004name\022#\n\003asn\030\003 \003(\t"
  "B\021\222A\0162\014List of ASNsR\003asn\022`\n\014created_date"
  "\030\005 \001(\0132\032.google.protobuf.TimestampB!\222A\0322"
  "\030Creation timestamp (UTC)\342A\001\003R\013createdDa"
  "te\022i\n\014updated_date\030\006 \001(\0132\032.google.protob"
  "uf.TimestampB*\222A#2!Last modification tim"
  "estamp (UTC)\342A\001\003R\013updatedDate\"\243\003\n\017ASGrou"
  "pDetailed\022;\n\002id\030\001 \001(\tB+\222A$2\"System gener"
  "ated unique identifier\342A\001\003R\002id\0226\n\004name\030\002"
  " \001(\tB\"\222A\0332\031User selected unique name\342A\001\002"
  "R\004name\022N\n\003asn\030\003 \003(\0132).kentik.as_group.v2"
  "02212.AutonomousSystemB\021\222A\0162\014List of ASN"
  "sR\003asn\022`\n\014created_date\030\005 \001(\0132\032.google.pr"
  "otobuf.TimestampB!\222A\0322\030Creation timestam"
  "p (UTC)\342A\001\003R\013createdDate\022i\n\014updated_date"
  "\030\006 \001(\0132\032.google.protobuf.TimestampB*\222A#2"
  "!Last modification timestamp (UTC)\342A\001\003R\013"
  "updatedDate\"\025\n\023ListASGroupsRequest\"\370\001\n\024L"
  "istASGroupsResponse\022y\n\tas_groups\030\001 \003(\0132("
  ".kentik.as_group.v202212.ASGroupDetailed"
  "B2\222A/2-List of configurations of request"
  "ed AS groupsR\010asGroups\022e\n\rinvalid_count\030"
  "\002 \001(\rB@\222A=2;Number of invalid entries en"
  "countered while collecting dataR\014invalid"
  "Count\"J\n\021GetASGroupRequest\0225\n\002id\030\001 \001(\tB%"
  "\222A\0362\034ID of the requested AS group\342A\001\002R\002i"
  "d\"\207\001\n\022GetASGroupResponse\022q\n\010as_group\030\001 \001"
  "(\0132(.kentik.as_group.v202212.ASGroupDeta"
  "iledB,\222A)2\'Configuration of the requeste"
  "d AS groupR\007asGroup\"\206\001\n\024CreateASGroupReq"
  "uest\022n\n\010as_group\030\001 \001(\0132\'.kentik.as_group"
  ".v202212.ASGroupConciseB*\222A#2!Configurat"
  "ion of the new AS group\342A\001\002R\007asGroup\"\216\001\n"
  "\025CreateASGroupResponse\022u\n\010as_group\030\001 \001(\013"
  "2(.kentik.as_group.v202212.ASGroupDetail"
  "edB0\222A-2+Configuration of the newly crea"
  "ted AS groupR\007asGroup\"\241\001\n\024UpdateASGroupR"
  "equest\022\210\001\n\010as_group\030\001 \001(\0132\'.kentik.as_gr"
  "oup.v202212.ASGroupConciseBD\222A=2;New con"
  "figuration attributes for the AS group t"
  "o be updated\342A\001\002R\007asGroup\"\210\001\n\025UpdateASGr"
  "oupResponse\022o\n\010as_group\030\001 \001(\0132(.kentik.a"
  "s_group.v202212.ASGroupDetailedB*\222A\'2%Up"
  "dated configuration of the AS groupR\007asG"
  "roup\"Q\n\024DeleteASGroupRequest\0229\n\002id\030\001 \001(\t"
  "B)\222A\"2 ID of the AS group to be deleted\342"
  "A\001\002R\002id\"\027\n\025DeleteASGroupResponse2\375\013\n\016ASG"
  "roupService\022\364\001\n\014ListASGroups\022,.kentik.as"
  "_group.v202212.ListASGroupsRequest\032-.ken"
  "tik.as_group.v202212.ListASGroupsRespons"
  "e\"\206\001\222AJ\022\023List all AS groups.\032%Returns li"
  "st of configured AS groups.*\014ListASGroup"
  "s\362\327\002\023admin.as_group:read\202\323\344\223\002\034\022\032/as_grou"
  "p/v202212/as_group\022\222\002\n\nGetASGroup\022*.kent"
  "ik.as_group.v202212.GetASGroupRequest\032+."
  "kentik.as_group.v202212.GetASGroupRespon"
  "se\"\252\001\222Ai\022%Retrieve configuration of a AS"
  " group.\0324Returns configuration of a AS g"
  "roup specified by ID.*\nGetASGroup\362\327\002\023adm"
  "in.as_group:read\202\323\344\223\002!\022\037/as_group/v20221"
  "2/as_group/{id}\022\256\002\n\rCreateASGroup\022-.kent"
  "ik.as_group.v202212.CreateASGroupRequest"
  "\032..kentik.as_group.v202212.CreateASGroup"
  "Response\"\275\001\222A}\022\031Configure a new AS group"
  ".\032QCreate configuration for a new AS gro"
  "up. Returns the newly created configurat"
  "ion.*\rCreateASGroup\362\327\002\024admin.as_group:wr"
  "ite\202\323\344\223\002\037\"\032/as_group/v202212/as_group:\001*"
  "\022\336\002\n\rUpdateASGroup\022-.kentik.as_group.v20"
  "2212.UpdateASGroupRequest\032..kentik.as_gr"
  "oup.v202212.UpdateASGroupResponse\"\355\001\222A\236\001"
  "\022$Updates configuration of a AS group.\032g"
  "Replaces configuration of a AS group wit"
  "h attributes in the request. Returns the"
  " updated configuration.*\rUpdateASGroup\362\327"
  "\002\024admin.as_group:write\202\323\344\223\002-\032(/as_group/"
  "v202212/as_group/{as_group.id}:\001*\022\236\002\n\rDe"
  "leteASGroup\022-.kentik.as_group.v202212.De"
  "leteASGroupRequest\032..kentik.as_group.v20"
  "2212.DeleteASGroupResponse\"\255\001\222Ak\022#Delete"
  " configuration of a AS group.\0325Deletes c"
  "onfiguration of a AS group with specific"
  " ID.*\rDeleteASGroup\362\327\002\024admin.as_group:wr"
  "ite\202\323\344\223\002!*\037/as_group/v202212/as_group/{i"
  "d}\032,\312A\023grpc.api.kentik.com\352\327\002\016admin.as_g"
  "roup\220\330\002\003B\315\004ZKgithub.com/kentik/api-schem"
  "a-public/gen/go/kentik/as_group/v202212;"
  "as_group\222A\374\003\022\225\002\n\032AS Group Configuration "
  "API\022\246\001# Overview\nThe AS Group Configurat"
  "ion API provides programmatic access to "
  "configuration of AS Groups:\n\n* **AS Grou"
  "p**: ASNs can be logically grouped into "
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kentik_2fas_5fgroup_2fv202212_2fas_5fgroup_2eproto = {
  false, false, descriptor_table_protodef_kentik_2fas_5fgroup_2fv202212_2fas_5fgroup_2eproto, "kentik/as_group/v202212/as_group.proto", 4448,

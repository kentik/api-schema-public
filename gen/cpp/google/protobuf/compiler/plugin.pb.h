...
class CodeGeneratorRequest PROTOBUF_FINAL :
...
class CodeGeneratorResponse_File PROTOBUF_FINAL :
...
class CodeGeneratorResponse PROTOBUF_FINAL :
...
inline PROTOBUF_NAMESPACE_ID::GeneratedCodeInfo* CodeGeneratorResponse_File::release_generated_code_info() {
  auto temp = unsafe_arena_release_generated_code_info();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;

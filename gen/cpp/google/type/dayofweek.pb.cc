...
static bool dynamic_init_dummy_google_2ftype_2fdayofweek_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_google_2ftype_2fdayofweek_2eproto)), true);
namespace google {
namespace type {

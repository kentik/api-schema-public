...
inline std::string* LocalizedText::unsafe_arena_release_text() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.type.LocalizedText.text)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return text_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void LocalizedText::unsafe_arena_set_allocated_text(
    std::string* text) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (text != nullptr) {
  ...
  text_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      text, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.type.LocalizedText.text)
}
...
inline std::string* LocalizedText::unsafe_arena_release_language_code() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.type.LocalizedText.language_code)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return language_code_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void LocalizedText::unsafe_arena_set_allocated_language_code(
    std::string* language_code) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (language_code != nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.type.LocalizedText.language_code)
}

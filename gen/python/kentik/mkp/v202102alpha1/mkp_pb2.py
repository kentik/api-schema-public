...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _PACKAGESERVICE.methods_by_name['ListPackage']._serialized_options = b'\222AB\022\022List MKP packages.\032\037Returns a list of MKP packages.*\013PackageList\362\327\002\016admin.mkp:read\202\323\344\223\002\035\022\033/mkp/v202102alpha1/packages'
  _PACKAGESERVICE.methods_by_name['GetPackage']._options = None
  _PACKAGESERVICE.methods_by_name['GetPackage']._serialized_options = b'\222Ae\022!Get information aboout a package.\0324Returns information about package specified with ID.*\nPackageGet\362\327\002\016admin.mkp:read\202\323\344\223\002\"\022 /mkp/v202102alpha1/packages/{id}'
  _PACKAGESERVICE.methods_by_name['CreatePackage']._options = None
  _PACKAGESERVICE.methods_by_name['CreatePackage']._serialized_options = b'\222Ab\022\032Create a package template.\0325Create package from request. returns created package.*\rPackageCreate\362\327\002\017admin.mkp:write\202\323\344\223\002 \"\033/mkp/v202102alpha1/packages:\001*'
  _PACKAGESERVICE.methods_by_name['UpdatePackage']._options = None
  _PACKAGESERVICE.methods_by_name['UpdatePackage']._serialized_options = b'\222A]\022\021Update a package.\0329Replaces the entire package attributes specified with id.*\rPackageUpdate\362\327\002\017admin.mkp:write\202\323\344\223\002-\032(/mkp/v202102alpha1/packages/{package.id}:\001*'
  _PACKAGESERVICE.methods_by_name['PatchPackage']._options = None
  _PACKAGESERVICE.methods_by_name['PatchPackage']._serialized_options = b'\222Ap\022\020Patch a package.\032NPartially Updates the attributes of package specified with id and mask fields.*\014PackagePatch\362\327\002\017admin.mkp:write\202\323\344\223\002-2(/mkp/v202102alpha1/packages/{package.id}:\001*'
  _PACKAGESERVICE.methods_by_name['DeletePackage']._options = None
  _PACKAGESERVICE.methods_by_name['DeletePackage']._serialized_options = b'\222AJ\022\021Delete a package.\032&Deletes the package specified with id.*\rPackageDelete\362\327\002\017admin.mkp:write\202\323\344\223\002\"* /mkp/v202102alpha1/packages/{id}'
  ...
  _TENANTSERVICE.methods_by_name['ListTenant']._serialized_options = b'\222A?\022\021List MKP tenants.\032\036Returns a list of MKP tenants.*\nTenantList\362\327\002\016admin.mkp:read\202\323\344\223\002\034\022\032/mkp/v202102alpha1/tenants'
  _TENANTSERVICE.methods_by_name['GetTenant']._options = None
  _TENANTSERVICE.methods_by_name['GetTenant']._serialized_options = b'\222Ac\022 Get information aboout a tenant.\0324Returns information about package specified with ID.*\tTenantGet\362\327\002\016admin.mkp:read\202\323\344\223\002!\022\037/mkp/v202102alpha1/tenants/{id}'
  _TENANTSERVICE.methods_by_name['CreateTenant']._options = None
  _TENANTSERVICE.methods_by_name['CreateTenant']._serialized_options = b'\222AU\022\020Create a tenant.\0323Create tenant from request. returns created tenant.*\014TenantCreate\362\327\002\017admin.mkp:write\202\323\344\223\002\037\"\032/mkp/v202102alpha1/tenants:\001*'
  _TENANTSERVICE.methods_by_name['UpdateTenant']._options = None
  _TENANTSERVICE.methods_by_name['UpdateTenant']._serialized_options = b'\222AZ\022\020Update a tenant.\0328Replaces the entire tenant attributes specified with id.*\014TenantUpdate\362\327\002\017admin.mkp:write\202\323\344\223\002+\032&/mkp/v202102alpha1/tenants/{tenant.id}:\001*'
  _TENANTSERVICE.methods_by_name['PatchTenant']._options = None
  _TENANTSERVICE.methods_by_name['PatchTenant']._serialized_options = b'\222Am\022\017Patch a tenant.\032MPartially Updates the attributes of tenant specified with id and mask fields.*\013TenantPatch\362\327\002\017admin.mkp:write\202\323\344\223\002+2&/mkp/v202102alpha1/tenants/{tenant.id}:\001*'
  _TENANTSERVICE.methods_by_name['DeleteTenant']._options = None
  _TENANTSERVICE.methods_by_name['DeleteTenant']._serialized_options = b'\222AG\022\020Delete a tenant.\032%Deletes the tenant specified with id.*\014TenantDelete\362\327\002\017admin.mkp:write\202\323\344\223\002!*\037/mkp/v202102alpha1/tenants/{id}'

...
_CHANNELBATCH.fields_by_name['events'].message_type = kentik_dot_notify_dot_backend_dot_v1_dot_models__channel__event__pb2._CHANNELEVENT
...
ChannelBatch = _reflection.GeneratedProtocolMessageType('ChannelBatch', (_message.Message,), {
  ...
  '__module__' : 'kentik.notify.backend.v1.models_channel_batch_pb2'

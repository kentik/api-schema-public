...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n%kentik/audit/v202208beta1/audit.proto\x12\x19kentik.audit.v202208beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a+kentik/core/v202012alpha1/annotations.proto\"\xd9\x04\n\x0cRequestEvent\x12%\n\x0erequest_method\x18\x01 \x01(\tR\rrequestMethod\x12!\n\x0crequest_path\x18\x02 \x01(\tR\x0brequestPath\x12%\n\x0e\x63lient_address\x18\x03 \x01(\tR\rclientAddress\x12#\n\rresponse_code\x18\x04 \x01(\rR\x0cresponseCode\x12g\n\x10request_metadata\x18\x05 \x03(\x0b\x32<.kentik.audit.v202208beta1.RequestEvent.RequestMetadataEntryR\x0frequestMetadata\x12j\n\x11response_metadata\x18\x06 \x03(\x0b\x32=.kentik.audit.v202208beta1.RequestEvent.ResponseMetadataEntryR\x10responseMetadata\x12U\n\x10request_protocol\x18\x07 \x01(\x0e\x32*.kentik.audit.v202208beta1.RequestProtocolR\x0frequestProtocol\x1a\x42\n\x14RequestMetadataEntry\x12\x10\n\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n\x05value\x18\x02 \x01(\tR\x05value:\x02\x38\x01\x1a\x43\n\x15ResponseMetadataEntry\x12\x10\n\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n\x05value\x18\x02 \x01(\tR\x05value:\x02\x38\x01\"\xe3\x02\n\nAuditEvent\x12\x17\n\x07user_id\x18\x01 \x01(\x04R\x06userId\x12\x1d\n\ncompany_id\x18\x02 \x01(\x04R\tcompanyId\x12!\n\x0cservice_name\x18\x03 \x01(\tR\x0bserviceName\x12\x19\n\x08\x65vent_id\x18\x04 \x01(\tR\x07\x65ventId\x12\x30\n\x05\x63time\x18\x05 \x01(\x0b\x32\x1a.google.protobuf.TimestampR\x05\x63time\x12#\n\revent_payload\x18\x06 \x01(\tR\x0c\x65ventPayload\x12%\n\x0e\x63orrelation_id\x18\x07 \x01(\tR\rcorrelationId\x12\x0e\n\x02id\x18\x08 \x01(\x04R\x02id\x12\x43\n\x07request\x18\x14 \x01(\x0b\x32\'.kentik.audit.v202208beta1.RequestEventH\x00R\x07requestB\x0c\n\nevent_type\"Y\n\x18\x43reateAuditEventsRequest\x12=\n\x06\x65vents\x18\x01 \x03(\x0b\x32%.kentik.audit.v202208beta1.AuditEventR\x06\x65vents\"\x1b\n\x19\x43reateAuditEventsResponse\"\xca\x01\n\x16ListAuditEventsRequest\x12\x39\n\nstart_time\x18\x01 \x01(\x0b\x32\x1a.google.protobuf.TimestampR\tstartTime\x12\x35\n\x08\x65nd_time\x18\x02 \x01(\x0b\x32\x1a.google.protobuf.TimestampR\x07\x65ndTime\x12\x1e\n\x06offset\x18\x0f \x01(\x04\x42\x06\x92\x41\x03:\x01\x30R\x06offset\x12\x1e\n\x05limit\x18\x10 \x01(\x04\x42\x08\x92\x41\x05:\x03\x31\x30\x30R\x05limit\"X\n\x17ListAuditEventsResponse\x12=\n\x06\x65vents\x18\x01 \x03(\x0b\x32%.kentik.audit.v202208beta1.AuditEventR\x06\x65vents\"X\n\x14GetAuditEventRequest\x12\x0e\n\x02id\x18\x01 \x01(\x03R\x02id\x12\x30\n\x05\x63time\x18\x02 \x01(\x0b\x32\x1a.google.protobuf.TimestampR\x05\x63time\"T\n\x15GetAuditEventResponse\x12;\n\x05\x65vent\x18\x01 \x01(\x0b\x32%.kentik.audit.v202208beta1.AuditEventR\x05\x65vent*\x84\x01\n\x0fRequestProtocol\x12 \n\x1cREQUEST_PROTOCOL_UNSPECIFIED\x10\x00\x12\x19\n\x15REQUEST_PROTOCOL_REST\x10\x01\x12\x19\n\x15REQUEST_PROTOCOL_GRPC\x10\x02\x12\x19\n\x15REQUEST_PROTOCOL_HTTP\x10\x03\x32\xb9\x06\n\x0c\x41uditService\x12\x91\x02\n\x11\x43reateAuditEvents\x12\x33.kentik.audit.v202208beta1.CreateAuditEventsRequest\x1a\x34.kentik.audit.v202208beta1.CreateAuditEventsResponse\"\x90\x01\x92\x41Y\x12!Create one ore more audit events.\x1a!Create one ore more audit events.*\x11\x43reateAuditEvents\xf2\xd7\x02\x0b\x61udit:write\x82\xd3\xe4\x93\x02\x1f\"\x1a/audit/v202208beta1/events:\x01*\x12\xf2\x01\n\x0fListAuditEvents\x12\x31.kentik.audit.v202208beta1.ListAuditEventsRequest\x1a\x32.kentik.audit.v202208beta1.ListAuditEventsResponse\"x\x92\x41\x45\x12\x12List Audit Events.\x1a\x1fReturns a list of audit events.*\x0e\x41uditEventList\xf2\xd7\x02\naudit:read\x82\xd3\xe4\x93\x02\x1c\x12\x1a/audit/v202208beta1/events\x12\xf8\x01\n\rGetAuditEvent\x12/.kentik.audit.v202208beta1.GetAuditEventRequest\x1a\x30.kentik.audit.v202208beta1.GetAuditEventResponse\"\x83\x01\x92\x41\x43\x12\x12Get an Audit Event\x1a\x1eReturn a specific audit event.*\rGetAuditEvent\xf2\xd7\x02\naudit:read\x82\xd3\xe4\x93\x02)\x12\'/audit/v202208beta1/events/{id}/{ctime}\x1a%\xca\x41\x13grpc.api.kentik.com\xea\xd7\x02\x0b\x61\x64min.auditB\xd8\x02ZCgithub.com/kentik/api-schema/gen/go/kentik/audit/v202208beta1;audit\x92\x41\x8f\x02\x12Q\n\tAudit API\"7\n\x16Kentik API Engineering\x12\x1dhttps://github.com/kentik/api2\x0b\x32\x30\x32\x32\x30\x38\x62\x65ta1*\x01\x02\x32\x10\x61pplication/json:\x10\x61pplication/jsonZD\n\x1e\n\x05\x65mail\x12\x15\x08\x02\x1a\x0fX-CH-Auth-Email \x02\n\"\n\x05token\x12\x19\x08\x02\x1a\x13X-CH-Auth-API-Token \x02\x62\x16\n\t\n\x05\x65mail\x12\x00\n\t\n\x05token\x12\x00r5\n\x16More about Kentik APIs\x12\x1bhttps://docs.kentik.com/apib\x06proto3')
...
RequestEvent = _reflection.GeneratedProtocolMessageType('RequestEvent', (_message.Message,), {
  ...
  'RequestMetadataEntry' : _reflection.GeneratedProtocolMessageType('RequestMetadataEntry', (_message.Message,), {
    ...
    '__module__' : 'kentik.audit.v202208beta1.audit_pb2'
    # @@protoc_insertion_point(class_scope:kentik.audit.v202208beta1.RequestEvent.RequestMetadataEntry)
    })
  ,
  ...
  'ResponseMetadataEntry' : _reflection.GeneratedProtocolMessageType('ResponseMetadataEntry', (_message.Message,), {
    ...
    '__module__' : 'kentik.audit.v202208beta1.audit_pb2'
    # @@protoc_insertion_point(class_scope:kentik.audit.v202208beta1.RequestEvent.ResponseMetadataEntry)
    })
  ,
  'DESCRIPTOR' : _REQUESTEVENT,
  '__module__' : 'kentik.audit.v202208beta1.audit_pb2'
  # @@protoc_insertion_point(class_scope:kentik.audit.v202208beta1.RequestEvent)
  })
...
AuditEvent = _reflection.GeneratedProtocolMessageType('AuditEvent', (_message.Message,), {
  ...
  '__module__' : 'kentik.audit.v202208beta1.audit_pb2'
  # @@protoc_insertion_point(class_scope:kentik.audit.v202208beta1.AuditEvent)
  })
...
CreateAuditEventsRequest = _reflection.GeneratedProtocolMessageType('CreateAuditEventsRequest', (_message.Message,), {
  ...
  '__module__' : 'kentik.audit.v202208beta1.audit_pb2'
  # @@protoc_insertion_point(class_scope:kentik.audit.v202208beta1.CreateAuditEventsRequest)
  })
...
CreateAuditEventsResponse = _reflection.GeneratedProtocolMessageType('CreateAuditEventsResponse', (_message.Message,), {
  ...
  '__module__' : 'kentik.audit.v202208beta1.audit_pb2'
  # @@protoc_insertion_point(class_scope:kentik.audit.v202208beta1.CreateAuditEventsResponse)
  })
...
ListAuditEventsRequest = _reflection.GeneratedProtocolMessageType('ListAuditEventsRequest', (_message.Message,), {
  ...
  '__module__' : 'kentik.audit.v202208beta1.audit_pb2'
  # @@protoc_insertion_point(class_scope:kentik.audit.v202208beta1.ListAuditEventsRequest)
  })
...
ListAuditEventsResponse = _reflection.GeneratedProtocolMessageType('ListAuditEventsResponse', (_message.Message,), {
  ...
  '__module__' : 'kentik.audit.v202208beta1.audit_pb2'
  # @@protoc_insertion_point(class_scope:kentik.audit.v202208beta1.ListAuditEventsResponse)
  })
...
GetAuditEventRequest = _reflection.GeneratedProtocolMessageType('GetAuditEventRequest', (_message.Message,), {
  ...
  '__module__' : 'kentik.audit.v202208beta1.audit_pb2'
  # @@protoc_insertion_point(class_scope:kentik.audit.v202208beta1.GetAuditEventRequest)
  })
...
GetAuditEventResponse = _reflection.GeneratedProtocolMessageType('GetAuditEventResponse', (_message.Message,), {
  ...
  '__module__' : 'kentik.audit.v202208beta1.audit_pb2'
  # @@protoc_insertion_point(class_scope:kentik.audit.v202208beta1.GetAuditEventResponse)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _AUDITSERVICE.methods_by_name['CreateAuditEvents']._serialized_options = b'\222AY\022!Create one ore more audit events.\032!Create one ore more audit events.*\021CreateAuditEvents\362\327\002\013audit:write\202\323\344\223\002\037\"\032/audit/v202208beta1/events:\001*'
  _AUDITSERVICE.methods_by_name['ListAuditEvents']._options = None
  _AUDITSERVICE.methods_by_name['ListAuditEvents']._serialized_options = b'\222AE\022\022List Audit Events.\032\037Returns a list of audit events.*\016AuditEventList\362\327\002\naudit:read\202\323\344\223\002\034\022\032/audit/v202208beta1/events'
  _AUDITSERVICE.methods_by_name['GetAuditEvent']._options = None
  _AUDITSERVICE.methods_by_name['GetAuditEvent']._serialized_options = b'\222AC\022\022Get an Audit Event\032\036Return a specific audit event.*\rGetAuditEvent\362\327\002\naudit:read\202\323\344\223\002)\022\'/audit/v202208beta1/events/{id}/{ctime}'
  _REQUESTPROTOCOL._serialized_start=1803
  _REQUESTPROTOCOL._serialized_end=1935
  ...
  _AUDITSERVICE._serialized_start=1938
  _AUDITSERVICE._serialized_end=2763
